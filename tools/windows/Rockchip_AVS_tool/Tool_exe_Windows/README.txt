...
//多目产线标定
rkAVS_calibTool.exe -m=4 -c=./calibMultiProductConfig.txt
//多目产线验证
rkAVS_calibTool.exe -m=5 -c=./calibMultiVerifyConfig.txt
...
/*********************************************************************/
**********************calibMultiProductConfig*************************
/*********************************************************************/
srcPath: ./multiProduct/src/                                                 //src image path
dstPath: ./multiProduct/rk_calib_result/                     //save path
calibTorrentPath: ./multiProduct/src/rk_4_camera_result_fisheye.xml         //torrent file path
imageNameFormat: .bin                                                       //.jpg、.png、.bmp，.bin、.yuv
cameraNum: 4                                                                //camera number（2-8）
cameraType: 2                                                               //0-pinhole、1-omn、2-fisheye
cameraFov: 120                                                              //horizontal fov
boardWidth: 15                                                              //number of chessboard corners in horizontal direction
boardHeight: 8                                                              //number of chessboard corners in vertical direction
squareSize: 30                                                              //size of chessboard(mm)
imageWidth: 2560                                                            //image width
imageHeight: 1520                                                           //image height
imageStride: 2560                                                           //image stride
imageFormat: 2                                                              //0-gray、1-rgb、2-yuv
isSaveCornersImage: 1                                                       //draw corners and save
multiProductMode: 0                                                         //multi product mode
isRing: 1                                                                   //is ring calib(0-1-2-3-0) 
isVerify: 0                                                                 //1-is verify mode,0-is calib mode


/*********************************************************************/
**********************calibMultiVerifyConfig*************************
/*********************************************************************/
srcPath: ./multiVerify/src/                                                 //src image path
dstPath: ./multiVerify/rk_calib_result/                                     //save path
calibTorrentPath: ./multiVerify/src/rk_4_camera_result.xml                  //verify calib file path
imageNameFormat: .bin                                                       //.jpg、.png、.bmp，.bin、.yuv
cameraNum: 4                                                                //camera number（2-8）
cameraType: 2                                                               //0-pinhole、1-omn、2-fisheye
cameraFov: 120                                                              //horizontal fov
