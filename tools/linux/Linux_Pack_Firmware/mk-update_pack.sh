...
function msg_help()
{
	...
	echo "        -v|--version      view this version."
	echo "        -h|--help         view this help message."
	echo "        -i|--image        input firmware image path."
	echo "        -p|--parameter    the partition file path (Not added by default)."
	echo "       -id|--chip-id      input chip id.(Support the following chip id)"
	echo "                              rk3588|RK3588"
	echo "                              rv1126|rv1109|RV1126|RV1109"
	echo "                              rv1106|rv1103|RV1106|RV1103"
	echo "                              rv1103b|RV1103B"
}
