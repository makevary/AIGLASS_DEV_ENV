...
CONFIG_SYSDRV_CHIP:=rv1103b

CONFIG_SYSDRV_CROSS := arm-rockchip831-linux-uclibcgnueabihf
...
ifeq ($(KERNEL_DTS),)
KERNEL_DTS := rv1103b-evb1-v10.dts
endif

ifeq ($(KERNEL_CFG),)
KERNEL_CFG := rv1103b_defconfig
ifeq ($(KERNEL_CFG_FRAGMENT),)
KERNEL_CFG_FRAGMENT := rv1103b-evb.config
endif
endif

ifeq ($(UBOOT_CFG),)
UBOOT_CFG := rv1103b_defconfig
...
ifeq ($(KERNEL_DTS),)
KERNEL_DTS := rv1103b-evb1-v10-spi-nor.dts
endif

ifeq ($(KERNEL_CFG),)
KERNEL_CFG := rv1103b_defconfig
ifeq ($(KERNEL_CFG_FRAGMENT),)
KERNEL_CFG_FRAGMENT := rv1103b-ipc.config
endif
endif

ifeq ($(UBOOT_CFG),)
UBOOT_CFG := rv1103b-spi-nor_defconfig
ifeq ($(UBOOT_CFG_FRAGMENT),)
UBOOT_CFG_FRAGMENT :=
endif
endif
...
KERNEL_CFG := rv1103b_defconfig
ifeq ($(KERNEL_CFG_FRAGMENT),)
KERNEL_CFG_FRAGMENT := rv1103b-evb.config rv1103b-nand.config
endif
endif
