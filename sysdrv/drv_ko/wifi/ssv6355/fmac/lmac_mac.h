...
enum
{
    ...
    TID_7,
    TID_MGT,
    TID_NOQOS = TID_MGT,//key index 0 use
    TID_NOQOS1,//key index 1 use
    TID_MAX
};
...
//#if LINUX_VERSION_CODE >= KERNEL_VERSION(4, 20, 0)
    ...
    STA_HE_CAPA = 1 << 5,
//#endif
    /// Bit Inidcating support for short Preamble in ERP
    STA_SHORT_PREAMBLE_CAPA = 1 << 6,
};
