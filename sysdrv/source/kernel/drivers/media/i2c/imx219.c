...
#define IMX219_XVCLK_FREQ		6000000
...
#define IMX219_REG_EXPOSURE_GROUPA		0x015a
#define IMX219_REG_EXPOSURE_GROUPB		0x025a
...
/* Analog gain control */
#define IMX219_REG_ANALOG_GAIN_GROUPA		0x0157
#define IMX219_REG_ANALOG_GAIN_GROUPB		0x0257
...
#define IMX219_REG_DIGITAL_GAIN_GROUPA		0x0158
#define IMX219_REG_DIGITAL_GAIN_GROUPB		0x0258
#define IMX219_REG_DIGITAL_GAIN_LOWER_BYTE_MAX	0x200
...
#define IMX219_GAIN_MAX			3677
#define IMX219_GAIN_STEP		1
#define IMX219_GAIN_DEFAULT		0x80
...
static const struct regval raw8_framefmt_regs[] = {
	{0x018c, 0x08},
	{0x018d, 0x08},
	{0x0309, 0x08},
	{REG_NULL, 0x00},
...
static const struct dev_pm_ops imx219_pm_ops = {
	...
	SET_LATE_SYSTEM_SLEEP_PM_OPS(imx219_suspend, imx219_resume)
#endif
};
...
static int imx219_set_gain(struct imx219 *imx219, uint32_t gain)
{
	...
	if(gain < IMX219_ANA_GAIN_MAX) {
		...
		again_reg = IMX219_ANA_GAIN_MAX;
		dgain_upper_byte = gain / IMX219_ANA_GAIN_MAX;
		dgain_lower_byte = (gain - IMX219_ANA_GAIN_MAX * dgain_upper_byte) / dgain_upper_byte
				    * IMX219_REG_DIGITAL_GAIN_LOWER_BYTE_MAX / IMX219_ANA_GAIN_MAX;
	...
	ret = imx219_write_reg(imx219->client, IMX219_REG_ANALOG_GAIN_GROUPA,
			       IMX219_REG_VALUE_08BIT, again_reg);
	ret |= imx219_write_reg(imx219->client, IMX219_REG_DIGITAL_GAIN_GROUPA,
				IMX219_REG_VALUE_16BIT, dgain_reg);
	ret |= imx219_write_reg(imx219->client, IMX219_REG_ANALOG_GAIN_GROUPB,
			       IMX219_REG_VALUE_08BIT, again_reg);
	ret |= imx219_write_reg(imx219->client, IMX219_REG_DIGITAL_GAIN_GROUPB,
				IMX219_REG_VALUE_16BIT, dgain_reg);
	return ret;
}
...
static int imx219_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	case V4L2_CID_EXPOSURE:
		...
		ret = imx219_write_reg(imx219->client, IMX219_REG_EXPOSURE_GROUPA,
				       IMX219_REG_VALUE_16BIT, ctrl->val);
		ret |= imx219_write_reg(imx219->client, IMX219_REG_EXPOSURE_GROUPB,
				       IMX219_REG_VALUE_16BIT, ctrl->val);
		break;
			 ...
			 const struct i2c_device_id *id)
{
	...
	imx219->reset_gpio = devm_gpiod_get(dev, "reset", imx219->is_thunderboot ? GPIOD_ASIS : GPIOD_OUT_LOW);
	if (IS_ERR(imx219->reset_gpio))
