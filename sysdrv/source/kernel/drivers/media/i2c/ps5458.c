...
static const struct regval ps5458_linear_10_2688x1520_30fps_regs[] = {
	...
	{0x007d, 0xC0}, //PXCLK IO
	{0x007e, 0xC0}, //PXDX IO
	{0x00af, 0x01}, //01: HSync inv & VSync inv
	{0x0509, 0x28},
	{0x050A, 0x16},
	{0x0510, 0x02}, //2 lane
	{0x0511, 0x00},//non-continues mode
	...
	{0x055B, 0x11},
	{0x05B0, 0x05},
	{0x0541, 0x20},//T_PLL_POSTDIVIDER_S=32 for 840Mbps
	{0x05EB, 0x80},//MPLL updateflag
	{0x06B6, 0x00},
	{0x0620, 0x00},
	{0x0622, 0x08},
	{0x0617, 0x98},
	...
	{0x01C8, 0x00},
	{0x01C9, 0x06},
	{0x01CF, 0x80}, //R_TG_WOI_HSize = 2688
	{0x01D0, 0x0a}, //R_TG_WOI_HSize=2688
	{0x01D1, 0xF0}, //R_TG_WOI_VSize = 1520
	{0x01d2, 0x05}, //R_TG_WOI_VSize=1520
	{0x01D3, 0x04}, //R_TG_WOI_HStart=4
	{0x01D5, 0x08}, //R_TG_WOI_VStart=8
	{0x01D7, 0x00},
	{0x01D8, 0x00},
	{0x0064, 0x01},
	{0x0123, 0x00},
	...
	{0x222A, 0x01},
	{0x010B, 0x64},
	{0x005F, 0x00},//Rs_Np_Sel=0 for default
	{0x011E, 0x40}, //R_LPF=1667->1600
	{0x011F, 0x06}, //
	{0x00EB, 0x01},
	{0x2340, 0x00},
	{0x234D, 0x04},
	...
	{0x0836, 0x00},
	{0x2247, 0xD0},
	{0x070A, 0xB1}, //T_OP_current_lvl_sel
	{0x0708, 0x30},
	{0x01E6, 0x10},
	{0x01C6, 0x52},
	{0x01C7, 0x01},
	...
	{0x01D1, 0x70},
	{0x01D2, 0x01},
	{0x01D3, 0x08}, //R_TG_WOI_HStart=8 for 648x368
	{0x01D5, 0x00}, //R_TG_WOI_VStart=0 for 648x368
	{0x01D7, 0x03}, //R_TG_VStart_sel=3
	{0x01D8, 0x00}, //d8 = R_TG_VStart_sel[9:8]
	{0x0064, 0x03},
	{0x0123, 0x02},
	{0x01e7, 0x0C},
	{0x01e8, 0x01},
	{0x2224, 0x04},
	{0x2229, 0x00},
	{0x2226, 0x00},//R_spll_refsel=0 for using external MCLK clock
	{0x222A, 0x01},
	{0x0494, 0x00},
	{0x010B, 0x60},
	{0x005F, 0x00},
	{0x011E, 0x0C},//R_LPF=1667->"6668(DVP), 6668(SPI_48M) due to Np=0" for 5fps
	{0x011F, 0x1A},//R_LPF=1667->"6668(DVP), 6668(SPI_48M) due to Np=0" for 5fps
	{0x0654, 0x05},
	{0x0663, 0x00},
	{0x0665, 0x00},
	{0x0667, 0x00},
	...
	{0x014A, 0x06},//R_ExpLine_PreRoll=1665 (R_LPF - 2) optical center
	{0x014B, 0x26},//R_GainIndex_PreRoll=38 (AG=1.509X)
	{0x014C, 0x00},//R_GainIndex_PreRoll=38 (AG=1.509X)
	{0x014E, 0x3E},//R_ExpLine_Stream=1598 (R_LPF - 2)
	{0x014F, 0x06},//R_ExpLine_Stream=1598 (R_LPF - 2)
	...
	{0x00eb, 0x01},
	{0x000C, 0x0C},
	{0x0035, 0x02},//R_SPIM_CLK_Div=2 (SPIM_CLK_freq=Sysclk_freq_Final/2=48MHz)
	{0x04A0, 0x01},
	{0x04A1, 0x00},// 0:4bit, 1:2bit, 2:1bit (SPI 4bit mode)
	{0x00eb, 0x01},
	{0x2343, 0x02},//R_Cxtsw_Group_Sel
	{0x2341, 0x00},//R_Cxtsw_Run_En(Rising Edge)
	{0x2341, 0x01},//R_Cxtsw_Run_En
	{0x05B7, 0xD0},//D02A: Version (Dummy register)
	{0x05B8, 0x2A},//D02A: Version (Dummy register)
	{REG_NULL, 0x00},
};
