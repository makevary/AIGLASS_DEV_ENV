...
/* RT_USING_TINYMEMBENCH is not set */
#define RT_USING_COREMARK
/* RT_USING_DHRYSTONE is not set */
/* RT_USING_FHOURSTONE is not set */
/* RT_USING_LINPACK is not set */
/* RT_USING_PI_CSS5 is not set */
/* RT_USING_WHETSTONE is not set */
