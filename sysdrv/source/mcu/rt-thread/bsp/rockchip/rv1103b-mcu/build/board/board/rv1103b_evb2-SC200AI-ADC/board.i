# 1 "board/rv1103b_evb2-SC200AI-ADC/board.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "board/rv1103b_evb2-SC200AI-ADC/board.c"
# 12 "board/rv1103b_evb2-SC200AI-ADC/board.c"
...
# 13 "board/rv1103b_evb2-SC200AI-ADC/board.c" 2
...
# 17 "board/rv1103b_evb2-SC200AI-ADC/board.c" 2
...
{
    {
        ...
        .rst_gpio =
        {
            ...
            .gpio_group = ((struct GPIO_REG *) 0x20520000U),
        },
        .pwdn_gpio =
        {
            .gpio_pin = GPIO_PIN_A6,
            .gpio_group = ((struct GPIO_REG *) 0x20840000U),
        },
        .time_valid_delay = 2,
        .gain_valid_delay = 2,
...
void cif_hw_config(void)
{
    ...
    csi2_dphy->enable = 
# 58 "board/rv1103b_evb2-SC200AI-ADC/board.c" 3 4
                       1
# 58 "board/rv1103b_evb2-SC200AI-ADC/board.c"
                           ;
    csi2_dphy->csi2_dphy1.enable = 
# 59 "board/rv1103b_evb2-SC200AI-ADC/board.c" 3 4
                                  1
# 59 "board/rv1103b_evb2-SC200AI-ADC/board.c"
                                      ;
    csi2_dphy->csi2_dphy1.csi_host_idx = 0;
    csi2_dphy->csi2_dphy1.data_lanes = 2;
    csi2_dphy->csi2_dphy1.isp_subdev_name = "sensor_0";

    csi_host_0->enable = 
# 64 "board/rv1103b_evb2-SC200AI-ADC/board.c" 3 4
                        1
# 64 "board/rv1103b_evb2-SC200AI-ADC/board.c"
                            ;

    vicap->enable = 
# 66 "board/rv1103b_evb2-SC200AI-ADC/board.c" 3 4
                   1
# 66 "board/rv1103b_evb2-SC200AI-ADC/board.c"
                       ;
}
