# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/irq.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/irq.c"
# 13 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/irq.c"
...
# 14 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/irq.c" 2
...
# 51 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/irq.c"
volatile rt_uint8_t rt_interrupt_nest;
# 60 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/irq.c"
void rt_interrupt_enter(void)
{
    rt_base_t level;
    ...
    rt_interrupt_nest ++;
    do { if ((rt_interrupt_enter_hook) != (0)) rt_interrupt_enter_hook (); } while (0);
    rt_hw_interrupt_enable(level);
}
;
# 81 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/irq.c"
void rt_interrupt_leave(void)
{
    rt_base_t level;
    ...
    level = rt_hw_interrupt_disable();
    rt_interrupt_nest --;
    do { if ((rt_interrupt_leave_hook) != (0)) rt_interrupt_leave_hook (); } while (0);
    rt_hw_interrupt_enable(level);
}
;
# 103 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/irq.c"
rt_uint8_t rt_interrupt_get_nest(void)
{
