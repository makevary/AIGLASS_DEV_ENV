# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/libcpu/risc-v/scr1/interrupt.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/libcpu/risc-v/scr1/interrupt.c"
# 15 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/libcpu/risc-v/scr1/interrupt.c"
...
# 16 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/libcpu/risc-v/scr1/interrupt.c" 2
...
# 17 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/libcpu/risc-v/scr1/interrupt.c" 2
...
# 18 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/libcpu/risc-v/scr1/interrupt.c" 2
...
static void write_csr_ipic(unsigned int addr, unsigned int val)
{
    ...
    {
    case 0xbf0 :
        ({ asm volatile ("csrw " "0xbf0" ", %0" :: "rK"(val)); });
        break;
    case 0xbf1 :
        ({ asm volatile ("csrw " "0xbf1" ", %0" :: "rK"(val)); });
        break;
    case 0xbf2 :
        ({ asm volatile ("csrw " "0xbf2" ", %0" :: "rK"(val)); });
        break;
    case 0xbf3 :
        ({ asm volatile ("csrw " "0xbf3" ", %0" :: "rK"(val)); });
        break;
    case 0xbf4 :
        ({ asm volatile ("csrw " "0xbf4" ", %0" :: "rK"(val)); });
        break;
    case 0xbf5 :
        ({ asm volatile ("csrw " "0xbf5" ", %0" :: "rK"(val)); });
        break;
    case 0xbf6 :
        ({ asm volatile ("csrw " "0xbf6" ", %0" :: "rK"(val)); });
        break;
    case 0xbf7 :
        ({ asm volatile ("csrw " "0xbf7" ", %0" :: "rK"(val)); });
        break;
    default:
        break;
    }
...
static unsigned int read_csr_ipic(unsigned int addr)
{
    ...
    {
    case 0xbf0 :
        res = ({ unsigned long __tmp; asm volatile ("csrr %0, " "0xbf0" : "=r"(__tmp)); __tmp; });
        break;
    case 0xbf1 :
        res = ({ unsigned long __tmp; asm volatile ("csrr %0, " "0xbf1" : "=r"(__tmp)); __tmp; });
        break;
    case 0xbf2 :
        res = ({ unsigned long __tmp; asm volatile ("csrr %0, " "0xbf2" : "=r"(__tmp)); __tmp; });
        break;
    case 0xbf3 :
        res = ({ unsigned long __tmp; asm volatile ("csrr %0, " "0xbf3" : "=r"(__tmp)); __tmp; });
        break;
    case 0xbf4 :
        res = ({ unsigned long __tmp; asm volatile ("csrr %0, " "0xbf4" : "=r"(__tmp)); __tmp; });
        break;
    case 0xbf5 :
        res = ({ unsigned long __tmp; asm volatile ("csrr %0, " "0xbf5" : "=r"(__tmp)); __tmp; });
        break;
    case 0xbf6 :
        res = ({ unsigned long __tmp; asm volatile ("csrr %0, " "0xbf6" : "=r"(__tmp)); __tmp; });
        break;
    case 0xbf7 :
        res = ({ unsigned long __tmp; asm volatile ("csrr %0, " "0xbf7" : "=r"(__tmp)); __tmp; });
        break;
    default:
        res = 0;
    }
...
{
    ({ unsigned long __tmp; asm volatile ("csrrs %0, " "mie" ", %1" : "=r"(__tmp) : "rK"((1 << 11))); __tmp; });
}

static void m_soft_irq_init()
{
    ({ unsigned long __tmp; asm volatile ("csrrs %0, " "mie" ", %1" : "=r"(__tmp) : "rK"((1 << 3))); __tmp; });
}
...
static void m_soft_irq_handle(void)
{
    ...
    ({ unsigned long __tmp; asm volatile ("csrrc %0, " "mie" ", %1" : "=r"(__tmp) : "rK"((1 << 3))); __tmp; });
...
void handle_trap(unsigned int i_mcause, unsigned int i_mepc, unsigned int i_sp)
{
    ...
    else
    {
        ...
        case 2:
            ...
            break;
        case 3:
            ({ asm volatile ("csrw " "mepc" ", %0" :: "rK"(i_mepc + 4)); });
...
__attribute__((weak)) void rt_hw_interrupt_active(int vector) {}

void rt_hw_interrupt_init(void)
{
    ({ asm volatile ("csrw " "mtvec" ", %0" :: "rK"(&trap_entry)); });
    m_ext_irq_init();
    m_soft_irq_init();
}
...
{
    rt_isr_handler_t old_handler = (0);
    ...
    if (vector < NUM_INTERRUPTS)
    {
        ...
        if (handler != (0))
        {
            ...
            write_csr_ipic(0xbf6, vector / 32);
            write_csr_ipic(0xbf7, (1 << 1));
