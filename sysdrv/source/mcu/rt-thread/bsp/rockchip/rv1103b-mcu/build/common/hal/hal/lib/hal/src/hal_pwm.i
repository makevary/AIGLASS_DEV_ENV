# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
...
# 7 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 2
# 231 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
__attribute__((always_inline)) static inline void Hal_PWM_ParaCheck(struct PWM_HANDLE *pPWM, uint8_t channel)
{
    ;
...
# 259 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_ChannelIRQHandler(struct PWM_HANDLE *pPWM, uint8_t channel)
{
    struct PWM_REG *reg;
    uint32_t status;
    ...
    status = ((*(volatile const uint32_t *)&(reg->INTSTS)));
    if (status & (1 << ((0U)))) {
        ((*(volatile uint32_t *)&(reg->INTSTS)) = ((1 << ((0U)))));
        pPWM->pChHandle[channel].result.negCycles = ((*(volatile const uint32_t *)&(reg->LPC)));
    }

    if (status & (1 << ((1U)))) {
        ((*(volatile uint32_t *)&(reg->INTSTS)) = ((1 << ((1U)))));
        pPWM->pChHandle[channel].result.posCycles = ((*(volatile const uint32_t *)&(reg->HPC)));
    }

    return HAL_OK;
}
# 289 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_SetConfig(struct PWM_HANDLE *pPWM, uint8_t channel,
                             const struct HAL_PWM_CONFIG *config)
{
    struct PWM_REG *reg;
    ...
    ;
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "channel=%d, period_ns=%" 
# 302 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3
   "l" 
# 302 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   "d" ", duty_ns=%" 
# 302 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3
   "l" 
# 302 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   "d" "\n", channel, config->periodNS, config->dutyNS); } while (0)
                                                      ;
    ...
    ((*(volatile uint32_t *)&(reg->PERIOD)) = (period));
    ((*(volatile uint32_t *)&(reg->DUTY)) = (duty));

    if (config->polarity) {
        ((*(volatile uint32_t *)&(reg->CTRL)) = (((((0 << 0) | (1 << 1)) << (2)) | ((((~0U) << (2)) & (~0U >> (32 - 1 - (3)))) << 16))));
    } else {
        ((*(volatile uint32_t *)&(reg->CTRL)) = (((((1 << 0) | (0 << 1)) << (2)) | ((((~0U) << (2)) & (~0U >> (32 - 1 - (3)))) << 16))));
    }

    switch (config->alignedMode) {
    case HAL_PWM_LEFT_ALIGNED:
        ((*(volatile uint32_t *)&(reg->CTRL)) = ((((
# 323 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
       1
# 323 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
       ) << (5)) | ((((~0U) << (5)) & (~0U >> (32 - 1 - (5)))) << 16)) | (((HAL_PWM_LEFT_ALIGNED) << (4)) | ((((~0U) << (4)) & (~0U >> (32 - 1 - (4)))) << 16))));
        break;
    case HAL_PWM_CENTER_ALIGNED:
        ((*(volatile uint32_t *)&(reg->CTRL)) = ((((
# 326 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
       1
# 326 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
       ) << (5)) | ((((~0U) << (5)) & (~0U >> (32 - 1 - (5)))) << 16)) | (((HAL_PWM_CENTER_ALIGNED) << (4)) | ((((~0U) << (4)) & (~0U >> (32 - 1 - (4)))) << 16))));
        break;
    case HAL_PWM_UNALIGNED:
    default:
        ((*(volatile uint32_t *)&(reg->CTRL)) = ((((
# 330 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
       0
# 330 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
       ) << (5)) | ((((~0U) << (5)) & (~0U >> (32 - 1 - (5)))) << 16))));
        break;
    }

    ((*(volatile uint32_t *)&(reg->ENABLE)) = ((((
# 334 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   1
# 334 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (2)) | ((((~0U) << (2)) & (~0U >> (32 - 1 - (2)))) << 16))));

    do { if (0) HAL_DBG_Printf("[HAL INFO] " "channel=%d, period=%" 
# 336 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3
   "l" 
# 336 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   "u" ", duty=%" 
# 336 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3
   "l" 
# 336 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   "u" ", polarity=%d\n", channel, period, duty, config->polarity); } while (0)
                                                    ;

    return HAL_OK;
}
# 350 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_SetOneshot(struct PWM_HANDLE *pPWM, uint8_t channel, uint32_t count)
{
    struct PWM_REG *reg;
    ...
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "Oneshot count=%" 
# 357 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3
   "l" 
# 357 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   "d" "\n", count); } while (0);

    ((*(volatile uint32_t *)&(reg->RPT)) = (count));

    return HAL_OK;
}
# 372 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_SetCapturedFreq(struct PWM_HANDLE *pPWM, uint8_t channel, uint32_t freq)
{
    struct PWM_REG *reg;
    ...
    ;
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "Captured freq=%" 
# 380 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3
   "l" 
# 380 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   "d" "\n", freq); } while (0);

    ((*(volatile uint32_t *)&(reg->CLK_CTRL)) = ((((pPWM->freq / (2 * freq)) << (4)) | ((((~0U) << (4)) & (~0U >> (32 - 1 - (12)))) << 16))));

    return HAL_OK;
}
# 395 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_SetMatch(struct PWM_HANDLE *pPWM, uint8_t channel, const struct PWM_MATCH *data)
{
    struct PWM_REG *reg;
    uint32_t val;
    ...
    val = (1 << (channel)) << (16U) |
          (1 << (channel)) << (0U);
    ((*(volatile uint32_t *)&(reg->PWRMATCH_ARBITER)) = (val));


    ((*(volatile uint32_t *)&(reg->PWRMATCH_LPRE)) = (data->lpreMin | (data->lpreMax << (16U))));

    ((*(volatile uint32_t *)&(reg->PWRMATCH_HPRE)) = (data->hpreMin | (data->hpreMax << (16U))));

    ((*(volatile uint32_t *)&(reg->PWRMATCH_LD)) = (data->ldMin | (data->ldMax << (16U))));

    ((*(volatile uint32_t *)&(reg->PWRMATCH_HD_ZERO)) = (data->hdZeroMin | (data->hdZeroMax << (16U))));

    ((*(volatile uint32_t *)&(reg->PWRMATCH_HD_ONE)) = (data->hdOneMin | (data->hdOneMax << (16U))));

    for (i = 0; i < data->matchCount; i++) {
        ((*(volatile uint32_t *)&(reg->PWRMATCH_VALUE[i])) = (data->match[i]));
    }


    ((*(volatile uint32_t *)&(reg->INT_EN)) = ((((
# 427 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   1
# 427 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (5)) | ((((~0U) << (5)) & (~0U >> (32 - 1 - (5)))) << 16))));

    ((*(volatile uint32_t *)&(reg->PWRMATCH_CTRL)) = ((((
# 429 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   1
# 429 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (0)) | ((((~0U) << (0)) & (~0U >> (32 - 1 - (0)))) << 16))));

    return HAL_OK;
}
# 442 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_SetOutputOffset(struct PWM_HANDLE *pPWM, uint8_t channel, uint32_t offsetNS)
{
    struct PWM_REG *reg;
    uint32_t period, duty;
    ...
    period = ((*(volatile const uint32_t *)&(reg->PERIOD)));
    duty = ((*(volatile const uint32_t *)&(reg->DUTY)));
    ...
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "channel=%d, offsetNS=%" 
# 460 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3
   "l" 
# 460 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   "d" "\n", channel, offsetNS); } while (0);

    ((*(volatile uint32_t *)&(reg->OFFSET)) = (outOffset));

    return HAL_OK;
}
# 475 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_GlobalLock(struct PWM_HANDLE *pPWM, uint8_t channelMask)
{
    struct PWM_REG *reg;
    ...
    ;
    ;
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "globalMask=0x%04x, global lock\n", channelMask); } while (0);
    ...
    while (ffs(channelMask)) {
        ...
        ((*(volatile uint32_t *)&(reg->ENABLE)) = ((((
# 495 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
       1
# 495 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
       ) << (4)) | ((((~0U) << (4)) & (~0U >> (32 - 1 - (4)))) << 16))));
        ((*(volatile uint32_t *)&(reg->CLK_CTRL)) = ((((
# 496 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
       1
# 496 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
       ) << (15)) | ((((~0U) << (15)) & (~0U >> (32 - 1 - (15)))) << 16))));

        if (!pPWM->globalGrantMask) {
            val = (1 << (channelId)) << (16U) |
                  (1 << (channelId)) << (0U);
            ((*(volatile uint32_t *)&(reg->GLOBAL_ARBITER)) = (val));

            pPWM->globalGrantMask = (1 << (channelId));
        }
...
# 520 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_GlobalUnlock(struct PWM_HANDLE *pPWM, uint8_t channelMask)
{
    struct PWM_REG *reg;
    ...
    ;
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "globalMask=0x%04x, globalGrantMask=0x%04x, global unlock\n", pPWM->globalMask, pPWM->globalGrantMask); } while (0);
    ...
    while (ffs(pPWM->globalMask)) {
        ...
        if (channelId == grantId) {
            ((*(volatile uint32_t *)&(reg->GLOBAL_ARBITER)) = (0));

            pPWM->globalGrantMask = 0;
        }

        ((*(volatile uint32_t *)&(reg->ENABLE)) = ((((
# 543 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
       0
# 543 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
       ) << (4)) | ((((~0U) << (4)) & (~0U >> (32 - 1 - (4)))) << 16))));
        ((*(volatile uint32_t *)&(reg->CLK_CTRL)) = ((((
# 544 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
       0
# 544 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
       ) << (15)) | ((((~0U) << (15)) & (~0U >> (32 - 1 - (15)))) << 16))));

        pPWM->globalMask &= ~(1 << (channelId));
    }
...
HAL_Status HAL_PWM_GlobalUpdate(struct PWM_HANDLE *pPWM)
{
    ...
    ;
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "globalMask=0x%04x, globalGrantMask=0x%04x, global update\n", pPWM->globalMask, pPWM->globalGrantMask); } while (0);
    ...
    ((*(volatile uint32_t *)&(reg->GLOBAL_CTRL)) = ((((
# 572 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   1
# 572 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (1)) | ((((~0U) << (1)) & (~0U >> (32 - 1 - (1)))) << 16))));
...
HAL_Status HAL_PWM_GlobalEnable(struct PWM_HANDLE *pPWM)
{
    ...
    ((*(volatile uint32_t *)&(reg->ENABLE)) = ((((
# 597 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   1
# 597 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (0)) | ((((~0U) << (0)) & (~0U >> (32 - 1 - (0)))) << 16))));
    ((*(volatile uint32_t *)&(reg->GLOBAL_CTRL)) = ((((
# 598 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   1
# 598 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (0)) | ((((~0U) << (0)) & (~0U >> (32 - 1 - (0)))) << 16))));
...
HAL_Status HAL_PWM_GlobalDisable(struct PWM_HANDLE *pPWM)
{
    ...
    ((*(volatile uint32_t *)&(reg->ENABLE)) = ((((
# 623 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   0
# 623 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (0)) | ((((~0U) << (0)) & (~0U >> (32 - 1 - (0)))) << 16))));
    ((*(volatile uint32_t *)&(reg->GLOBAL_CTRL)) = ((((
# 624 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   0
# 624 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (1)) | ((((~0U) << (1)) & (~0U >> (32 - 1 - (1)))) << 16))));

    return HAL_OK;
}
# 637 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
                                    ...
                                    ePWM_captureIntMode mode)
{
    ...
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "channel=%d, capture interrupt mode=%d enable\n", channel, mode); } while (0);

    val = (((!!(mode & HAL_PWM_CAP_LPR_INT)) << (0)) | ((((~0U) << (0)) & (~0U >> (32 - 1 - (0)))) << 16)) |
          (((!!(mode & HAL_PWM_CAP_HPR_INT)) << (1)) | ((((~0U) << (1)) & (~0U >> (32 - 1 - (1)))) << 16)) |
          (((channel) << (6)) | ((((~0U) << (6)) & (~0U >> (32 - 1 - (8)))) << 16));
    ((*(volatile uint32_t *)&(reg->INT_EN)) = (val));

    return HAL_OK;
}
# 663 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_DisableCaptureInt(struct PWM_HANDLE *pPWM, uint8_t channel)
{
    struct PWM_REG *reg;
    uint32_t val;
    ...
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "channel=%d, capture interrupt disable\n", channel); } while (0);

    val = (((
# 673 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
         0
# 673 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
         ) << (0)) | ((((~0U) << (0)) & (~0U >> (32 - 1 - (0)))) << 16)) |
          (((
# 674 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
         0
# 674 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
         ) << (1)) | ((((~0U) << (1)) & (~0U >> (32 - 1 - (1)))) << 16)) |
          (((0) << (6)) | ((((~0U) << (6)) & (~0U >> (32 - 1 - (8)))) << 16));
    ((*(volatile uint32_t *)&(reg->INT_EN)) = (val));

    return HAL_OK;
}
# 688 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
uint64_t HAL_PWM_GetCaptureHighNs(struct PWM_HANDLE *pPWM, uint8_t channel)
{
    struct PWM_REG *reg;
    ...
    return HAL_DivU64((uint64_t)(((*(volatile const uint32_t *)&(reg->HPC))) * 1000000000ULL), pPWM->freq);
}
# 705 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
uint64_t HAL_PWM_GetCaptureLowNs(struct PWM_HANDLE *pPWM, uint8_t channel)
{
    struct PWM_REG *reg;
    ...
    return HAL_DivU64((uint64_t)(((*(volatile const uint32_t *)&(reg->LPC))) * 1000000000ULL), pPWM->freq);
}
# 722 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
ePWM_Mode HAL_PWM_GetMode(struct PWM_HANDLE *pPWM, uint8_t channel)
{
    struct PWM_REG *reg;
    uint32_t ctrl;
    ...
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "channel=%d\n", channel); } while (0);

    ctrl = ((*(volatile const uint32_t *)&(reg->CTRL)));

    return (ePWM_Mode)((ctrl >> (0U)) & (0x3U << (0U)));
}
# 745 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_Enable(struct PWM_HANDLE *pPWM, uint8_t channel, ePWM_Mode mode)
{
    struct PWM_REG *reg;
    ...
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "Enable channel=%d\n", channel); } while (0);

    pPWM->pChHandle[channel].mode = mode;

    if (mode == HAL_PWM_ONE_SHOT) {
        ((*(volatile uint32_t *)&(reg->CTRL)) = ((((0) << (0)) | ((((~0U) << (0)) & (~0U >> (32 - 1 - (1)))) << 16)) | (((
# 757 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
       1
# 757 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
       ) << (5)) | ((((~0U) << (5)) & (~0U >> (32 - 1 - (5)))) << 16))));
        ((*(volatile uint32_t *)&(reg->INT_EN)) = ((((
# 758 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
       1
# 758 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
       ) << (2)) | ((((~0U) << (2)) & (~0U >> (32 - 1 - (2)))) << 16))));
    } else if (mode == HAL_PWM_CONTINUOUS) {
        ((*(volatile uint32_t *)&(reg->CTRL)) = ((((1) << (0)) | ((((~0U) << (0)) & (~0U >> (32 - 1 - (1)))) << 16)) | (((
# 760 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
       0
# 760 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
       ) << (5)) | ((((~0U) << (5)) & (~0U >> (32 - 1 - (5)))) << 16))));
    } else if (mode == HAL_PWM_CAPTURE) {
        ((*(volatile uint32_t *)&(reg->CTRL)) = ((((2) << (0)) | ((((~0U) << (0)) & (~0U >> (32 - 1 - (1)))) << 16)) | (((
# 762 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
       0
# 762 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
       ) << (5)) | ((((~0U) << (5)) & (~0U >> (32 - 1 - (5)))) << 16))));
    }

    ((*(volatile uint32_t *)&(reg->ENABLE)) = ((((
# 765 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   1
# 765 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (1)) | ((((~0U) << (1)) & (~0U >> (32 - 1 - (1)))) << 16)) | (((
# 765 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   1
# 765 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
...
# 777 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_Disable(struct PWM_HANDLE *pPWM, uint8_t channel)
{
    struct PWM_REG *reg;
    ...
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "Disable channel=%d\n", channel); } while (0);

    ((*(volatile uint32_t *)&(reg->INT_EN)) = ((((
# 786 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   0
# 786 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (2)) | ((((~0U) << (2)) & (~0U >> (32 - 1 - (2)))) << 16))));
    ((*(volatile uint32_t *)&(reg->ENABLE)) = ((((
# 787 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   0
# 787 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (1)) | ((((~0U) << (1)) & (~0U >> (32 - 1 - (1)))) << 16)) | (((
# 787 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   0
# 787 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
...
# 799 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_EnableCounter(struct PWM_HANDLE *pPWM, uint8_t channel)
{
    struct PWM_REG *reg;
    ...
    if (!pPWM->counterSupport) {
        do { if (0) HAL_DBG_Printf("[HAL INFO] " "channel=%d, unsupported counter mode\n", channel); } while (0);

        return HAL_INVAL;
    }
    reg = pPWM->pChHandle[channel].pReg;

    do { if (0) HAL_DBG_Printf("[HAL INFO] " "channel=%d, wave counter enable\n", channel); } while (0);

    arbiter = (1 << (channel)) << (16U) |
              (1 << (channel)) << (0U);
    ((*(volatile uint32_t *)&(reg->COUNTER_ARBITER)) = (arbiter));

    val = ((*(volatile const uint32_t *)&(reg->COUNTER_ARBITER)));
    if (!(val & arbiter)) {
        do { if (0) HAL_DBG_Printf("[HAL ERROR] " "failed to abtain counter arbitration for channel%d\n", channel); } while (0);

        return HAL_INVAL;
    }

    ((*(volatile uint32_t *)&(reg->COUNTER_CTRL)) = ((((
# 826 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   1
# 826 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (0)) | ((((~0U) << (0)) & (~0U >> (32 - 1 - (0)))) << 16)) | (((channel) << (3)) | ((((~0U) << (3)) & (~0U >> (32 - 1 - (5)))) << 16))));

    return HAL_OK;
}
# 838 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_DisableCounter(struct PWM_HANDLE *pPWM, uint8_t channel)
{
    struct PWM_REG *reg;
    ...
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "channel=%d, wave counter disable\n", channel); } while (0);

    ((*(volatile uint32_t *)&(reg->COUNTER_CTRL)) = ((((
# 853 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   0
# 853 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (0)) | ((((~0U) << (0)) & (~0U >> (32 - 1 - (0)))) << 16)) | (((0) << (3)) | ((((~0U) << (3)) & (~0U >> (32 - 1 - (5)))) << 16))));

    ((*(volatile uint32_t *)&(reg->COUNTER_ARBITER)) = (0));

    return HAL_OK;
}
# 868 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_GetCounterRes(struct PWM_HANDLE *pPWM, uint8_t channel, uint64_t *cntRes)
{
    struct PWM_REG *reg;
    uint64_t low, high;
    ...
    low = ((*(volatile const uint32_t *)&(reg->COUNTER_LOW)));
    high = ((*(volatile const uint32_t *)&(reg->COUNTER_HIGH)));
...
# 902 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_ClearCounterRes(struct PWM_HANDLE *pPWM, uint8_t channel)
{
    struct PWM_REG *reg;
    ...
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "channel=%d, clear wave counter result\n", channel); } while (0);

    ((*(volatile uint32_t *)&(reg->COUNTER_CTRL)) = ((((
# 917 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   1
# 917 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (6)) | ((((~0U) << (6)) & (~0U >> (32 - 1 - (6)))) << 16))));

    return HAL_OK;
}
# 930 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_EnableFreqMeter(struct PWM_HANDLE *pPWM, uint8_t channel, uint32_t delayMs)
{
    struct PWM_REG *reg;
    ...
    if (!pPWM->freqMeterSupport) {
        do { if (0) HAL_DBG_Printf("[HAL INFO] " "channel=%d, unsupported frequency meter mode\n", channel); } while (0);
    ...
    ;
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "channel=%d, frequency meter enable\n", channel); } while (0);

    arbiter = (1 << (channel)) << (16U) |
              (1 << (channel)) << (0U);
    ((*(volatile uint32_t *)&(reg->FREQ_ARBITER)) = (arbiter));

    val = ((*(volatile const uint32_t *)&(reg->FREQ_ARBITER)));
    if (!(val & arbiter)) {
        do { if (0) HAL_DBG_Printf("[HAL ERROR] " "failed to abtain frequency meter arbitration for channel%d\n", channel); } while (0);
    ...
    ((*(volatile uint32_t *)&(reg->FREQ_TIMER_VALUE)) = (timerVal));

    ((*(volatile uint32_t *)&(reg->INT_EN)) = ((((
# 963 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   1
# 963 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (4)) | ((((~0U) << (4)) & (~0U >> (32 - 1 - (4)))) << 16))));
    ((*(volatile uint32_t *)&(reg->FREQ_CTRL)) = ((((
# 964 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   1
# 964 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (0)) | ((((~0U) << (0)) & (~0U >> (32 - 1 - (0)))) << 16)) | (((channel) << (3)) | ((((~0U) << (3)) & (~0U >> (32 - 1 - (5)))) << 16))));

    return HAL_OK;
}
# 976 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_DisableFreqMeter(struct PWM_HANDLE *pPWM, uint8_t channel)
{
    struct PWM_REG *reg;
    ...
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "channel=%d, frequency meter disable\n", channel); } while (0);

    ((*(volatile uint32_t *)&(reg->FREQ_TIMER_VALUE)) = (0));
    ((*(volatile uint32_t *)&(reg->INT_EN)) = ((((
# 992 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   0
# 992 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (4)) | ((((~0U) << (4)) & (~0U >> (32 - 1 - (4)))) << 16))));
    ((*(volatile uint32_t *)&(reg->FREQ_CTRL)) = ((((
# 993 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3 4
   0
# 993 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   ) << (0)) | ((((~0U) << (0)) & (~0U >> (32 - 1 - (0)))) << 16)) | (((0) << (3)) | ((((~0U) << (3)) & (~0U >> (32 - 1 - (5)))) << 16))));

    ((*(volatile uint32_t *)&(reg->FREQ_ARBITER)) = (0));

    return HAL_OK;
}
# 1009 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_GetFreqMeterRes(struct PWM_HANDLE *pPWM, uint8_t channel, uint32_t delayMs, uint32_t *freqHz)
{
    struct PWM_REG *reg;
    uint32_t status;
    ...
    ((*(volatile uint32_t *)&(reg->INTSTS)) = ((1 << ((4U)))));

    freqRes = ((*(volatile const uint32_t *)&(reg->FREQ_RESULT_VALUE)));
    freqTimer = ((*(volatile const uint32_t *)&(reg->FREQ_TIMER_VALUE)));
    *freqHz = HAL_DivU64((uint64_t)pPWM->freq * freqRes, freqTimer);
    if (!*freqHz) {
        return HAL_INVAL;
    }

    do { if (0) HAL_DBG_Printf("[HAL INFO] " "channel=%d, frequency meter get result: %" 
# 1043 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c" 3
   "l" 
# 1043 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
   "d" "Hz\n", channel, *freqHz); } while (0);

    return HAL_OK;
}
# 1724 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
HAL_Status HAL_PWM_Init(struct PWM_HANDLE *pPWM, struct PWM_REG *pReg, uint32_t freq)
{
    ...
    version = ((*(volatile const uint32_t *)&(pReg->VERSION_ID)));
    pPWM->channelNum = (version & (0xFU << (0U))) >> (0U);
    pPWM->freqMeterSupport = !!(version & (0x1U << (10U)));
    pPWM->counterSupport = !!(version & (0x1U << (11U)));
    pPWM->waveSupport = !!(version & (0x1U << (12U)));

    for (i = 0; i < pPWM->channelNum; i++) {
        reg = (uint32_t)pReg + i * (0x1000);
        pPWM->pChHandle[i].pReg = (struct PWM_REG *)(reg);
    }
# 1754 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_pwm.c"
    return HAL_OK;
}
