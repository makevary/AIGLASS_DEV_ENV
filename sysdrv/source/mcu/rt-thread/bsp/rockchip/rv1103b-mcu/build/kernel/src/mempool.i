# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mempool.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mempool.c"
# 19 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mempool.c"
...
# 20 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mempool.c" 2
...
# 40 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mempool.c"
void rt_mp_alloc_sethook(void (*hook)(struct rt_mempool *mp, void *block))
{
...
# 77 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mempool.c"
rt_err_t rt_mp_init(struct rt_mempool *mp,
                    const char *name,
                    void *start,
                    rt_size_t size,
...
;
# 132 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mempool.c"
rt_err_t rt_mp_detach(struct rt_mempool *mp)
{
    ...
    while (!rt_list_isempty(&(mp->suspend_thread)))
    {
        ...
        thread = ((struct rt_thread *)((char *)(mp->suspend_thread.next) - (unsigned long)(&((struct rt_thread *)0)->tlist)));
...
;
# 185 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mempool.c"
rt_mp_t rt_mp_create(const char *name,
                     rt_size_t block_count,
                     rt_size_t block_size)
{
...
;
# 248 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mempool.c"
rt_err_t rt_mp_delete(rt_mp_t mp)
{
    struct rt_thread *thread;
    register rt_ubase_t temp;
...
;
# 304 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mempool.c"
void *rt_mp_alloc(rt_mp_t mp, rt_int32_t time)
{
    rt_uint8_t *block_ptr;
    ...
    *(rt_uint8_t **)block_ptr = (rt_uint8_t *)mp;
    ...
    do { if ((rt_mp_alloc_hook) != (0)) rt_mp_alloc_hook (mp, (rt_uint8_t *)(block_ptr + sizeof(rt_uint8_t *))); } while (0)
                                                                               ;
...
void rt_mp_free(void *block)
{
    ...
    do { if ((rt_mp_free_hook) != (0)) rt_mp_free_hook (mp, block); } while (0);
