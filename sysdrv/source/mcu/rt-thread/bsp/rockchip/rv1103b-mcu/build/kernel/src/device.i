# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c"
# 17 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c"
...
# 18 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c" 2
# 49 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c"
rt_err_t rt_device_register(rt_device_t dev,
                            const char *name,
                            rt_uint16_t flags)
{
...
;
# 80 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c"
rt_err_t rt_device_unregister(rt_device_t dev)
{
    ;
    ;
...
;
# 100 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c"
rt_err_t rt_device_init_all(void)
{
    return 0;
}
# 112 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c"
rt_device_t rt_device_find(const char *name)
{
...
;
# 158 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c"
rt_device_t rt_device_create(int type, int attach_size)
{
    int size;
    rt_device_t device;

    size = (((sizeof(struct rt_device)) + (4) - 1) & ~((4) - 1));
    attach_size = (((attach_size) + (4) - 1) & ~((4) - 1));
...
;
# 205 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c"
rt_err_t rt_device_init(rt_device_t dev)
{
    rt_err_t result = 0;
...
# 240 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c"
rt_err_t rt_device_open(rt_device_t dev, rt_uint16_t oflag)
{
    rt_err_t result = 0;
...
;
# 305 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c"
rt_err_t rt_device_close(rt_device_t dev)
{
    rt_err_t result = 0;
...
;
# 346 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c"
rt_size_t rt_device_read(rt_device_t dev,
                         rt_off_t pos,
                         void *buffer,
                         rt_size_t size)
...
;
# 385 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c"
rt_size_t rt_device_write(rt_device_t dev,
                          rt_off_t pos,
                          const void *buffer,
                          rt_size_t size)
...
;
# 421 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c"
rt_err_t rt_device_control(rt_device_t dev, int cmd, void *arg)
{
    ;
    ;
...
;
# 445 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c"
rt_err_t
rt_device_set_rx_indicate(rt_device_t dev,
                          rt_err_t (*rx_ind)(rt_device_t dev, rt_size_t size))
{
...
;
# 467 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/device.c"
rt_err_t
rt_device_set_tx_complete(rt_device_t dev,
                          rt_err_t (*tx_done)(rt_device_t dev, void *buffer))
{
