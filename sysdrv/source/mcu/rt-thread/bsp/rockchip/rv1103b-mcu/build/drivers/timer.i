...
{
    *(volatile unsigned int *)(0xff1e0000 + 0x0008) = 0x00;
    *(volatile unsigned int *)(0xff1e0000 + 0x000C) = 0x00;
}

static void _reset_mtimecmp()
{
    *(volatile unsigned int *)(0xff1e0000 + 0x0010) = 0x00;
    *(volatile unsigned int *)(0xff1e0000 + 0x0014) = 0x00;
}

static void _write_mtime_ctrl(unsigned int t)
{
    *(volatile unsigned int *)(0xff1e0000 + 0x0000) = t;
}

static void _write_mtime_div(unsigned int t)
{
    *(volatile unsigned int *)(0xff1e0000 + 0x0004) = t;
}

static void _write_mtimecmp(unsigned int t)
{
    *(volatile unsigned int *)(0xff1e0000 + 0x0010) = t;
}

static void _write_mtimecmph(unsigned int t)
{
    *(volatile unsigned int *)(0xff1e0000 + 0x0014) = t;
}

static void _write_mtime(unsigned int t)
{
    *(volatile unsigned int *)(0xff1e0000 + 0x0008) = t;
}

static void _write_mtimeh(unsigned int t)
{
    *(volatile unsigned int *)(0xff1e0000 + 0x000C) = t;
}

static unsigned int _read_mtimecmp()
{
    return *(volatile unsigned int *)(0xff1e0000 + 0x0010);
}

static unsigned int _read_mtimecmph()
{
    return *(volatile unsigned int *)(0xff1e0000 + 0x0014);
}

static unsigned int _read_mtime()
{
    return *(volatile unsigned int *)(0xff1e0000 + 0x0008);
}

static unsigned int _read_mtimeh()
{
    return *(volatile unsigned int *)(0xff1e0000 + 0x000C);
}

static unsigned int _read_mtime_ctrl()
{
    return *(volatile unsigned int *)(0xff1e0000 + 0x0000);
}

static unsigned int _read_mtime_div()
{
    return *(volatile unsigned int *)(0xff1e0000 + 0x0004);
}

static void _run_timer()
{
    unsigned int temp;
    temp = *(volatile unsigned int *)(0xff1e0000 + 0x0000);
    temp |= (1 << 0);
    *(volatile unsigned int *)(0xff1e0000 + 0x0000) = temp;
}
...
void _update_timer(void)
{
    ({ unsigned long __tmp; asm volatile ("csrrc %0, " "mie" ", %1" : "=r"(__tmp) : "rK"((1 << 7))); __tmp; });
    _write_mtimecmp(-1);
    _write_mtimecmph(0);
    ...
    ({ unsigned long __tmp; asm volatile ("csrrs %0, " "mie" ", %1" : "=r"(__tmp) : "rK"((1 << 7))); __tmp; });
}
...
void sysTick_config(unsigned int ticks)
{
    ...
    _reset_mtime();
    _reset_mtimecmp();
    _write_mtime_div(1000);
    _write_mtimecmp(ticks / 1000);
    timer_cmp.time_cmp = ticks / 1000;
    timer_cmp.time_cmph = 0;
    timer_cmp.step = ticks / 1000;
    ({ unsigned long __tmp; asm volatile ("csrrs %0, " "mie" ", %1" : "=r"(__tmp) : "rK"((1 << 7))); __tmp; });
    _run_timer();
}
