# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
# 13 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
...
# 14 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c" 2
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/inc/hal_cache.h" 1
# 15 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c" 2
# 47 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
...
# 89 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
uintptr_t HAL_CpuAddrToDmaAddr(uintptr_t cpuAddr)
{
    uintptr_t sramAddr = cpuAddr;
# 120 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
    return sramAddr;
}
# 145 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
HAL_Status HAL_ICACHE_Enable(void)
{
    ...
    ((struct ICACHE_REG *) 0x206A0000U)->CACHE_CTRL |=
        ((0x1U << (0U)) | (0x1U << (1U)));
    ((struct ICACHE_REG *) 0x206A0000U)->CACHE_CTRL &= (~(0x1U << (3U)));
# 169 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
    do {
        status =
            ((struct ICACHE_REG *) 0x206A0000U)->CACHE_STATUS & (0x1U << (0U));
    } while (status == 0);

    ((struct ICACHE_REG *) 0x206A0000U)->CACHE_CTRL &= ~(0x1U << (6U));

    HAL_SYS_ExitCriticalSection(flags);
# 186 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
    return HAL_OK;
}
...
HAL_Status HAL_ICACHE_Disable(void)
{
    ...
    HAL_SYS_ExitCriticalSection(flags);
# 216 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
    return HAL_OK;
}
...
HAL_Status HAL_ICACHE_Invalidate(void)
{
    ...
    if ((uint32_t)((struct DCACHE_REG *) 0x206A0000U) == (uint32_t)((struct ICACHE_REG *) 0x206A0000U)) {
        if (((struct DCACHE_REG *) 0x206A0000U)->CACHE_CTRL & (0x1U << (1U))) {
            return HAL_OK;
        } else {
            return HAL_INVAL;
        }
    ...
    ((struct ICACHE_REG *) 0x206A0000U)->CACHE_MAINTAIN[0] =
        0x6U | (0x1U << (0U));

    do {
        status = ((struct ICACHE_REG *) 0x206A0000U)->CACHE_STATUS &
                 (0x1U << (1U));
    } while (status);

    HAL_SYS_ExitCriticalSection(flags);
# 261 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
    return HAL_OK;
}
                                        ...
                                        uint32_t sizeByte)
{
    ...
    offset = ((address & ((0x1U << (5U)) - 1)) + sizeByte - 1) >> (5U);
    value = (address & (0x7FFFFFFU << (5U))) |
            0x2U | (0x1U << (0U));

    flags = HAL_SYS_EnterCriticalSection();

    ((struct ICACHE_REG *) 0x206A0000U)->CACHE_MAINTAIN[1] = offset;
    ((struct ICACHE_REG *) 0x206A0000U)->CACHE_MAINTAIN[0] = value;
    ...
    HAL_SYS_ExitCriticalSection(flags);
# 314 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
    return HAL_OK;
}
...
HAL_Status HAL_ICACHE_EnablePMU(void)
{
    ...
    ((struct ICACHE_REG *) 0x206A0000U)->CACHE_CTRL |= (0x1U << (5U));
...
HAL_Status HAL_ICACHE_GetPMU(struct CACHE_PMU_CNT *stat)
{
    ...
    stat->rdNum = ((struct ICACHE_REG *) 0x206A0000U)->PMU_RD_NUM_CNT;
    stat->wrNum = ((struct ICACHE_REG *) 0x206A0000U)->PMU_WR_NUM_CNT;
    stat->sramRdHit = ((struct ICACHE_REG *) 0x206A0000U)->PMU_SRAM_RD_HIT_CNT;
    stat->hbRdHit = ((struct ICACHE_REG *) 0x206A0000U)->PMU_HB_RD_HIT_CNT;
    stat->stbRdHit = ((struct ICACHE_REG *) 0x206A0000U)->PMU_STB_RD_HIT_CNT;
    stat->rdHit = ((struct ICACHE_REG *) 0x206A0000U)->PMU_RD_HIT_CNT;
    stat->wrHit = ((struct ICACHE_REG *) 0x206A0000U)->PMU_WR_HIT_CNT;
    stat->rdMissPenalty = ((struct ICACHE_REG *) 0x206A0000U)->PMU_RD_MISS_PENALTY_CNT;
    stat->wrMissPenalty = ((struct ICACHE_REG *) 0x206A0000U)->PMU_WR_MISS_PENALTY_CNT;
    stat->rdLat = ((struct ICACHE_REG *) 0x206A0000U)->PMU_RD_LAT_CNT;
    stat->wrLat = ((struct ICACHE_REG *) 0x206A0000U)->PMU_WR_LAT_CNT;
...
HAL_Status HAL_ICACHE_EnableInt(void)
{
    ...
    ((struct ICACHE_REG *) 0x206A0000U)->CACHE_INT_EN |= (0x1U << (0U));
...
HAL_Check HAL_ICACHE_GetInt(void)
{
    ...
    status = ((struct ICACHE_REG *) 0x206A0000U)->CACHE_INT_ST & (0x1U << (0U));
...
uintptr_t HAL_ICACHE_GetErrAddr(void)
{
    ...
    address = ((struct ICACHE_REG *) 0x206A0000U)->CACHE_ERR_HADDR;
...
HAL_Status HAL_ICACHE_ClearInt(void)
{
    ...
    ((struct ICACHE_REG *) 0x206A0000U)->CACHE_INT_ST |= (0x1U << (0U));
...
HAL_Status HAL_DCACHE_Enable(void)
{
    ...
    ((struct DCACHE_REG *) 0x206A0000U)->CACHE_CTRL |=
        (0x1U << (0U))
        | (7U << (8U))
        | (0x1U << (7U));
    ((struct DCACHE_REG *) 0x206A0000U)->STB_TIMEOUT_CTRL = 1;
# 543 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
    do {
        status =
            ((struct DCACHE_REG *) 0x206A0000U)->CACHE_STATUS & (0x1U << (0U));
    } while (status == 0);

    ((struct DCACHE_REG *) 0x206A0000U)->CACHE_CTRL &= ~(0x1U << (6U));

    HAL_SYS_ExitCriticalSection(flags);
# 560 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
    return HAL_OK;
}
...
HAL_Status HAL_DCACHE_Disable(void)
{
    ...
    HAL_SYS_ExitCriticalSection(flags);
# 590 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
    return HAL_OK;
}
...
HAL_Status HAL_DCACHE_Invalidate(void)
{
    ...
    ((struct DCACHE_REG *) 0x206A0000U)->CACHE_MAINTAIN[0] =
        0x6U | (0x1U << (0U));

    do {
        status = ((struct DCACHE_REG *) 0x206A0000U)->CACHE_STATUS &
                 (0x1U << (1U));
    } while (status);

    HAL_SYS_ExitCriticalSection(flags);
# 638 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
    return HAL_OK;
}
                                        ...
                                        uint32_t sizeByte)
{
    ...
    ((struct DCACHE_REG *) 0x206A0000U)->CACHE_MAINTAIN[1] = offset;
    ((struct DCACHE_REG *) 0x206A0000U)->CACHE_MAINTAIN[0] = value;
    ...
    HAL_SYS_ExitCriticalSection(flags);
# 716 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
    return HAL_OK;
}
# 726 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
                                   ...
                                   uint32_t sizeByte)
{
    ...
    HAL_SYS_ExitCriticalSection(flags);
# 783 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
    return HAL_OK;
}
# 793 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
HAL_Status
HAL_DCACHE_CleanInvalidateByRange(uintptr_t address, uint32_t sizeByte)
{
    ...
    HAL_SYS_ExitCriticalSection(flags);
# 850 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
    return HAL_OK;
}
...
HAL_Status HAL_DCACHE_CleanInvalidate(void)
{
    ...
    ((struct DCACHE_REG *) 0x206A0000U)->CACHE_CTRL |= (0x1U << (4U));

    do {
        status =
            ((struct DCACHE_REG *) 0x206A0000U)->CACHE_STATUS & (0x1U << (2U));
    } while (!status);

    ((struct DCACHE_REG *) 0x206A0000U)->CACHE_CTRL &= ~(0x1U << (4U));

    HAL_SYS_ExitCriticalSection(flags);
# 892 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_cache.c"
    return HAL_OK;
}
...
HAL_Status HAL_DCACHE_EnablePMU(void)
{
    ...
    ((struct DCACHE_REG *) 0x206A0000U)->CACHE_CTRL |= (0x1U << (5U));
...
HAL_Status HAL_DCACHE_GetPMU(struct CACHE_PMU_CNT *stat)
{
    ...
    stat->rdNum = ((struct DCACHE_REG *) 0x206A0000U)->PMU_RD_NUM_CNT;
    stat->wrNum = ((struct DCACHE_REG *) 0x206A0000U)->PMU_WR_NUM_CNT;
    stat->sramRdHit = ((struct DCACHE_REG *) 0x206A0000U)->PMU_SRAM_RD_HIT_CNT;
    stat->hbRdHit = ((struct DCACHE_REG *) 0x206A0000U)->PMU_HB_RD_HIT_CNT;
    stat->stbRdHit = ((struct DCACHE_REG *) 0x206A0000U)->PMU_STB_RD_HIT_CNT;
    stat->rdHit = ((struct DCACHE_REG *) 0x206A0000U)->PMU_RD_HIT_CNT;
    stat->wrHit = ((struct DCACHE_REG *) 0x206A0000U)->PMU_WR_HIT_CNT;
    stat->rdMissPenalty = ((struct DCACHE_REG *) 0x206A0000U)->PMU_RD_MISS_PENALTY_CNT;
    stat->wrMissPenalty = ((struct DCACHE_REG *) 0x206A0000U)->PMU_WR_MISS_PENALTY_CNT;
    stat->rdLat = ((struct DCACHE_REG *) 0x206A0000U)->PMU_RD_LAT_CNT;
    stat->wrLat = ((struct DCACHE_REG *) 0x206A0000U)->PMU_WR_LAT_CNT;
...
HAL_Status HAL_DCACHE_EnableInt(void)
{
    ...
    ((struct DCACHE_REG *) 0x206A0000U)->CACHE_INT_EN |= (0x1U << (0U));
...
HAL_Check HAL_DCACHE_GetInt(void)
{
    ...
    status = ((struct DCACHE_REG *) 0x206A0000U)->CACHE_INT_ST & (0x1U << (0U));
...
HAL_Status HAL_DCACHE_ClearInt(void)
{
    ...
    ((struct DCACHE_REG *) 0x206A0000U)->CACHE_INT_ST |= (0x1U << (0U));
...
uintptr_t HAL_DCACHE_GetErrAddr(void)
{
    ...
    address = ((struct DCACHE_REG *) 0x206A0000U)->CACHE_ERR_HADDR;
