# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mem.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mem.c"
# 49 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mem.c"
...
# 50 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mem.c" 2
# 59 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mem.c"
static void (*rt_malloc_hook)(void *ptr, rt_size_t size);
static void (*rt_free_hook)(void *ptr);
# 74 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mem.c"
...
# 143 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mem.c"
...
# 191 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mem.c"
void rt_system_heap_init(void *begin_addr, void *end_addr)
{
    struct heap_mem *mem;
...
# 259 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mem.c"
void *rt_malloc(rt_size_t size)
{
         ...
         ptr = ((struct heap_mem *)&heap_ptr[ptr])->next)
    {
        ...
        if ((!mem->used) && (mem->next - (ptr + (((sizeof(struct heap_mem)) + (4) - 1) & ~((4) - 1)))) >= size)
        {
            ...
            {
# 316 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mem.c"
            ...
            do { if ((rt_malloc_hook) != (0)) rt_malloc_hook (((void *)((rt_uint8_t *)mem + (((sizeof(struct heap_mem)) + (4) - 1) & ~((4) - 1)))), size); } while (0)
                                                                                          ;
...
;
# 408 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mem.c"
...
;
# 512 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/mem.c"
void *rt_calloc(rt_size_t count, rt_size_t size)
{
    void *p;
...
void rt_free(void *rmem)
{
    ...
    do { if ((rt_free_hook) != (0)) rt_free_hook (rmem); } while (0);
