# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/scheduler.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/scheduler.c"
# 26 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/scheduler.c"
...
# 27 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/scheduler.c" 2
...
# 28 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/scheduler.c" 2
...
# 63 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/scheduler.c"
void
...
# 185 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/scheduler.c"
void rt_schedule(void)
{
    rt_base_t level;
    ...
    if (rt_scheduler_lock_nest == 0)
    {
        ...
        highest_ready_priority = __rt_ffs(rt_thread_ready_priority_group) - 1;
# 209 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/scheduler.c"
        to_thread = ((struct rt_thread *)((char *)(rt_thread_priority_table[highest_ready_priority].next) - (unsigned long)(&((struct rt_thread *)0)->tlist)))
        ...
        if (to_thread != rt_current_thread)
        {
            ...
            do { if ((rt_scheduler_hook) != (0)) rt_scheduler_hook (from_thread, to_thread); } while (0);
...
# 272 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/scheduler.c"
void rt_schedule_insert_thread(struct rt_thread *thread)
{
    ...
    thread->stat = 0x01 | (thread->stat & ~0x0f);
    ...
    rt_list_insert_before(&(rt_thread_priority_table[thread->current_priority]),
                          &(thread->tlist));
                                                                                           ...
                                                                                           ;
# 305 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/scheduler.c"
    rt_thread_ready_priority_group |= thread->number_mask;


    rt_hw_interrupt_enable(temp);
}
# 318 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/scheduler.c"
void rt_schedule_remove_thread(struct rt_thread *thread)
{
    register rt_base_t temp;
    ...
    temp = rt_hw_interrupt_disable();
                                                                ...
                                                                ;
# 342 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/scheduler.c"
