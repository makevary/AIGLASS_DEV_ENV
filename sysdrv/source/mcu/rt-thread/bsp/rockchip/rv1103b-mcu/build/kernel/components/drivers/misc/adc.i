# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/misc/adc.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/misc/adc.c"
# 12 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/misc/adc.c"
...
# 13 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/misc/adc.c" 2
...
# 14 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/misc/adc.c" 2
...
# 16 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/misc/adc.c" 2
...
# 17 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/misc/adc.c" 2



# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/include/rtdbg.h" 1
# 21 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/misc/adc.c" 2


# 22 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/misc/adc.c"
...
static rt_err_t _adc_control(rt_device_t dev, int cmd, void *args)
{
    ...
    if (adc->ops->enabled == (0))
    {
        return -6;
    }
    if (cmd == RT_ADC_CMD_ENABLE)
    {
        result = adc->ops->enabled(adc, (rt_uint32_t)args, 1);
    }
    else if (cmd == RT_ADC_CMD_DISABLE)
    {
        result = adc->ops->enabled(adc, (rt_uint32_t)args, 0);
    }

    return result;
}
# 75 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/misc/adc.c"
...
rt_err_t rt_adc_enable(rt_adc_device_t dev, rt_uint32_t channel)
{
    ...
    ;
    if (dev->ops->enabled != (0))
    {
        result = dev->ops->enabled(dev, channel, 1);
    }
    else
    {
        result = -6;
...
rt_err_t rt_adc_disable(rt_adc_device_t dev, rt_uint32_t channel)
{
    ...
    if (dev->ops->enabled != (0))
    {
        result = dev->ops->enabled(dev, channel, 0);
    }
    else
    {
        result = -6;
