# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/pipe.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/pipe.c"
# 11 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/pipe.c"
...
# 12 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/pipe.c" 2
...
# 13 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/pipe.c" 2
...
# 14 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/pipe.c" 2
# 309 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/pipe.c"
...
rt_size_t rt_pipe_read (rt_device_t device, rt_off_t pos, void *buffer, rt_size_t count)
{
    ...
    {
        rt_set_errno(-
# 352 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/pipe.c" 3
                     22
# 352 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/pipe.c"
                           );
        return 0;
    }
    if (count == 0) return 0;
...
rt_size_t rt_pipe_write (rt_device_t device, rt_off_t pos, const void *buffer, rt_size_t count)
{
    ...
    {
        rt_set_errno(-
# 380 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/pipe.c" 3
                     22
# 380 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/pipe.c"
                           );
        return 0;
    }
    if (count == 0) return 0;
...
# 417 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/pipe.c"
rt_pipe_t *rt_pipe_create(const char *name, int bufsz)
{
    rt_pipe_t *pipe;
    rt_device_t dev;
...
int rt_pipe_delete(const char *name)
{
    ...
    if (device)
    {
        ...
        {
            result = -
# 493 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/pipe.c" 3
                     19
# 493 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/pipe.c"
                           ;
        }
    }
    else
    {
        result = -
# 498 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/pipe.c" 3
                 19
# 498 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/pipe.c"
                       ;
    }
