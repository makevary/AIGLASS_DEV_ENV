# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/CMSIS/Device/RV1103B/Source/Templates/system_rv1103b_mcu.c"
...
# 7 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/CMSIS/Device/RV1103B/Source/Templates/system_rv1103b_mcu.c" 2
...
void SystemInit(void)
{
    ...
    ((struct GRF_SYS_REG *) 0x20150000U)->CACHE_PERI_ADDR_START = 0x20000;
    ((struct GRF_SYS_REG *) 0x20150000U)->CACHE_PERI_ADDR_END = 0x21000;

    ((struct DCACHE_REG *) 0x206A0000U)->CACHE_CTRL |= (0x1U << (0U)) |
                          (7U << (8U)) |
                          (0x1U << (7U));
