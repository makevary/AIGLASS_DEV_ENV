# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_timer.c"
...
# 7 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_timer.c" 2
# 68 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_timer.c"
HAL_Status HAL_TIMER_Init(struct TIMER_REG *pReg, eTIMER_MODE mode)
{
    ;

    if (pReg == ((struct TIMER_REG *) 0x20835000U)) {
        return HAL_BUSY;
    }


    ((*(volatile uint32_t *)&(pReg->CONTROLREG)) = (mode << (1U)));
...
HAL_Status HAL_TIMER_SysTimerInit(struct TIMER_REG *pReg)
{
    ...
    if (((*(volatile const uint32_t *)&(pReg->CONTROLREG)) & ((0x1U << (0U))))) {
        return HAL_OK;
    }

    ((*(volatile uint32_t *)&(pReg->CONTROLREG)) = (TIMER_FREE_RUNNING));
    pReg->LOAD_COUNT[0] = 0xFFFFFFFFU;
    pReg->LOAD_COUNT[1] = 0xFFFFFFFFU;
    ((*(volatile uint32_t *)&(pReg->CONTROLREG)) &= ~((0x1U << (2U))));
    ((*(volatile uint32_t *)&(pReg->CONTROLREG)) |= ((0x1U << (0U))));
...
HAL_Status HAL_TIMER_DeInit(struct TIMER_REG *pReg)
{
    ...
    ((*(volatile uint32_t *)&(pReg->CONTROLREG)) = (0));

    return HAL_OK;
}
# 134 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_timer.c"
HAL_Status HAL_TIMER_Start(struct TIMER_REG *pReg)
{
    ;
...
HAL_Status HAL_TIMER_Start_IT(struct TIMER_REG *pReg)
{
    ...
    ((*(volatile uint32_t *)&(pReg->CONTROLREG)) |= ((0x1U << (0U)) | (0x1U << (2U))));
...
# 215 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_timer.c"
...
{
    HAL_TIMER_ClrInt(((struct TIMER_REG *) 0x20830000U));
...
{
    HAL_TIMER_ClrInt(((struct TIMER_REG *) 0x20831000U));
