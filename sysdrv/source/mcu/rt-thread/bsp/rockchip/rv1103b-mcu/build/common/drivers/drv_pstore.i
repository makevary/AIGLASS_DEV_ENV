# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pstore.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pstore.c"
# 28 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pstore.c"
...
# 29 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pstore.c" 2
...
# 30 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pstore.c" 2
...
{
    struct persistent_ram_buffer *rb = (struct persistent_ram_buffer *)0x7c000;
    ...
    if (rb->size > (0x4000 - 12))
        rb->size = (0x4000 - 12);

    if (rb->start >= (0x4000 - 12))
        rb->start = 0;
}
...
static void write_log_to_ram(const char *str, int flush)
{
    struct persistent_ram_buffer *rb =
        (struct persistent_ram_buffer *)0x7c000;
...
__attribute__((used)) const init_fn_t __rt_init_pstore_dev_init __attribute__((section(".rti_fn.""1"))) = pstore_dev_init;
