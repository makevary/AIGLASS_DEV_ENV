# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_saradc.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_saradc.c"
# 15 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_saradc.c"
...
# 16 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_saradc.c" 2
...
# 17 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_saradc.c" 2
...
# 20 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_saradc.c" 2


# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/include/rtdbg.h" 1
# 23 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_saradc.c" 2
...
static rt_err_t rk_wait_saradc_completed(struct rk_saradc *rk_saradc)
{
    ...
    if (rt_event_recv(&rk_saradc->event, 0xffffffff, 0x02 | 0x04,
                      rt_tick_from_millisecond(1), &status) != 0)
    {
        ;
        return -2;
    }
...
static int rk_saradc_init(void)
{
    ...
    rk_saradc.reg = ((struct SARADC_REG *) 0x209A0000U);

    HAL_CRU_ClkEnable(0x0000005C);
    HAL_CRU_ClkEnable(0x0000005D);
    ...
    rt_event_init(&rk_saradc.event, "saradc", 0x00);

    rt_hw_interrupt_install(SARADC_IRQn, rk_saradc_irq_handler, (0), (0));
    rt_hw_interrupt_umask(SARADC_IRQn);

    if (rt_hw_adc_register(&rk_saradc.rk_saradc_dev, "rk_adc0", &rk_saradc_ops, &rk_saradc) == 0)
    {
        ;
    }
    else
...
__attribute__((used)) const init_fn_t __rt_init_rk_saradc_init __attribute__((section(".rti_fn.""1"))) = rk_saradc_init;
