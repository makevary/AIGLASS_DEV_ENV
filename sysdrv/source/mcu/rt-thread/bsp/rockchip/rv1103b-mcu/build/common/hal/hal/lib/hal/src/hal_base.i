# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_base.c"
...
# 7 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_base.c" 2
# 57 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_base.c"
static volatile uint32_t uwTick;
static eHAL_tickFreq uwTickFreq = HAL_TICK_FREQ_1KHZ;
# 96 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_base.c"
...
# 133 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_base.c"
__attribute__((always_inline)) static inline HAL_Status TimerDelayUs(uint32_t us)
{
    uint64_t count, from, now, pass;

    from = HAL_TIMER_GetCount(((struct TIMER_REG *) 0x20835000U));
    count = (24 * 1000 * 1000) / 1000000 * us;

    do {
        now = HAL_TIMER_GetCount(((struct TIMER_REG *) 0x20835000U));
        pass = now > from ? now - from : from - now;
    } while (pass < count);

    return HAL_OK;
}
# 162 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_base.c"
HAL_Status HAL_Init(void)
{
# 175 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_base.c"
    HAL_TIMER_SysTimerInit(((struct TIMER_REG *) 0x20835000U));
...
# 205 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_base.c"
    if (ret == HAL_OK) {
...
# 233 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_base.c"
HAL_Status HAL_IncTick(void)
{
    uwTick += uwTickFreq;
...
uint32_t HAL_GetTick(void)
{
    ...
    uint64_t tick = HAL_TIMER_GetCount(((struct TIMER_REG *) 0x20835000U));
    uint32_t base = (24 * 1000 * 1000) / 1000;
...
uint64_t HAL_GetSysTimerCount(void)
{
    ...
    uint64_t count = HAL_TIMER_GetCount(((struct TIMER_REG *) 0x20835000U));
    if (count >> 62) {
        count = ~count;
    }
...
# 313 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_base.c"
...
# 329 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_base.c"
HAL_Status HAL_DelayUs(uint32_t us)
{
...
# 351 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_base.c"
HAL_Status HAL_CPUDelayUs(uint32_t us)
{
    volatile uint32_t cycles;


    cycles = (uint32_t)HAL_DivU64((uint64_t)SystemCoreClock, 1000000) * us;
...
# 402 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_base.c"
void HAL_CPU_EnterIdle(void)
{
