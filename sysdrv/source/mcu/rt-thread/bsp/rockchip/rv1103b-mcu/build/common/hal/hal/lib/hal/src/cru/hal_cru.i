# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
...
# 7 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c" 2
# 122 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
...
int HAL_CRU_RoundFreqGetMuxArray(uint32_t freq, uint32_t *table, int num, uint32_t *pFreqOut, 
# 253 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c" 3 4
                                                                                             _Bool 
# 253 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
                                                                                                  is_div)
{
    uint32_t mux = 0;
    int i = 0;
...
# 403 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
static HAL_Status CRU_PllSetPostDiv(uint32_t foutHz, uint32_t *postDiv1,
                                    uint32_t *postDiv2, uint32_t *foutVco)
{
    uint32_t freq;

    if (foutHz < (800 * 1000000)) {
        for (*postDiv1 = 1; *postDiv1 <= 7; (*postDiv1)++) {
            for (*postDiv2 = 1; *postDiv2 <= 7; (*postDiv2)++) {
                freq = foutHz * (*postDiv1) * (*postDiv2);
                if (freq >= (800 * 1000000) && freq <= (2000 * 1000000)) {
                    *foutVco = freq;
...
# 447 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
                                                 ...
                                                 uint32_t foutHz)
{
    ...
    if (finHz == 0 || foutHz == 0 || foutHz == finHz) {
        return 
# 458 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c" 3 4
              ((void *)0)
# 458 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
                  ;
    }
    ...
    if (error) {
        return 
# 463 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c" 3 4
              ((void *)0)
# 463 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
                  ;
    }
    ...
    if (finHz / 1000000 * 1000000 == finHz && foutHz / 1000000 * 1000000 == foutHz) {
        finHz /= 1000000;
        foutVco /= 1000000;
        ...
        rateTable->frac = 0;
    } else if (finHz / 1000000 * 1000000 != finHz) {
        clkGcd = foutHz / finHz;
        ...
        fin64 = HAL_DivU64(fin64 << 24, finHz);
        frac64 = rateTable->fbDiv;
        frac64 = rateTable->fbDiv << 24;
        frac64 = fin64 - frac64;
        ...
        clkGcd = CRU_Gcd(finHz / 1000000, foutVco / 1000000);
        rateTable->refDiv = finHz / 1000000 / clkGcd;
        rateTable->fbDiv = foutVco / 1000000 / clkGcd;
        rateTable->frac = 0;

        frac64 = (foutVco % 1000000);
        fin64 = finHz;
        frac64 = frac64 * rateTable->refDiv;
        frac64 = HAL_DivU64(frac64 << 24, fin64);
        rateTable->frac = frac64;
        if (rateTable->frac > 0) {
            rateTable->dsmpd = 0;
        }
...
# 521 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
                                                   ...
                                                   uint32_t rate)
{
    ...
    if (rateTable == 
# 526 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c" 3 4
                    ((void *)0)
# 526 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
                        ) {
        return CRU_PllSetByAuto((24 * 1000 * 1000), rate);
    }
...
# 869 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
uint32_t HAL_CRU_GetPllFreq(struct PLL_SETUP *pSetup)
{
    uint64_t refDiv, fbDiv, postdDv1, postDiv2, frac, dsmpd;
    uint32_t mode = 0, rate = (24 * 1000 * 1000);

    mode = (((uint32_t)(((*(volatile const uint32_t *)&(*(pSetup->modeOffset))))) & pSetup->modeMask) >> pSetup->modeShift)
                                            ;
    ...
    case 0:
        ...
        break;
    case 1:
        postdDv1 = (((uint32_t)(((*(volatile const uint32_t *)&(*(pSetup->conOffset0))))) & (0x7 << 12)) >> 12);
        fbDiv = (((uint32_t)(((*(volatile const uint32_t *)&(*(pSetup->conOffset0))))) & (0xfff << 0)) >> 0);
        postDiv2 = (((uint32_t)(((*(volatile const uint32_t *)&(*(pSetup->conOffset1))))) & (0x7 << 6)) >> 6);
        refDiv = (((uint32_t)(((*(volatile const uint32_t *)&(*(pSetup->conOffset1))))) & (0x3f << 0)) >> 0);
        dsmpd = (((uint32_t)(((*(volatile const uint32_t *)&(*(pSetup->conOffset1))))) & (1 << 12)) >> 12);
        frac = (((uint32_t)(((*(volatile const uint32_t *)&(*(pSetup->conOffset2))))) & (0xffffff << 0)) >> 0);
        rate = (rate / refDiv) * fbDiv;
        if (dsmpd == 0) {
            uint64_t fracRate = (24 * 1000 * 1000);
...
# 917 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
HAL_Status HAL_CRU_SetPllFreq(struct PLL_SETUP *pSetup, uint32_t rate)
{
    ...
    if (rate == HAL_CRU_GetPllFreq(pSetup)) {
        return HAL_OK;
    } else if (rate < (24 * 1000000)) {
        return HAL_INVAL;
    } else if (rate > (1600 * 1000000)) {
        return HAL_INVAL;
    }
    ...
    ((*(volatile uint32_t *)&(*(pSetup->modeOffset))) = (((((__builtin_constant_p(pSetup->modeMask) ? ((pSetup->modeMask) > 0xFFFFU ? 0 : ((pSetup->modeMask) << 16)) : ((pSetup->modeMask) << 16))) | (0 << pSetup->modeShift)))));


    ((*(volatile uint32_t *)&(*(pSetup->conOffset1))) = (((((__builtin_constant_p(1 << 13) ? ((1 << 13) > 0xFFFFU ? 0 : ((1 << 13) << 16)) : ((1 << 13) << 16))) | (1 << 13)))));


    ((*(volatile uint32_t *)&(*(pSetup->conOffset1))) = (((((__builtin_constant_p(0x7 << 6) ? ((0x7 << 6) > 0xFFFFU ? 0 : ((0x7 << 6) << 16)) : ((0x7 << 6) << 16))) | (pConfig->postDiv2 << 6)))));
    ((*(volatile uint32_t *)&(*(pSetup->conOffset1))) = (((((__builtin_constant_p(0x3f << 0) ? ((0x3f << 0) > 0xFFFFU ? 0 : ((0x3f << 0) << 16)) : ((0x3f << 0) << 16))) | (pConfig->refDiv << 0)))));
    ((*(volatile uint32_t *)&(*(pSetup->conOffset0))) = (((((__builtin_constant_p(0x7 << 12) ? ((0x7 << 12) > 0xFFFFU ? 0 : ((0x7 << 12) << 16)) : ((0x7 << 12) << 16))) | (pConfig->postDiv1 << 12)))));
    ((*(volatile uint32_t *)&(*(pSetup->conOffset0))) = (((((__builtin_constant_p(0xfff << 0) ? ((0xfff << 0) > 0xFFFFU ? 0 : ((0xfff << 0) << 16)) : ((0xfff << 0) << 16))) | (pConfig->fbDiv << 0)))));
    ((*(volatile uint32_t *)&(*(pSetup->conOffset1))) = (((((__builtin_constant_p(1 << 12) ? ((1 << 12) > 0xFFFFU ? 0 : ((1 << 12) << 16)) : ((1 << 12) << 16))) | (pConfig->dsmpd << 12)))));

    if (pConfig->frac) {
        ((*(volatile uint32_t *)&(*(pSetup->conOffset2))) = ((((*(volatile const uint32_t *)&(*(pSetup->conOffset2)))) & 0xff000000) | pConfig->frac));
    }


    ((*(volatile uint32_t *)&(*(pSetup->conOffset1))) = (((((__builtin_constant_p(1 << 13) ? ((1 << 13) > 0xFFFFU ? 0 : ((1 << 13) << 16)) : ((1 << 13) << 16))) | (0 << 13)))));


    while (delay > 0) {
        if (pSetup->stat0) {
            if (((*(volatile const uint32_t *)&(*(pSetup->stat0)))) & (1 << pSetup->lockShift)) {
                break;
            }
        } else {
            if (((*(volatile const uint32_t *)&(*(pSetup->conOffset1)))) & (1 << pSetup->lockShift)) {
                break;
            }
        }
        HAL_CPUDelayUs(1000);
    ...
    ((*(volatile uint32_t *)&(*(pSetup->modeOffset))) = (((((__builtin_constant_p(pSetup->modeMask) ? ((pSetup->modeMask) > 0xFFFFU ? 0 : ((pSetup->modeMask) << 16)) : ((pSetup->modeMask) << 16))) | (1 << pSetup->modeShift)))));
...
HAL_Check HAL_CRU_ClkIsEnabled(uint32_t clk)
{
    ...
    uint32_t index = ((uint32_t)(((clk) & (((~0U) << (0)) & (~0U >> (32 - 1 - (11))))) / 16));
    uint32_t shift = ((uint32_t)(((clk) & (((~0U) << (0)) & (~0U >> (32 - 1 - (11))))) % 16));
    uint32_t bank = ((uint32_t)(((clk) & (((~0U) << (12)) & (~0U >> (32 - 1 - (15))))) >> (12)));
    uint32_t reg;
    HAL_Check ret;

    reg = ctrl->banks[bank].cruBase + ctrl->banks[bank].gateOffset + index * 4;
    ret = (HAL_Check)(!(((*(volatile uint32_t *)((uintptr_t)(reg))) & (1 << shift)) >> shift));
...
HAL_Status HAL_CRU_ClkEnable(uint32_t clk)
{
    ...
    reg = ctrl->banks[bank].cruBase + ctrl->banks[bank].gateOffset + index * 4;
    (*(volatile uint32_t *)((uintptr_t)(reg)) = ((1U << shift) << (16) | (0U) << (shift)));
...
HAL_Status HAL_CRU_ClkDisable(uint32_t clk)
{
    ...
    reg = ctrl->banks[bank].cruBase + ctrl->banks[bank].gateOffset + index * 4;
    (*(volatile uint32_t *)((uintptr_t)(reg)) = ((1U << shift) << (16) | (1U) << (shift)));
...
HAL_Status HAL_CRU_ClkDisableUnused(uint32_t bank, uint32_t index, uint32_t val)
{
    ...
    reg = ctrl->banks[bank].cruBase + ctrl->banks[bank].gateOffset + index * 4;
    (*(volatile uint32_t *)((uintptr_t)(reg)) = ((0) << (16) | (val) << (0)));
...
{
    const struct HAL_CRU_DEV *ctrl = CRU_GetInfo();
    uint32_t index = ((uint32_t)(((clks[0]) & (((~0U) << (0)) & (~0U >> (32 - 1 - (11))))) / 16));
    uint32_t bank = ((uint32_t)(((clks[0]) & (((~0U) << (12)) & (~0U >> (32 - 1 - (15))))) >> (12)));
    uint32_t val = 0;
    uint32_t reg;
    int i;

    for (i = 0; i < numClks; i++) {
        val |= (1UL << (((uint32_t)(((clks[i]) & (((~0U) << (0)) & (~0U >> (32 - 1 - (11))))) % 16))));
        if (index != ((uint32_t)(((clks[i]) & (((~0U) << (0)) & (~0U >> (32 - 1 - (11))))) / 16))) {
            return HAL_ERROR;
        }
    }

    reg = ctrl->banks[bank].cruBase + ctrl->banks[bank].softOffset + index * 4;
    (*(volatile uint32_t *)((uintptr_t)(reg)) = ((val) << (16) | (val) << (0)));
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "%s: index: 0x%" 
# 1140 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c" 3
   "l" 
# 1140 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
   "x" ", val: 0x%" 
# 1140 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c" 3
   "l" 
# 1140 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
   "x" "\n", __func__, index, val); } while (0);
...
HAL_Status HAL_CRU_ClkResetSyncDeassert(int numClks, uint32_t *clks)
{
    ...
    reg = ctrl->banks[bank].cruBase + ctrl->banks[bank].softOffset + index * 4;
    (*(volatile uint32_t *)((uintptr_t)(reg)) = ((val) << (16) | (0) << (0)));
    do { if (0) HAL_DBG_Printf("[HAL INFO] " "%s: index: 0x%" 
# 1163 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c" 3
   "l" 
# 1163 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
   "x" ", val: 0x%" 
# 1163 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c" 3
   "l" 
# 1163 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
...
HAL_Status HAL_CRU_ClkSetDiv(uint32_t divName, uint32_t divValue)
{
    ...
    index = ((uint32_t)(((divName) & (((~0U) << (0)) & (~0U >> (32 - 1 - (7))))) >> (0)));
    shift = ((uint32_t)(((divName) & (((~0U) << (16)) & (~0U >> (32 - 1 - (23))))) >> (16)));
    ;
    mask = (((1 << (((uint32_t)(((divName) & (((~0U) << (24)) & (~0U >> (32 - 1 - (31))))) >> (24))))) - 1) << ((uint32_t)(((divName) & (((~0U) << (16)) & (~0U >> (32 - 1 - (23))))) >> (16))));
    maxDiv = ((1 << ((uint32_t)(((divName) & (((~0U) << (24)) & (~0U >> (32 - 1 - (31))))) >> (24)))) - 1) + 1;
    if (divValue > maxDiv) {
        divValue = maxDiv;
    }

    bank = ((uint32_t)(((divName) & (((~0U) << (8)) & (~0U >> (32 - 1 - (11))))) >> (8)));
    reg = ctrl->banks[bank].cruBase + ctrl->banks[bank].selOffset + index * 4;
    (*(volatile uint32_t *)((uintptr_t)(reg)) = ((mask) << (16) | ((divValue - 1U)) << (shift)));
...
uint32_t HAL_CRU_ClkGetDiv(uint32_t divName)
{
    ...
    bank = ((uint32_t)(((divName) & (((~0U) << (8)) & (~0U >> (32 - 1 - (11))))) >> (8)));
    reg = ctrl->banks[bank].cruBase + ctrl->banks[bank].selOffset + index * 4;
    divValue = (((*(volatile uint32_t *)((uintptr_t)(reg))) & mask) >> shift) + 1;
...
HAL_Status HAL_CRU_ClkSetMux(uint32_t muxName, uint32_t muxValue)
{
    ...
    index = ((uint32_t)(((muxName) & (((~0U) << (0)) & (~0U >> (32 - 1 - (7))))) >> (0)));
    shift = ((uint32_t)(((muxName) & (((~0U) << (16)) & (~0U >> (32 - 1 - (23))))) >> (16)));
    ;
    mask = (((1 << (((uint32_t)(((muxName) & (((~0U) << (24)) & (~0U >> (32 - 1 - (31))))) >> (24))))) - 1) << ((uint32_t)(((muxName) & (((~0U) << (16)) & (~0U >> (32 - 1 - (23))))) >> (16))));
    bank = ((uint32_t)(((muxName) & (((~0U) << (8)) & (~0U >> (32 - 1 - (11))))) >> (8)));
    reg = ctrl->banks[bank].cruBase + ctrl->banks[bank].selOffset + index * 4;
    (*(volatile uint32_t *)((uintptr_t)(reg)) = ((mask) << (16) | (muxValue) << (shift)));
...
uint32_t HAL_CRU_ClkGetMux(uint32_t muxName)
{
    ...
    bank = ((uint32_t)(((muxName) & (((~0U) << (8)) & (~0U >> (32 - 1 - (11))))) >> (8)));
    reg = ctrl->banks[bank].cruBase + ctrl->banks[bank].selOffset + index * 4;
    muxValue = (((*(volatile uint32_t *)((uintptr_t)(reg))) & mask) >> shift);
                                 ...
                                 uint32_t denominator)
{
    ...
    index = ((uint32_t)(((fracDivName) & (((~0U) << (0)) & (~0U >> (32 - 1 - (7))))) >> (0)));
    bank = ((uint32_t)(((fracDivName) & (((~0U) << (8)) & (~0U >> (32 - 1 - (11))))) >> (8)));
    reg = ctrl->banks[bank].cruBase + ctrl->banks[bank].selOffset + index * 4;
    (*(volatile uint32_t *)((uintptr_t)(reg)) = ((0) << (16) | (((numerator << 16) | denominator)) << (0)));
                                 ...
                                 uint32_t *denominator)
{
    ...
    bank = ((uint32_t)(((fracDivName) & (((~0U) << (8)) & (~0U >> (32 - 1 - (11))))) >> (8)));
    reg = ctrl->banks[bank].cruBase + ctrl->banks[bank].selOffset + index * 4;
    val = (*(volatile uint32_t *)((uintptr_t)(reg)));
...
# 1642 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
HAL_Status HAL_CRU_FracdivGetConfig(uint32_t rateOut, uint32_t rate,
                                    uint32_t *numerator,
                                    uint32_t *denominator)
{
...
HAL_Status HAL_CRU_ClkNp5BestDiv(eCLOCK_Name clockName, uint32_t rate, uint32_t pRate, uint32_t *bestdiv)
{
    uint32_t div = ((uint32_t)((clockName) & 0x00000000FFFFFFFF));
    uint32_t maxDiv = (((1 << (((uint32_t)(((div) & (((~0U) << (24)) & (~0U >> (32 - 1 - (31))))) >> (24))))) - 1) << ((uint32_t)(((div) & (((~0U) << (16)) & (~0U >> (32 - 1 - (23))))) >> (16))));
    uint32_t i;
...
__attribute__((weak)) HAL_Status HAL_CRU_PvtConfig(struct HAL_PVT_CFG *pvtCfg)
{
    return HAL_OK;
}
...
HAL_Status HAL_CRU_SetGlbSrst(eCRU_GlbSrstType type)
{
# 1752 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru.c"
    return HAL_INVAL;
}
