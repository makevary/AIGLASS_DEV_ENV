# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/bsp/RV1103B/hal_bsp.c"
...
# 9 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/bsp/RV1103B/hal_bsp.h"
...
# 10 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/bsp/RV1103B/hal_bsp.h" 2
...
void BSP_Init(void);
# 7 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/bsp/RV1103B/hal_bsp.c" 2


static struct CRU_BANK_INFO cruBanks[] = {
    { .cruBase = 0x20000000U, .selOffset = 0x300, .gateOffset = 0x800, .softOffset = 0xa00, },
    { .cruBase = 0x20010000U, .selOffset = 0x300, .gateOffset = 0x800, .softOffset = 0xa00, },
    { .cruBase = 0x20020000U, .selOffset = 0x300, .gateOffset = 0x800, .softOffset = 0xa00, },
    { .cruBase = 0x20030000U, .selOffset = 0x300, .gateOffset = 0x800, .softOffset = 0xa00, },
    { .cruBase = 0x20040000U, .selOffset = 0x300, .gateOffset = 0x800, .softOffset = 0xa00, },
    { .cruBase = 0x20050000U, .selOffset = 0x300, .gateOffset = 0x800, .softOffset = 0xa00, },
    { .cruBase = 0x20058000U, .selOffset = 0x300, .gateOffset = 0x800, .softOffset = 0xa00, },
    { .cruBase = 0x20060000U, .selOffset = 0x300, .gateOffset = 0x800, .softOffset = 0xa00, },
    { .cruBase = 0x20070000U, .selOffset = 0x300, .gateOffset = 0x800, .softOffset = 0xa00, },
    { .cruBase = 0x20080000U, .selOffset = 0x300, .gateOffset = 0x800, .softOffset = 0xa00, },
};

const struct HAL_CRU_DEV g_cruDev = {
    .banks = cruBanks,
    .banksNum = (sizeof((cruBanks)) / sizeof((cruBanks)[0])),
};
# 65 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/bsp/RV1103B/hal_bsp.c"
const struct HAL_I2C_DEV g_i2c0Dev =
{
    .pReg = ((struct I2C_REG *) 0x20530000U),
    .irqNum = I2C0_IRQn,
    .clkID = CLK_I2C0,
    .clkGateID = 0x0000800D,
    .pclkGateID = 0x0000800C,
    .runtimeID = PM_RUNTIME_ID_I2C0,
};

const struct HAL_I2C_DEV g_i2c1Dev =
{
    .pReg = ((struct I2C_REG *) 0x20910000U),
    .irqNum = I2C1_IRQn,
    .clkID = CLK_I2C1,
    .clkGateID = 0x00000027,
    .pclkGateID = 0x00000026,
    .runtimeID = PM_RUNTIME_ID_I2C1,
};

const struct HAL_I2C_DEV g_i2c2Dev =
{
    .pReg = ((struct I2C_REG *) 0x20920000U),
    .irqNum = I2C2_IRQn,
    .clkID = CLK_I2C2,
    .clkGateID = 0x00000029,
    .pclkGateID = 0x00000028,
    .runtimeID = PM_RUNTIME_ID_I2C2,
};

const struct HAL_I2C_DEV g_i2c3Dev =
{
    .pReg = ((struct I2C_REG *) 0x20930000U),
    .irqNum = I2C3_IRQn,
    .clkID = CLK_I2C3,
    .clkGateID = 0x0000002B,
    .pclkGateID = 0x0000002A,
    .runtimeID = PM_RUNTIME_ID_I2C3,
};

const struct HAL_I2C_DEV g_i2c4Dev =
{
    .pReg = ((struct I2C_REG *) 0x20940000U),
    .irqNum = I2C4_IRQn,
    .clkID = CLK_I2C4,
    .clkGateID = 0x0000002D,
    .pclkGateID = 0x0000002C,
...
{
    .pReg = ((struct PWM_REG *) 0x20550000U),
    .clkID = CLK_PWM0,
    .clkGateID = 0x0000704A,
    .pclkGateID = 0x00008020,
...
{
    .pReg = ((struct PWM_REG *) 0x20970000U),
    .clkID = CLK_PWM1,
    .clkGateID = 0x0000704B,
    .pclkGateID = 0x00000046,
...
{
    .pReg = ((struct PWM_REG *) 0x20980000U),
    .clkID = CLK_PWM2,
    .clkGateID = 0x0000704C,
    .pclkGateID = 0x0000004C,
    .irqNum[0] = PWM2_CH0_IRQn,
    .irqNum[1] = PWM2_CH1_IRQn,
    .irqNum[2] = PWM2_CH2_IRQn,
    .irqNum[3] = PWM2_CH3_IRQn,
};
# 202 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/bsp/RV1103B/hal_bsp.c"
void BSP_Init(void)
{
}
