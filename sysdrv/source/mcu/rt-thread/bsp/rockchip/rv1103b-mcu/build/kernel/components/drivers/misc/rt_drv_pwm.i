# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/misc/rt_drv_pwm.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/misc/rt_drv_pwm.c"
# 11 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/misc/rt_drv_pwm.c"
...
# 10 "/opt/aiglass_dev_env/sysdrv/source/mcu/prebuilts/gcc/linux-x86/riscv64/xpack-riscv-none-embed-gcc-10.2.0-1.2/riscv-none-embed/include/string.h" 3
...
# 11 "/opt/aiglass_dev_env/sysdrv/source/mcu/prebuilts/gcc/linux-x86/riscv64/xpack-riscv-none-embed-gcc-10.2.0-1.2/riscv-none-embed/include/string.h" 2 3
...
# 12 "/opt/aiglass_dev_env/sysdrv/source/mcu/prebuilts/gcc/linux-x86/riscv64/xpack-riscv-none-embed-gcc-10.2.0-1.2/riscv-none-embed/include/string.h" 2 3
...
# 13 "/opt/aiglass_dev_env/sysdrv/source/mcu/prebuilts/gcc/linux-x86/riscv64/xpack-riscv-none-embed-gcc-10.2.0-1.2/riscv-none-embed/include/string.h" 2 3
...
# 12 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/misc/rt_drv_pwm.c" 2

# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/include/drivers/rt_drv_pwm.h" 1
# 14 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/include/drivers/rt_drv_pwm.h"
...
# 15 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/include/drivers/rt_drv_pwm.h" 2
...
# 16 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/include/drivers/rt_drv_pwm.h" 2
...
# 14 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/misc/rt_drv_pwm.c" 2
...
static rt_size_t _pwm_read(rt_device_t dev, rt_off_t pos, void *buffer, rt_size_t size)
{
    ...
    if (pwm->ops->control)
    {
        result = pwm->ops->control(pwm, (128 + 3), &configuration);
        if (result != 0)
        {
            return 0;
        }
...
static rt_size_t _pwm_write(rt_device_t dev, rt_off_t pos, const void *buffer, rt_size_t size)
{
    ...
    if (pwm->ops->control)
    {
        ...
        result = pwm->ops->control(pwm, (128 + 2), &configuration);
        if (result != 0)
        {
            return 0;
        }
...
# 103 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/misc/rt_drv_pwm.c"
rt_err_t rt_device_pwm_register(struct rt_device_pwm *device, const char *name, const struct rt_pwm_ops *ops, const void *user_data)
{
    rt_err_t result = 0;
    ...
    device->parent.init = (0);
    device->parent.open = (0);
    device->parent.close = (0);
    ...
    result = rt_device_register(&device->parent, name, 0x003);
...
rt_err_t rt_pwm_enable(struct rt_device_pwm *device, int channel)
{
    ...
    result = rt_device_control(&device->parent, (128 + 0), &configuration);
...
rt_err_t rt_pwm_disable(struct rt_device_pwm *device, int channel)
{
    ...
    configuration.channel = channel;
    result = rt_device_control(&device->parent, (128 + 1), &configuration);
...
rt_err_t rt_pwm_set_internal(struct rt_device_pwm *device, int channel, rt_uint32_t period, rt_uint32_t pulse, rt_uint32_t polarity, enum rt_pwm_aligned_mode aligned)
{
    ...
    configuration.pulse = pulse;
    configuration.polarity = polarity ? 1 : 0;
    configuration.aligned = aligned;
    result = rt_device_control(&device->parent, (128 + 2), &configuration);
...
rt_err_t rt_pwm_set_oneshot(struct rt_device_pwm *device, int channel, rt_uint32_t count)
{
    ...
    result = rt_device_control(&device->parent, (128 + 4), &configuration);
...
rt_err_t rt_pwm_set_capture(struct rt_device_pwm *device, int channel)
{
    ...
    configuration.channel = channel;
    result = rt_device_control(&device->parent, (128 + 5), &configuration);
...
rt_err_t rt_pwm_int_enable(struct rt_device_pwm *device, int channel)
{
    ...
    configuration.channel = channel;
    result = rt_device_control(&device->parent, (128 + 6), &configuration);
...
rt_err_t rt_pwm_int_disable(struct rt_device_pwm *device, int channel)
{
    ...
    configuration.channel = channel;
    result = rt_device_control(&device->parent, (128 + 7), &configuration);
...
rt_err_t rt_pwm_lock(struct rt_device_pwm *device, rt_uint32_t channel_mask)
{
    ...
    result = rt_device_control(&device->parent, (128 + 9), &configuration);
...
rt_err_t rt_pwm_unlock(struct rt_device_pwm *device, rt_uint8_t channel_mask)
{
    ...
    configuration.mask = channel_mask;
    result = rt_device_control(&device->parent, (128 + 10), &configuration);
