# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c"
# 30 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c"
...
# 31 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c" 2
...
# 33 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c" 2
...
void BSP_Init(void);
# 37 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c" 2
...
# 38 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c" 2
# 54 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c"
struct rockchip_pwm
{
...
# 85 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c"
static void rockchip_pwm0_irq(int irq, void *param); static struct rockchip_pwm pwm0 = { .hal_dev = &g_pwm0Dev, .name = "pwm""0", .irq_handler = rockchip_pwm0_irq, }; static void rockchip_pwm0_irq(int irq, void *param) { rockchip_pwm_irq(&pwm0); }
# 100 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c"
static struct rockchip_pwm *const rockchip_pwm_table[] =
{

    &pwm0,
# 114 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c"
    (0)
};
...
# 146 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c"
    rt_interrupt_leave();
}
...
static rt_err_t rockchip_pwm_control(struct rt_device_pwm *device, int cmd, void *arg)
{
    ...
    case (128 + 6):
        ...
        rt_hw_interrupt_install(pwm->hal_dev->irqNum[config->channel], pwm->irq_handler, 
# 212 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c" 3 4
                                                                                        ((void *)0)
# 212 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c"
                                                                                            , "0" + config->channel);
        ...
        pwm->is_int_enable = 
# 218 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c" 3 4
                            1
# 218 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c"
                                ;
        break;
    case (128 + 7):
        ...
        pwm->is_int_enable = 
# 226 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c" 3 4
                            0
# 226 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_pwm.c"
                                 ;
        break;
    default:
        break;
...
int rockchip_rt_hw_pwm_init(void)
{
    ...
    for (pwm = rockchip_pwm_table; *pwm != (0); pwm++)
    {
        hal_dev = (*pwm)->hal_dev;
...
__attribute__((used)) const init_fn_t __rt_init_rockchip_rt_hw_pwm_init __attribute__((section(".rti_fn.""3"))) = rockchip_rt_hw_pwm_init;
