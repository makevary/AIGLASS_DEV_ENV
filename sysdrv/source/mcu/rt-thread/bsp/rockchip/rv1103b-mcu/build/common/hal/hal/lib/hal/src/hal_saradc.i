# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_saradc.c"
...
# 7 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_saradc.c" 2
# 82 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_saradc.c"
HAL_Status HAL_SARADC_Start(struct SARADC_REG *reg, eSARADC_mode mode, uint32_t chn)
{
    uint32_t value;
    ...
    ((*(volatile uint32_t *)&(reg->END_INT_EN)) = (((((__builtin_constant_p((0x1U << (0U))) ? (((0x1U << (0U))) > 0xFFFFU ? 0 : (((0x1U << (0U))) << 16)) : (((0x1U << (0U))) << 16))) | ((0x1U << (0U)))))))
                                                        ;
    value = (0x1U << (4U)) | (0x1U << (5U)) | chn;
    ((*(volatile uint32_t *)&(reg->CONV_CON)) = (((((__builtin_constant_p((0x1U << (4U)) | (0x1U << (5U)) | (0xFU << (0U))) ? (((0x1U << (4U)) | (0x1U << (5U)) | (0xFU << (0U))) > 0xFFFFU ? 0 : (((0x1U << (4U)) | (0x1U << (5U)) | (0xFU << (0U))) << 16)) : (((0x1U << (4U)) | (0x1U << (5U)) | (0xFU << (0U))) << 16))) | (value)))))


                            ;
# 116 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_saradc.c"
    return HAL_OK;
}
...
void HAL_SARADC_EnableHighThresholdIrq(struct SARADC_REG *reg, uint32_t chn)
{
    ...
    ((*(volatile uint32_t *)&(reg->HT_INT_EN)) = (((((__builtin_constant_p((1UL << (chn))) ? (((1UL << (chn))) > 0xFFFFU ? 0 : (((1UL << (chn))) << 16)) : (((1UL << (chn))) << 16))) | ((1UL << (chn)))))));
...
HAL_Check HAL_SARADC_PollIsEOC(struct SARADC_REG *reg, uint32_t chn)
{
    ...
    return reg->HT_INT_ST & (1UL << (chn)) ? HAL_TRUE : HAL_FALSE;
