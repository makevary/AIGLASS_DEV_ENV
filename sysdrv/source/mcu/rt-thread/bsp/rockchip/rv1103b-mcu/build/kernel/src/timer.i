# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
# 21 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
...
# 22 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c" 2
...
# 23 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c" 2


static rt_list_t rt_timer_list[1];
# 44 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
...
# 61 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
void rt_timer_enter_sethook(void (*hook)(struct rt_timer *timer))
{
...
# 117 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
static rt_err_t rt_timer_list_next_timeout(rt_list_t timer_list[], rt_tick_t *timeout_tick)
{
    struct rt_timer *timer;

    if (rt_list_isempty(&timer_list[1 - 1]))
        return -1;

    timer = ((struct rt_timer *)((char *)(timer_list[1 - 1].next) - (unsigned long)(&((struct rt_timer *)0)->row[1 - 1])))
                                                                             ;
...
static __inline void _rt_timer_remove(rt_timer_t timer)
{
    int i;
...
# 188 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
void rt_timer_init(rt_timer_t timer,
                   const char *name,
                   void (*timeout)(void *parameter),
                   void *parameter,
...
;
# 212 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
rt_err_t rt_timer_detach(rt_timer_t timer)
{
...
;
# 247 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
rt_timer_t rt_timer_create(const char *name,
                           void (*timeout)(void *parameter),
                           void *parameter,
                           rt_tick_t time,
...
;
# 275 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
rt_err_t rt_timer_delete(rt_timer_t timer)
{
    register rt_base_t level;
...
;
# 306 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
rt_err_t rt_timer_start(rt_timer_t timer)
{
    unsigned int row_lvl;
    rt_list_t *timer_list;
    register rt_base_t level;
    rt_list_t *row_head[1];
    unsigned int tst_nr;
    ...
    do { if ((rt_object_take_hook) != (0)) rt_object_take_hook (&(timer->parent)); } while (0);
...
# 343 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
    {
    ...
    for (row_lvl = 0; row_lvl < 1; row_lvl++)
    {
             ...
             row_head[row_lvl] = row_head[row_lvl]->next)
        {
            ...
            t = ((struct rt_timer *)((char *)(p) - (unsigned long)(&((struct rt_timer *)0)->row[row_lvl])));
            ...
            else if ((t->timeout_tick - timer->timeout_tick) < 0xffffffff / 2)
            {
                break;
            }
        }
    ...
    rt_list_insert_after(row_head[1 - 1],
                         &(timer->row[1 - 1]));
    for (row_lvl = 2; row_lvl <= 1; row_lvl++)
    {
        if (!(tst_nr & 0x3))
            rt_list_insert_after(row_head[1 - row_lvl],
                                 &(timer->row[1 - row_lvl]));
        else
            break;
    ...
    rt_hw_interrupt_enable(level);
# 417 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
    return 0;
}
;
# 428 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
rt_err_t rt_timer_stop(rt_timer_t timer)
{
    register rt_base_t level;
    ...
    do { if ((rt_object_put_hook) != (0)) rt_object_put_hook (&(timer->parent)); } while (0);
...
;
# 465 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
rt_err_t rt_timer_control(rt_timer_t timer, int cmd, void *arg)
{
...
void rt_timer_check(void)
{
    ...
    while (!rt_list_isempty(&rt_timer_list[1 - 1]))
    {
        t = ((struct rt_timer *)((char *)(rt_timer_list[1 - 1].next) - (unsigned long)(&((struct rt_timer *)0)->row[1 - 1])))
                                                                             ;
        ...
        if ((current_tick - t->timeout_tick) < 0xffffffff / 2)
        {
            do { if ((rt_timer_enter_hook) != (0)) rt_timer_enter_hook (t); } while (0);
            ...
            do { if ((rt_timer_exit_hook) != (0)) rt_timer_exit_hook (t); } while (0);
            ;

            if ((t->parent.flag & 0x2) &&
                (t->parent.flag & 0x1))
            {
...
rt_tick_t rt_timer_next_timeout_tick(void)
{
    rt_tick_t next_timeout = 0xffffffff;
    rt_timer_list_next_timeout(rt_timer_list, &next_timeout);
    return next_timeout;
}
# 680 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
void rt_system_timer_init(void)
{
    int i;
...
void rt_system_timer_thread_init(void)
{
# 720 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/timer.c"
}
