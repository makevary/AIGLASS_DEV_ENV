# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
...
# 7 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c" 2
# 87 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
...
# 124 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
...
{
    ((*(volatile uint32_t *)&(pI2C->pReg->IPD)) = ((0xff)));
...
{
    ((*(volatile uint32_t *)&(pI2C->pReg->IEN)) = (0));
...
{
    uint32_t val = ((*(volatile const uint32_t *)&(pI2C->pReg->CON))) & (0xff << (8U));

    ((*(volatile uint32_t *)&(pI2C->pReg->CON)) = (val));
...
static HAL_Status I2C_Start(struct I2C_HANDLE *pI2C)
{
    ...
    if (pI2C->type == I2C_IT) {
        ((*(volatile uint32_t *)&(pI2C->pReg->IEN)) = ((0x1 << (4U))));
    }


    val |= (0x1 << (0U)) | ((pI2C->mode) << (1U)) | (0x1 << (3U)) | pI2C->cfg;


    if (!(pI2C->msg.flags & (0x1 << 2))) {
        val |= (0x1 << (6U));
    }
...
# 213 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
static HAL_Status I2C_Stop(struct I2C_HANDLE *pI2C, HAL_Status error)
{
    ...
    if (pI2C->isLastMSG || error) {
        if (pI2C->type == I2C_IT) {
            ...
            ((*(volatile uint32_t *)&(pI2C->pReg->IEN)) = ((0x1 << (5U))));
        }

        pI2C->state = STATE_STOP;

        ctrl = ((*(volatile const uint32_t *)&(pI2C->pReg->CON)));
        ctrl |= (0x1 << (4U));
        ((*(volatile uint32_t *)&(pI2C->pReg->CON)) = (ctrl));
        ...
        ctrl = ((*(volatile const uint32_t *)&(pI2C->pReg->CON))) & (0xff << (8U));
        ((*(volatile uint32_t *)&(pI2C->pReg->CON)) = (ctrl));
...
static HAL_Status I2C_PrepareRead(struct I2C_HANDLE *pI2C)
{
    ...
    con = ((*(volatile const uint32_t *)&(pI2C->pReg->CON)));
    ...
    if (pI2C->processed != 0) {
        con &= ~((0x3U << (1U)));
        con |= ((REG_CON_MOD_RX) << (1U));
    }

    ((*(volatile uint32_t *)&(pI2C->pReg->CON)) = (con));
    ((*(volatile uint32_t *)&(pI2C->pReg->MRXCNT)) = (len));
...
static HAL_Status I2C_FillTransmitBuf(struct I2C_HANDLE *pI2C)
{
    ...
    for (i = 0; i < 8; ++i) {
        ...
        ((*(volatile uint32_t *)&(pI2C->pReg->TXDATA[i])) = (val));
        if (pI2C->processed == pI2C->msg.len) {
            break;
        }
    }

    ((*(volatile uint32_t *)&(pI2C->pReg->MTXCNT)) = (cnt));

    return HAL_OK;
}
# 332 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
static HAL_Status I2C_HandleStart(struct I2C_HANDLE *pI2C, uint32_t ipd)
{
    if (!(ipd & (0x1 << (4U)))) {
        I2C_Stop(pI2C, HAL_ERROR);
        do { if (0) HAL_DBG_Printf("[HAL ERROR] " "unexpected irq in START: 0x%" 
# 336 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c" 3
       "l" 
# 336 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
       "x" "\n", ipd); } while (0);
        I2C_CleanIPD(pI2C);
    ...
    ((*(volatile uint32_t *)&(pI2C->pReg->IPD)) = ((0x1 << (4U))));


    ((*(volatile uint32_t *)&(pI2C->pReg->CON)) = (((*(volatile const uint32_t *)&(pI2C->pReg->CON))) & ~(0x1 << (3U))));


    if (pI2C->mode == REG_CON_MOD_TX) {
        if (pI2C->type == I2C_IT) {
            ((*(volatile uint32_t *)&(pI2C->pReg->IEN)) = ((0x1 << (2U)) | (0x1 << (6U))));
        }
        ...
        if (pI2C->type == I2C_IT) {
            ((*(volatile uint32_t *)&(pI2C->pReg->IEN)) = ((0x1 << (3U)) | (0x1 << (6U))));
        }
...
# 374 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
static HAL_Status I2C_HandleWrite(struct I2C_HANDLE *pI2C, uint32_t ipd)
{
    if (!(ipd & (0x1 << (2U)))) {
        I2C_Stop(pI2C, HAL_ERROR);
        do { if (0) HAL_DBG_Printf("[HAL ERROR] " "unexpected irq in WRITE: 0x%" 
# 378 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c" 3
       "l" 
# 378 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
       "x" "\n", ipd); } while (0);
        I2C_CleanIPD(pI2C);
    ...
    ((*(volatile uint32_t *)&(pI2C->pReg->IPD)) = ((0x1 << (2U))));
...
# 404 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
static HAL_Status I2C_HandleRead(struct I2C_HANDLE *pI2C, uint32_t ipd)
{
    ...
    ((*(volatile uint32_t *)&(pI2C->pReg->IPD)) = ((0x1 << (3U))));
    ...
    for (i = 0; i < len; ++i) {
        if (i % 4 == 0) {
            val = ((*(volatile const uint32_t *)&(pI2C->pReg->RXDATA[i / 4])));
        }
...
# 450 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
static HAL_Status I2C_HandleStop(struct I2C_HANDLE *pI2C, uint32_t ipd)
{
    ...
    if (!(ipd & (0x1 << (5U)))) {
        I2C_Stop(pI2C, HAL_ERROR);
        do { if (0) HAL_DBG_Printf("[HAL ERROR] " "unexpected irq in STOP: 0x%" 
# 456 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c" 3
       "l" 
# 456 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
       "x" "\n", ipd); } while (0);
        I2C_CleanIPD(pI2C);
    ...
    ((*(volatile uint32_t *)&(pI2C->pReg->IPD)) = ((0x1 << (5U))));
...
# 492 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
HAL_Status HAL_I2C_AdaptDIV(struct I2C_HANDLE *pI2C, uint32_t rate)
{
    ...
    rateKHZ = (((rate) + (1000) - 1) / (1000));
    spec = I2C_GetSpec(pI2C->speed);

    minTotalDIV = (((rateKHZ) + (speedKHZ * 8) - 1) / (speedKHZ * 8));

    minHighNS = spec->maxRiseNS + spec->minHighNS;
    minHighDIV = (((rateKHZ * minHighNS) + (8 * 1000000) - 1) / (8 * 1000000));

    minLowNS = spec->maxFallNS + spec->minLowNS;
    minLowDIV = (((rateKHZ * minLowNS) + (8 * 1000000) - 1) / (8 * 1000000));
    ...
    if (minHoldDIV >= minTotalDIV) {
        ...
        extraLowDIV = (((minLowDIV * extraDIV) + (minHoldDIV) - 1) / (minHoldDIV));
    ...
    pI2C->cfg = ((1) << (8U)) | ((startSetup) << (12U));
    ((*(volatile uint32_t *)&(pI2C->pReg->CLKDIV)) = ((highDIV << (16U)) | lowDIV));

    ((*(volatile uint32_t *)&(pI2C->pReg->CON)) = (((1) << (8U)) | ((startSetup) << (12U))));
...
HAL_Status HAL_I2C_IRQHandler(struct I2C_HANDLE *pI2C)
{
    uint32_t ipd = ((*(volatile const uint32_t *)&(pI2C->pReg->IPD)));
    HAL_Status result = HAL_BUSY;

    if (pI2C->state == STATE_IDLE) {
        do { if (0) HAL_DBG_Printf("[HAL WARNING] " "irq in STATE_IDLE, ipd = 0x%" 
# 569 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c" 3
       "l" 
# 569 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
       "x" "\n", ipd); } while (0);
        I2C_CleanIPD(pI2C);
    ...
    if (ipd & (0x1 << (6U))) {
        ...
        ((*(volatile uint32_t *)&(pI2C->pReg->IPD)) = ((0x1 << (6U))));
        ipd &= ~(0x1 << (6U));
...
# 639 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
HAL_Status HAL_I2C_SetupMsg(struct I2C_HANDLE *pI2C, uint16_t addr, uint8_t *buf,
                            uint16_t len, uint16_t flags)
{
    ;
...
# 661 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
HAL_Status HAL_I2C_ConfigureMode(struct I2C_HANDLE *pI2C, eI2C_Mode mode,
                                 uint32_t addr, uint32_t regAddr)
{
    ;
    ...
    if (mode == REG_CON_MOD_REGISTER_TX) {
        ((*(volatile uint32_t *)&(pI2C->pReg->MRXADDR)) = (addr));
        ((*(volatile uint32_t *)&(pI2C->pReg->MRXRADDR)) = (regAddr));
    }
...
# 684 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
HAL_Status HAL_I2C_Transfer(struct I2C_HANDLE *pI2C, eI2C_TransferType type, 
# 684 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c" 3 4
                                                                            _Bool 
# 684 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
                                                                                 last)
{
...
HAL_Status HAL_I2C_ForceStop(struct I2C_HANDLE *pI2C)
{
    ...
    I2C_DisableIRQ(pI2C);
    ((*(volatile uint32_t *)&((pI2C->pReg->CON))) = ((((((*(volatile const uint32_t *)&(pI2C->pReg->CON)))) & (~(~(0xff << (8U))))) | ((0x1 << (0U)) | (0x1 << (4U))))))
                                         ;
...
HAL_Status HAL_I2C_WriteFinish(struct I2C_HANDLE *pI2C)
{
    if (((*(volatile const uint32_t *)&(pI2C->pReg->IPD))) & (0x1 << (2U))) {
        return HAL_OK;
    }
...
HAL_Status HAL_I2C_StopFinish(struct I2C_HANDLE *pI2C)
{
    if ((0x1 << (5U)) & ((*(volatile const uint32_t *)&(pI2C->pReg->IPD)))) {
        return HAL_OK;
    }

    return HAL_BUSY;
}
# 776 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
HAL_Status HAL_I2C_StartTXU32(struct I2C_HANDLE *pI2C, uint32_t *buf,
                              uint16_t len32, uint16_t len8)
{
    int i;
    ...
    for (i = 0; i < len32; i++) {
        ((*(volatile uint32_t *)&(pI2C->pReg->TXDATA[i])) = (buf[i]));
    }


    ((*(volatile uint32_t *)&(pI2C->pReg->CON)) = ((0x1 << (0U)) | (0x1 << (3U)) | pI2C->cfg));
    ((*(volatile uint32_t *)&(pI2C->pReg->MTXCNT)) = (len8));

    return HAL_OK;
}
# 805 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
HAL_Status HAL_I2C_StartTX(struct I2C_HANDLE *pI2C, uint16_t addr,
                           uint8_t *buf, uint16_t len)
{
    uint32_t i, j;
...
HAL_Status HAL_I2C_CloseTX(struct I2C_HANDLE *pI2C)
{
    ((*(volatile uint32_t *)&(pI2C->pReg->MTXCNT)) = (0));
    ((*(volatile uint32_t *)&(pI2C->pReg->CON)) = (0));

    return HAL_OK;
}
# 894 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_i2c.c"
HAL_Status HAL_I2C_Init(struct I2C_HANDLE *pI2C, struct I2C_REG *pReg, uint32_t rate,
                        eI2C_BusSpeed speed)
{
