# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.c"
# 13 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.h" 1
# 16 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.h"
...
# 17 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.h" 2
...
# 18 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.h" 2
...
# 19 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/isp3.h"
...
# 19 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.h" 2
...
# 14 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.c" 2
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/regs_v3x.h" 1
# 15 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.c" 2
# 36 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.c"
struct dphy_param
{
    uint32_t data_rate_mbps;
    uint8_t hs_settle;
};
# 150 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.c"
...
# 181 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.c" 3 4
   _Bool 
# 181 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.c"
        dual_cam_en;
    ...
    if (!csi2_dphy->enable)
    {
        rt_kprintf("[ISP]: %s ERR ""dphy is not enable\n""", __FUNCTION__);
        return -1;
    }
    ...
    csi2_dphy->csi2_dphy1.data_lanes = (mbus_config->flags & (0x3 << (0x0))) + 1;

    len = sizeof(rv1109_dphy_param) / sizeof(rv1109_dphy_param[0]);
    data_rate_mbps = ({ (((mbus_config->linked_freq) + (1000000 - 1)) / 1000000) * 1000000; }) << 1;
    ...
    {
        index = len - 2;
        rt_kprintf("[ISP]: %s ERR ""can't match data rate: %dmbps, use %dmbps as default""", __FUNCTION__, data_rate_mbps, rv1109_dphy_param[index].data_rate_mbps)
                                                              ;
    }
    ...
    if (dual_cam_en)
    {
        ...
        (*(volatile unsigned int *)(dphy_base + (0x80)) = (0x5e));
        (*(volatile unsigned int *)(dphy_base + (0x80)) = (0x5f));
    }
    else
    {
        (*(volatile unsigned int *)(dphy_base + (0x80)) = (0x1e));
        (*(volatile unsigned int *)(dphy_base + (0x80)) = (0x1f));
    }

    grf_lanes_en = ((0x1 << (8)) | (0x1 << ((8) + 16)));
    (*(volatile unsigned int *)(dphy_base + (0x160)) = (rv1109_dphy_param[index].hs_settle));
    ...
    if (csi2_dphy->csi2_dphy1.enable)
    {
        ...
        {
            lanes_en |= (0x1 << (2));
            grf_lanes_en |= ((0x1 << (4)) | (0x1 << ((4) + 16)));
            (*(volatile unsigned int *)(dphy_base + (0x1e0)) = (rv1109_dphy_param[index].hs_settle));
        }
        if (csi2_dphy->csi2_dphy1.data_lanes >= 2)
        {
            lanes_en |= (0x1 << (3));
            grf_lanes_en |= ((0x1 << (5)) | (0x1 << ((5) + 16)));
            (*(volatile unsigned int *)(dphy_base + (0x260)) = (rv1109_dphy_param[index].hs_settle));
        }
        if (csi2_dphy->csi2_dphy1.data_lanes >= 4)
        {
            lanes_en |= (0x1 << (4));
            grf_lanes_en |= ((0x1 << (6)) | (0x1 << ((6) + 16)));
            (*(volatile unsigned int *)(dphy_base + (0x2e0)) = (rv1109_dphy_param[index].hs_settle));
            lanes_en |= (0x1 << (5));
            grf_lanes_en |= ((0x1 << (7)) | (0x1 << ((7) + 16)));
            (*(volatile unsigned int *)(dphy_base + (0x360)) = (rv1109_dphy_param[index].hs_settle));
    ...
    lanes_en |= 0x41;
    (*(volatile unsigned int *)(dphy_base + (0x00)) = (lanes_en));

    if (mbus_config->mbus_type == CAMERA_MBUS_CSI2_DPHY)
    {

        (*(volatile unsigned int *)(dphy_base + (0x44C)) = (0x02));
        if (dual_cam_en)

            (*(volatile unsigned int *)(dphy_base + (0X84)) = (0x14));
        else
            (*(volatile unsigned int *)(dphy_base + (0X84)) = (0x04));
    }
    else if (mbus_config->mbus_type == CAMERA_MBUS_LVDS_DPHY)
    {
        (*(volatile unsigned int *)(dphy_base + (0x44C)) = (0x04));

        mask = mbus_config->flags & (0x3 << (0x7));
        if (mask == (0x1 << (0x7)))
        {
            lvds_mode = (0x2 << (4));
        }
        else if (mask == (0x2 << (0x7)))
        {
            lvds_mode = (0x0 << (4));
        }
        else if (mask == (0x3 << (0x7)))
        {
            lvds_mode = (0x1 << (4));
        }
        lvds_mode |= (0x1 << (0x0));
        (*(volatile unsigned int *)(dphy_base + (0x480)) = (lvds_mode));

    }

    mask = mbus_config->flags & (0x1 << (0x6));
    if (mask)
    {

        (*(volatile unsigned int *)(dphy_base + (0x128)) = (0x1));
    }
    else
    {

        (*(volatile unsigned int *)(dphy_base + (0x128)) = (0x0));
    }

    (*(volatile unsigned int *)((0x20120000U + 0x14)) = (grf_lanes_en));
...
int rk_isp_hw_mipi_lvds_dphy_reinit(struct rk_isp_dev *dev)
{
    ...
    (*(volatile unsigned int *)(dphy_base + (0x00)) = (0x01));
...
int rk_isp_hw_csi_host_init(struct rk_isp_dev *dev)
{
    ...
    lane_num = mbus_config->flags & (0x3 << (0x0));

    if (csi_host0->enable)
    {
        (*(volatile unsigned int *)(csi_host0_base + (0x04)) = (lane_num));
        (*(volatile unsigned int *)(csi_host0_base + (0x40)) = (0x0c204000));
        (*(volatile unsigned int *)(csi_host0_base + (0x10)) = (0x1));
    }
    if (csi_host1->enable)
    {
        (*(volatile unsigned int *)(csi_host1_base + (0x04)) = (lane_num));
        (*(volatile unsigned int *)(csi_host1_base + (0x40)) = (0x0c204000));
        (*(volatile unsigned int *)(csi_host1_base + (0x10)) = (0x1));
    }
...
int rk_isp_hw_csi_host_reinit(struct rk_isp_dev *dev)
{
    ...
    if (csi_host0->enable)
    {
        (*(volatile unsigned int *)(csi_host0_base + (0x20)));
        (*(volatile unsigned int *)(csi_host0_base + (0x24)));
        (*(volatile unsigned int *)(csi_host0_base + (0x10)) = (0x0));
    }
    if (csi_host1->enable)
    {
        (*(volatile unsigned int *)(csi_host1_base + (0x20)));
        (*(volatile unsigned int *)(csi_host1_base + (0x24)));
        (*(volatile unsigned int *)(csi_host1_base + (0x10)) = (0x0));
    }
...
static int rk_isp_hw_vicap_init_buf(struct rk_isp_dev *dev, uint32_t host_offset)
{
    ...
    if (!dev->buf_addr0)
    {
        ...
        if (dev->buf_addr0)
        {
            (*(volatile unsigned int *)(vicap_base + host_offset + (0x0124)) = ((uint32_t)dev->buf_addr0->addr));
    ...
    if (!dev->buf_addr1)
    {
        ...
        if (dev->buf_addr1)
        {
            (*(volatile unsigned int *)(vicap_base + host_offset + (0x0128)) = ((uint32_t)dev->buf_addr1->addr));
...
# 431 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.c" 3 4
                               ((void *)0)
# 431 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.c"
                                   ;
    int on = 0;
    ...
    if (mbus_config->mbus_type == CAMERA_MBUS_CSI2_DPHY)
    {
        if (frame_phase & CIF_CSI_FRAME0_READY)
        {
            ...
            if (dev->buf_addr0)
            {
                (*(volatile unsigned int *)(vicap_base + host_offset + frm_addr_y) = ((uint32_t)dev->buf_addr0->addr));
            }
            else
            {
                if (!dev->buf_addr1)
                {
                    rk_device_control(&dev->subdev->parent, (27), &on);
                    dev->is_sensor_off = 
# 450 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.c" 3 4
                                        1
# 450 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.c"
                                            ;
                }
            }
        }
        else
        {
            ...
            if (dev->buf_addr1)
            {
                (*(volatile unsigned int *)(vicap_base + host_offset + frm_addr_y) = ((uint32_t)dev->buf_addr1->addr));
            }
            else
            {
                if (!dev->buf_addr0)
                {
                    rk_device_control(&dev->subdev->parent, (27), &on);
                    dev->is_sensor_off = 
# 468 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.c" 3 4
                                        1
# 468 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.c"
                                            ;
                }
            }
        }
...
# 601 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/isp3/drv_isp3_subdev.c"
int rk_isp_hw_vicap_init(struct rk_isp_dev *dev)
{
    ...
    if (mbus_config->mbus_type == CAMERA_MBUS_CSI2_DPHY)
    {
        ...
        if (output_info->output_fmt->fmt_type == ISP_DEVICE_FORMAT_RAW)
        {
            if (csi_host0->enable)
            {
                (*(volatile unsigned int *)(vicap_base + (0x0134)) = (dev->bytesperline));
                rk_isp_hw_vicap_init_buf(dev, 0);
                (*(volatile unsigned int *)(vicap_base + (0x0174)) = ((0x3U << (8U)) | (0x1U << (16U)) | (0x1U << (18U)) | (0x1U << (19U)) | (0x1U << (24U)) | (0x1U << (0U))))
            ...
            if (csi_host1->enable)
            {
                (*(volatile unsigned int *)(vicap_base + (0x0334)) = (dev->bytesperline));
                rk_isp_hw_vicap_init_buf(dev, 0x200);
                (*(volatile unsigned int *)(vicap_base + (0x0374)) = ((0x3U << (8U)) | (0x1U << (16U)) | (0x1U << (18U)) | (0x1U << (19U)) | (0x1U << (24U)) | (0x1U << (0U))))
        ...
        else
        {
            if (csi_host0->enable)
            {
                (*(volatile unsigned int *)(vicap_base + (0x0780)) = ((0x1)));
            }
            if (csi_host1->enable)
            {
                (*(volatile unsigned int *)(vicap_base + (0x0780)) = ((0x21)));
            }
        }
        (*(volatile unsigned int *)(vicap_base + (0x0784)) = ((height << 16) | width));

        if (csi_host0->enable)
        {
            (*(volatile unsigned int *)(vicap_base + (0x0100)) = (val));
            (*(volatile unsigned int *)(vicap_base + (0x0104)) = (val2));
            (*(volatile unsigned int *)(vicap_base + (0x0120)) = (0x200001));
            (*(volatile unsigned int *)(vicap_base + (0x01A0)) = ((height << 16) | width));
        }
        if (csi_host1->enable)
        {
            (*(volatile unsigned int *)(vicap_base + (0x0300)) = (val));
            (*(volatile unsigned int *)(vicap_base + (0x0304)) = (val2));
            (*(volatile unsigned int *)(vicap_base + (0x0320)) = (0x200001));
            (*(volatile unsigned int *)(vicap_base + (0x03A0)) = ((height << 16) | width));
        }
    }
...
int rk_isp_hw_vicap_reinit(struct rk_isp_dev *dev)
{
    ...
    (*(volatile unsigned int *)(vicap_base + (0x0780)) = (0));

    if (csi_host0->enable)
    {
        val = (*(volatile unsigned int *)(vicap_base + (0x0100)));
        val &= (~0x1);
        (*(volatile unsigned int *)(vicap_base + (0x0100)) = (val));
        (*(volatile unsigned int *)(vicap_base + (0x0120)) = (0xa0000));
        (*(volatile unsigned int *)(vicap_base + (0x0178)) = (0xffffffff));
    }
    if (csi_host1->enable)
    {
        val = (*(volatile unsigned int *)(vicap_base + (0x0300)));
        val &= (~0x1);
        (*(volatile unsigned int *)(vicap_base + (0x0300)) = (val));
        (*(volatile unsigned int *)(vicap_base + (0x0320)) = (0xa0000));
        (*(volatile unsigned int *)(vicap_base + (0x0378)) = (0xffffffff));
    }
