# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
# 11 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
...
# 12 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 2
...
# 14 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 2
# 26 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
void rt_rbb_init(rt_rbb_t rbb, rt_uint8_t *buf, rt_size_t buf_size, rt_rbb_blk_t block_set, rt_size_t blk_max_num)
{
    rt_size_t i;
...
;
# 56 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
rt_rbb_t rt_rbb_create(rt_size_t buf_size, rt_size_t blk_max_num)
{
    rt_rbb_t rbb = 
# 58 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                  ((void *)0)
# 58 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
                      ;
    rt_uint8_t *buf;
    rt_rbb_blk_t blk_set;
    ...
    {
        return 
# 65 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
              ((void *)0)
# 65 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
                  ;
    }
    ...
    if (!buf)
    {
        rt_free(rbb);
        return 
# 72 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
              ((void *)0)
# 72 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
                  ;
    }
    ...
    if (!blk_set)
    {
        ...
        rt_free(rbb);
        return 
# 80 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
              ((void *)0)
# 80 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
                  ;
    }
...
static rt_rbb_blk_t find_empty_blk_in_set(rt_rbb_t rbb)
{
    ...
    return 
# 119 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
          ((void *)0)
# 119 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
              ;
}
# 133 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
rt_rbb_blk_t rt_rbb_blk_alloc(rt_rbb_t rbb, rt_size_t blk_size)
{
    rt_base_t level;
    rt_size_t empty1 = 0, empty2 = 0;
    rt_rbb_blk_t head, tail, new = 
# 137 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                                  ((void *)0)
# 137 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
                                      ;
    ...
    if (rt_slist_len(&rbb->blk_list) < rbb->blk_max_num && new)
    {
        ...
        {
            head = ((struct rt_rbb_blk *)((char *)((&rbb->blk_list)->next) - (unsigned long)(&((struct rt_rbb_blk *)0)->list)));
            tail = ((struct rt_rbb_blk *)((char *)(rt_slist_tail(&rbb->blk_list)) - (unsigned long)(&((struct rt_rbb_blk *)0)->list)));
            if (head->buf <= tail->buf)
            {
                ...
                else
                {
                    ...
                    new = 
# 181 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                         ((void *)0)
# 181 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
                             ;
                }
            }
            else
            {
                ...
                else
                {
                    ...
                    new = 
# 205 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                         ((void *)0)
# 205 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
                             ;
                }
            }
        }
    ...
    {
        new = 
# 220 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
             ((void *)0)
# 220 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
                 ;
    }
...
;
# 251 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
rt_rbb_blk_t rt_rbb_blk_get(rt_rbb_t rbb)
{
    rt_base_t level;
    rt_rbb_blk_t block = 
# 254 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                        ((void *)0)
# 254 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
                            ;
    rt_slist_t *node;
    ...
    {
        block = ((struct rt_rbb_blk *)((char *)(node) - (unsigned long)(&((struct rt_rbb_blk *)0)->list)));
    ...
    block = 
# 274 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
           ((void *)0)
# 274 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
               ;
...
;
# 291 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
rt_size_t rt_rbb_blk_size(rt_rbb_blk_t block)
{
    ;
...
;
# 306 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
rt_uint8_t *rt_rbb_blk_buf(rt_rbb_blk_t block)
{
    ;
...
;
# 362 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
rt_size_t rt_rbb_blk_queue_get(rt_rbb_t rbb, rt_size_t queue_data_len, rt_rbb_blk_queue_t blk_queue)
{
    rt_base_t level;
    rt_size_t data_total_size = 0;
    rt_slist_t *node;
    rt_rbb_blk_t last_block = 
# 367 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                             ((void *)0)
# 367 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
                                 , block;
    ...
    for (node = rt_slist_first(&rbb->blk_list); node; node = rt_slist_next(node))
    {
        if (!last_block)
        {
            last_block = ((struct rt_rbb_blk *)((char *)(node) - (unsigned long)(&((struct rt_rbb_blk *)0)->list)));
            ...
            else
            {
                ...
                last_block = 
# 391 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                            ((void *)0)
# 391 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
                                ;
                continue;
            }
        }
...
;
# 433 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
rt_size_t rt_rbb_blk_queue_len(rt_rbb_blk_queue_t blk_queue)
{
...
;
# 455 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
rt_uint8_t *rt_rbb_blk_queue_buf(rt_rbb_blk_queue_t blk_queue)
{
    ;
...
;
# 491 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
rt_size_t rt_rbb_next_blk_queue_len(rt_rbb_t rbb)
{
    rt_base_t level;
    ...
    rt_slist_t *node;
    rt_rbb_blk_t last_block = 
# 496 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                             ((void *)0)
# 496 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
                                 , block;
    ...
    for (node = rt_slist_first(&rbb->blk_list); node; node = rt_slist_next(node))
    {
        if (!last_block)
        {
            ...
            if (last_block->status != RT_RBB_BLK_PUT)
            {
                ...
                last_block = 
# 513 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c" 3 4
                            ((void *)0)
# 513 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
                                ;
                continue;
            }
        }
...
;
# 548 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/src/ringblk_buf.c"
rt_size_t rt_rbb_get_buf_size(rt_rbb_t rbb)
{
    ;
