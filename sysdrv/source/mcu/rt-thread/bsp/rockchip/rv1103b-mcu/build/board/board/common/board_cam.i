...
# 12 "board/common/board_cam.c" 2


# 1 "board/common/board_cam.h" 1
# 15 "board/common/board_cam.h"
...
__attribute__((weak)) struct dphy_board_desc csi2_dphy_board =
{
    .enable = 
# 23 "board/common/board_cam.c" 3 4
             0
# 23 "board/common/board_cam.c"
                  ,
    .reg = 0x20DB0000,

    .csi2_dphy1.enable = 
# 26 "board/common/board_cam.c" 3 4
                        0
# 26 "board/common/board_cam.c"
                             ,
    ...
    .csi2_dphy2.enable = 
# 31 "board/common/board_cam.c" 3 4
                        0
# 31 "board/common/board_cam.c"
                             ,
...
__attribute__((weak)) struct csi2_board_desc csi2_host0_board =
{
    .enable = 
# 39 "board/common/board_cam.c" 3 4
             0
# 39 "board/common/board_cam.c"
                  ,
    .reg = 0x20d90000,
    .csi_host_idx = 0,
};

__attribute__((weak)) struct csi2_board_desc csi2_host1_board =
{
    .enable = 
# 46 "board/common/board_cam.c" 3 4
             0
# 46 "board/common/board_cam.c"
                  ,
    .reg = 0x20da0000,
    .csi_host_idx = 1,
};

__attribute__((weak)) struct vicap_board_desc vicap_board =
{
    .enable = 
# 53 "board/common/board_cam.c" 3 4
             0
# 53 "board/common/board_cam.c"
                  ,
    .reg = 0x20D10000,
};

__attribute__((weak)) void cif_hw_config(void);
...
const char *cam_get_pwm_name(int pwm_channel)
{
    ...
    return 
# 82 "board/common/board_cam.c" 3 4
          ((void *)0)
# 82 "board/common/board_cam.c"
              ;
}
...
# 90 "board/common/board_cam.c" 3 4
                            ((void *)0)
# 90 "board/common/board_cam.c"
                                ;
    int gpio_group = -1;
    int gpio_pin = -1;
    ...
    {
    case 0:
        pGPIO = ((struct GPIO_REG *) 0x20520000U);
        break;
    case 1:
        pGPIO = ((struct GPIO_REG *) 0x20D80000U);
        break;
    case 2:
        pGPIO = ((struct GPIO_REG *) 0x20840000U);
        break;
    default:
        return -1;
        break;
    }
    HAL_GPIO_SetPinLevel(pGPIO, (1 << (gpio_pin)), gpio_level);
    return 0;
}
...
{
    struct GPIO_REG *pGPIO = 
# 120 "board/common/board_cam.c" 3 4
                            ((void *)0)
# 120 "board/common/board_cam.c"
                                ;
    int gpio_group = -1;
    int gpio_pin = -1;
    int gpio_bank = -1;
    ...
    pin_config_mux = (gpio_func | (1UL << (31))) & (~(1 << 25)) & (~(1 << 26));
    HAL_GPIO_SetPinDirection(pGPIO, (1 << (gpio_pin)), gpio_direction);
    HAL_GPIO_SetPinLevel(pGPIO, (1 << (gpio_pin)), gpio_default_level);
    HAL_PINCTRL_SetIOMUX(gpio_bank, (1 << (gpio_pin)), pin_config_mux);
    return 0;
}
