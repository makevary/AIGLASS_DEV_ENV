...
# 12 "board/common/board_base.c" 2
...
# 15 "board/common/board_base.c" 2
# 1 "board/rv1103b_evb2-SC200AI-ADC/iomux.h" 1
# 14 "board/rv1103b_evb2-SC200AI-ADC/iomux.h"
# 1 "board/common/iomux_base.h" 1
# 14 "board/common/iomux_base.h"
...
void i2c3_m0_iomux_config(void);
void i2c3_m1_iomux_config(void);
void i2c4_m0_iomux_config(void);
void i2c4_m1_iomux_config(void);
void uart0_m0_iomux_config(void);
void rt_hw_iomux_config(void);
# 15 "board/rv1103b_evb2-SC200AI-ADC/iomux.h" 2
# 16 "board/common/board_base.c" 2
...
void BSP_Init(void);
# 18 "board/common/board_base.c" 2

# 1 "board/common/board_base.h" 1
# 20 "board/common/board_base.c" 2
...
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_i2c.h" 1
# 35 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_i2c.h"
struct I2C_REG;
...
# 27 "board/common/board_base.c" 2


extern __attribute__((unused)) uint32_t __DATA_START__[];
extern __attribute__((unused)) uint32_t _tdata_end[];
extern __attribute__((unused)) uint32_t __SAVE_DATA_START__[];

__attribute__((section(".data"))) static int data_fixup_flag = 0;
...
# 83 "board/common/board_base.c"
__attribute__((weak)) const struct rockchip_i2c_config rockchip_i2c_config_table[] =
{
    {
        .id = ((struct I2C_REG *) 0x20940000U),
        .speed = I2C_400K,
    },
    { }
};
...
volatile static rt_bool_t sirq = 0;
static void board_softirq_handler(int vector, void *param)
{

    ((struct GRF_SYS_REG *) 0x20150000U)->HPMCU_CACHE_MISC = 0x00080000;
    sirq = 1;
}
...
void rt_hw_board_init(void)
{
    ...
    rt_system_heap_init((void *)&_end, (void *)&_heap_end);
    rt_hw_interrupt_init();
    rt_soft_interrupt_install(board_softirq_handler, (0), "soft irq");
    sysTick_config(396000000 / 1000);
    ...
    ((struct GRF_SYS_REG *) 0x20150000U)->PERI_CON2 = 0x01000100;
