# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/serial/serial.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/serial/serial.c"
# 27 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/serial/serial.c"
...
# 28 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/serial/serial.c" 2
...
# 30 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/serial/serial.c" 2



# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/include/rtdbg.h" 1
# 34 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/serial/serial.c" 2
# 206 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/serial/serial.c"
...
static rt_size_t _serial_fifo_calc_recved_len(struct rt_serial_device *serial)
{
    ...
    {
        return (rx_fifo->is_full == 0 ? 0 : serial->config.bufsz);
    }
    else
    {
        if (rx_fifo->put_index > rx_fifo->get_index)
...
# 363 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/serial/serial.c"
...
static void rt_dma_recv_update_get_index(struct rt_serial_device *serial, rt_size_t len)
{
    ...
    if (rx_fifo->is_full && len != 0) rx_fifo->is_full = 0;
...
static rt_err_t rt_serial_open(struct rt_device *dev, rt_uint16_t oflag)
{
    ...
    if ((oflag & 0x040) || (dev->open_flag & 0x040))
        stream_flag = 0x040;
    ...
    serial->ops->control(serial, 0x20, (0));
...
static rt_err_t rt_serial_close(struct rt_device *dev)
{
    ...
    serial->ops->control(serial, 0x21, (0));
...
# 938 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/serial/serial.c"
                                  ...
                                  void *args)
{
    ...
    switch (cmd)
    {
        ...
        case 0x03:
            ...
            break;
# 1091 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/serial/serial.c"
        default :
...
# 1115 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/serial/serial.c"
rt_err_t rt_hw_serial_register(struct rt_serial_device *serial,
                               const char *name,
                               rt_uint32_t flag,
                               void *data)
