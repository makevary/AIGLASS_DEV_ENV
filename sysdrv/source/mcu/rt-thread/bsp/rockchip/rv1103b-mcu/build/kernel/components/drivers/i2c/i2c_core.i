# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/i2c/i2c_core.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/i2c/i2c_core.c"
# 11 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/i2c/i2c_core.c"
...
# 12 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/i2c/i2c_core.c" 2
                                    ...
                                    const char *bus_name)
{
    ...
    rt_mutex_init(&bus->lock, "i2c_bus_lock", 0x00);

    if (bus->timeout == 0) bus->timeout = 1000;
...
struct rt_i2c_bus_device *rt_i2c_bus_device_find(const char *bus_name)
{
    ...
    if (dev == (0) || dev->type != RT_Device_Class_I2CBUS)
    {
        ;
                          ...
                          rt_uint32_t num)
{
    ...
    {
# 62 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/components/drivers/i2c/i2c_core.c"
        rt_mutex_take(&bus->lock, -1);
...
__attribute__((used)) const init_fn_t __rt_init_rt_i2c_core_init __attribute__((section(".rti_fn.""4"))) = rt_i2c_core_init;
