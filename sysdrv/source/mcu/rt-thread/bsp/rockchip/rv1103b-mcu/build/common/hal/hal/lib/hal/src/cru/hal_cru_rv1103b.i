# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru_rv1103b.c"
...
# 7 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru_rv1103b.c" 2
# 27 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru_rv1103b.c"
...
static struct PLL_SETUP GPLL = {
    .conOffset0 = &(((struct TOPCRU_REG *) 0x20060000U)->GPLL_CON[0]),
    .conOffset1 = &(((struct TOPCRU_REG *) 0x20060000U)->GPLL_CON[1]),
    .conOffset2 = &(((struct TOPCRU_REG *) 0x20060000U)->GPLL_CON[2]),
    .conOffset3 = &(((struct TOPCRU_REG *) 0x20060000U)->GPLL_CON[3]),
    .modeOffset = &(((struct TOPCRU_REG *) 0x20060000U)->MODE_CON00),
    .modeShift = 0,
    .lockShift = 10,
    .modeMask = 0x3 << 0,
    .rateTable = PLL_TABLE,
};
# 71 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru_rv1103b.c"
static uint32_t HAL_CRU_ClkFracGetFreq(eCLOCK_Name clockName)
{
    uint32_t freq = 0;
    uint32_t mux = ((uint32_t)(((clockName) & 0xFFFFFFFF00000000) >> 32));
    uint32_t divSrc, divFrac;
    uint32_t n, m, pRate;

    switch (clockName) {
    case CLK_UART0:
        divSrc = ((uint32_t)((CLK_UART0_SRC) & 0x00000000FFFFFFFF));
        divFrac = ((uint32_t)((CLK_UART0_FRAC) & 0x00000000FFFFFFFF));
        break;
    case CLK_UART1:
        divSrc = ((uint32_t)((CLK_UART1_SRC) & 0x00000000FFFFFFFF));
        divFrac = ((uint32_t)((CLK_UART1_FRAC) & 0x00000000FFFFFFFF));
        break;
    case CLK_UART2:
        divSrc = ((uint32_t)((CLK_UART2_SRC) & 0x00000000FFFFFFFF));
        divFrac = ((uint32_t)((CLK_UART2_FRAC) & 0x00000000FFFFFFFF));
        break;
    case MCLK_SAI:
        divSrc = ((uint32_t)((CLK_SAI_SRC) & 0x00000000FFFFFFFF));
        divFrac = ((uint32_t)((CLK_SAI_FRAC) & 0x00000000FFFFFFFF));
        break;
    default:
...
# 144 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru_rv1103b.c"
static HAL_Status HAL_CRU_ClkFracSetFreq(eCLOCK_Name clockName, uint32_t rate)
{
    ...
    case CLK_UART0:
        ...
        divFrac = ((uint32_t)((CLK_UART0_FRAC) & 0x00000000FFFFFFFF));
        gateId = 0x00007010;
        fracGateId = 0x00007016;
        break;
    case CLK_UART1:
        divSrc = ((uint32_t)((CLK_UART1_SRC) & 0x00000000FFFFFFFF));
        divFrac = ((uint32_t)((CLK_UART1_FRAC) & 0x00000000FFFFFFFF));
        gateId = 0x00007011;
        fracGateId = 0x00007017;
        break;
    case CLK_UART2:
        divSrc = ((uint32_t)((CLK_UART2_SRC) & 0x00000000FFFFFFFF));
        divFrac = ((uint32_t)((CLK_UART2_FRAC) & 0x00000000FFFFFFFF));
        gateId = 0x00007012;
        fracGateId = 0x00007018;
        break;
    case MCLK_SAI:
        divSrc = ((uint32_t)((CLK_SAI_SRC) & 0x00000000FFFFFFFF));
        divFrac = ((uint32_t)((CLK_SAI_FRAC) & 0x00000000FFFFFFFF));
        gateId = 0x0000701C;
        fracGateId = 0x0000701D;
        break;
    default:
...
{
    ((struct TOPCRU_REG *) 0x20060000U)->CRU_CLKSEL_CON[31] = (((__builtin_constant_p((0x1U << (9U))) ? (((0x1U << (9U))) > 0xFFFFU ? 0 : (((0x1U << (9U))) << 16)) : (((0x1U << (9U))) << 16))) | (1 << (9U)));
    ((struct TOPCRU_REG *) 0x20060000U)->CRU_CLKSEL_CON[37] = (((__builtin_constant_p((0x7U << (13U))) ? (((0x7U << (13U))) > 0xFFFFU ? 0 : (((0x7U << (13U))) << 16)) : (((0x7U << (13U))) << 16))) | (1 << (13U)));
    ((struct TOPCRU_REG *) 0x20060000U)->GPLL_CON[0] = (((__builtin_constant_p((0x7U << (12U))) ? (((0x7U << (12U))) > 0xFFFFU ? 0 : (((0x7U << (12U))) << 16)) : (((0x7U << (12U))) << 16))) | (1 << (12U)));
}
...
uint32_t HAL_CRU_ClkGetFreq(eCLOCK_Name clockName)
{
    uint32_t clkMux = ((uint32_t)(((clockName) & 0xFFFFFFFF00000000) >> 32));
    uint32_t clkDiv = ((uint32_t)((clockName) & 0x00000000FFFFFFFF));
    ...
    case CCLK_SDMMC1:
    case SCLK_SFC_2X:
        pRate = HAL_CRU_MuxGetFreq2(clkMux, s_gpllFreq, (24 * 1000 * 1000));
    ...
    case CLK_I2C0:
        return HAL_CRU_MuxGetFreq2(((uint32_t)(((CLK_I2C_PMU) & 0xFFFFFFFF00000000) >> 32)), s_gpllFreq / 12, (24 * 1000 * 1000));
    case CLK_I2C1:
    case CLK_I2C2:
    case CLK_I2C3:
    case CLK_I2C4:
        return HAL_CRU_MuxGetFreq2(((uint32_t)(((CLK_I2C_PERI) & 0xFFFFFFFF00000000) >> 32)), s_gpllFreq / 12, (24 * 1000 * 1000));
    case CLK_SPI0:
        return HAL_CRU_MuxGetFreq4(clkMux, s_gpllFreq / 6, s_gpllFreq / 12, s_gpllFreq / 24, (24 * 1000 * 1000));
    case CLK_PWM0:
    case CLK_PWM1:
    case CLK_PWM2:
        return HAL_CRU_MuxGetFreq2(clkMux, s_gpllFreq / 12, (24 * 1000 * 1000));
    case DCLK_DECOM:
    ...
    case MCLK_SAI_OUT2IO:
        pRate = HAL_CRU_MuxGetFreq2(clkMux, HAL_CRU_ClkGetFreq(MCLK_SAI), (24 * 1000 * 1000) / 2);
        break;
    ...
    case CLK_MIPI0_OUT2IO:
        pRate = HAL_CRU_MuxGetFreq2(clkMux, HAL_CRU_ClkGetFreq(CLK_REF_MIPI0_SRC), (24 * 1000 * 1000));
        break;
    case CLK_MIPI1_OUT2IO:
        pRate = HAL_CRU_MuxGetFreq2(clkMux, HAL_CRU_ClkGetFreq(CLK_REF_MIPI1_SRC), (24 * 1000 * 1000));
        break;
...
# 354 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/cru/hal_cru_rv1103b.c"
HAL_Status HAL_CRU_ClkSetFreq(eCLOCK_Name clockName, uint32_t rate)
{
    ...
    case CCLK_SDMMC1:
    case SCLK_SFC_2X:
        mux = HAL_CRU_RoundFreqGetMux2(rate, s_gpllFreq, (24 * 1000 * 1000), &pRate);
        break;
    case LSCLK_PERI_SRC:
    case DCLK_VICAP_SRC:
    ...
    case CLK_CORE_RGA:
        ...
        break;
    case CLK_I2C0:
        mux = HAL_CRU_FreqGetMux2(rate, s_gpllFreq / 12, (24 * 1000 * 1000));
        clkMux = ((uint32_t)(((CLK_I2C_PMU) & 0xFFFFFFFF00000000) >> 32));
        break;
    case CLK_I2C1:
    case CLK_I2C2:
    case CLK_I2C3:
    case CLK_I2C4:
        mux = HAL_CRU_FreqGetMux2(rate, s_gpllFreq / 12, (24 * 1000 * 1000));
        clkMux = ((uint32_t)(((CLK_I2C_PERI) & 0xFFFFFFFF00000000) >> 32));
        break;
    case CLK_SPI0:
        mux = HAL_CRU_FreqGetMux4(rate, s_gpllFreq / 6, s_gpllFreq / 12, s_gpllFreq / 24, (24 * 1000 * 1000));
        break;
    case CLK_PWM0:
    case CLK_PWM1:
    case CLK_PWM2:
    ...
    case CLK_PKA_CRYPTO:
        ...
        break;
    case MCLK_SAI_OUT2IO:
        pRate = HAL_CRU_RoundFreqGetMux2(clkMux, HAL_CRU_ClkGetFreq(MCLK_SAI), (24 * 1000 * 1000) / 2, &pRate);
        break;
    case CLK_ISP_GPLL_SRC:
        pRate = s_gpllFreq;
        break;
...
HAL_Status HAL_CRU_WdtGlbRstEnable(eCRU_WdtRstType wdtType)
{
    uint32_t mask = (0x1FU << (11U)) | (0x1FU << (6U));
    uint32_t val = 1 << (11U);
    ...
    ((struct TOPCRU_REG *) 0x20060000U)->CRU_GLB_RST_CON = (((__builtin_constant_p(mask) ? ((mask) > 0xFFFFU ? 0 : ((mask) << 16)) : ((mask) << 16))) | (val));
