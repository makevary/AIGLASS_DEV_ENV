# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c"
...
# 7 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c" 2
# 45 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c"
struct MBOX_CHAN {
...
static struct MBOX_DEV g_MBoxDevs[8];
...
static struct MBOX_DEV *MBOX_FindEntry(const struct MBOX_REG *pReg)
{
    ...
    return 
# 71 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c" 3 4
          ((void *)0)
# 71 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c"
              ;
}
...
# 170 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c"
...
# 215 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c"
HAL_Status HAL_MBOX_Suspend(struct MBOX_REG *pReg)
{
    ;
...
# 261 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c"
HAL_Status HAL_MBOX_SendMsg2(struct MBOX_REG *pReg, eMBOX_CH chan,
                             const struct MBOX_CMD_DAT *msg, uint8_t isA2B)
{
    uint32_t status;
    ...
    status = MBOX_ChanIntStGet(pReg, chan, !isA2B);
    if (status) {
...
# 286 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c"
HAL_Status HAL_MBOX_SendMsg(struct MBOX_REG *pReg, eMBOX_CH chan,
                            const struct MBOX_CMD_DAT *msg)
{
    struct MBOX_DEV *pMBox;
...
# 337 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c"
HAL_Status HAL_MBOX_IrqHandler(int irq, struct MBOX_REG *pReg)
{
    struct MBOX_DEV *pMBox;
    uint32_t chan;
    ...
    if (irq < 0 || !(((pReg) == ((struct MBOX_REG *) 0x20580000U)) || ((pReg) == ((struct MBOX_REG *) 0x20581000U)) || ((pReg) == ((struct MBOX_REG *) 0x20582000U)) || ((pReg) == ((struct MBOX_REG *) 0x20583000U)) || ((pReg) == ((struct MBOX_REG *) 0x20A10000U)) || ((pReg) == ((struct MBOX_REG *) 0x20A11000U)) || ((pReg) == ((struct MBOX_REG *) 0x20A12000U)) || ((pReg) == ((struct MBOX_REG *) 0x20A13000U)))) {
        return HAL_INVAL;
    }
...
# 387 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c"
HAL_Status HAL_MBOX_Init(struct MBOX_REG *pReg, uint8_t isA2B)
{
    struct MBOX_DEV *pMBox = 
# 389 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c" 3 4
                            ((void *)0)
# 389 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c"
                                ;
    uint32_t chan;
    int i;
    ...
    for (chan = 0; chan < MBOX_CH_MAX; chan++) {
        pMBox->chans[chan].client = 
# 410 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c" 3 4
                                   ((void *)0)
# 410 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c"
                                       ;
    }
...
HAL_Status HAL_MBOX_DeInit(struct MBOX_REG *pReg)
{
    ...
    pMBox->pReg = 
# 432 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c" 3 4
                 ((void *)0)
# 432 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c"
                     ;

    for (chan = 0; chan < 1; chan++) {
        pMBox->chans[chan].client = 
# 435 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c" 3 4
                                   ((void *)0)
# 435 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c"
                                       ;
    }

    return HAL_OK;
}
# 458 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c"
HAL_Status HAL_MBOX_RegisterClient(struct MBOX_REG *pReg, eMBOX_CH chan,
                                   const struct MBOX_CLIENT *cl)
{
    struct MBOX_DEV *pMBox;
...
# 487 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c"
HAL_Status HAL_MBOX_UnregisterClient(struct MBOX_REG *pReg, eMBOX_CH chan,
                                     const struct MBOX_CLIENT *cl)
{
    struct MBOX_DEV *pMBox;
    ...
    pMBox->chans[chan].client = 
# 504 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c" 3 4
                               ((void *)0)
# 504 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/hal_mbox.c"
                                   ;
