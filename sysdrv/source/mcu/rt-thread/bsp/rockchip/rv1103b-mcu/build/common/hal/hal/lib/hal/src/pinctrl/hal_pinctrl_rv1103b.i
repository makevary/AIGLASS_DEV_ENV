# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/pinctrl/hal_pinctrl_rv1103b.c"
...
# 8 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/pinctrl/hal_pinctrl_rv1103b.c" 2
# 230 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/pinctrl/hal_pinctrl_rv1103b.c"
static HAL_Status PINCTRL_SetIOMUX(eGPIO_bankId bank, uint8_t pin, uint32_t val)
{
    switch (bank) {
    case 0:
        if (pin < 7) {
            do { if (pin % 8 / (4) == 0) { (((struct GPIO0_A_IOC_REG *) 0x201B0000U)->GPIO0A_IOMUX_SEL_0) = ((((1U << ((4))) - 1U) << (((pin % (4)) * ((4))) + 16)) | (((val) & ((1U << ((4))) - 1U)) << ((pin % (4)) * ((4))))); } else if (pin % 8 / (4) == 1) { (((struct GPIO0_A_IOC_REG *) 0x201B0000U)->GPIO0A_IOMUX_SEL_1) = ((((1U << ((4))) - 1U) << (((pin % (4)) * ((4))) + 16)) | (((val) & ((1U << ((4))) - 1U)) << ((pin % (4)) * ((4))))); } else do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown IOMUX_SEL_%d \n", pin % 8 / (4)); } while (0); } while (0);
        } else if (pin >= 8 && pin < 14) {
            do { if (pin % 8 / (4) == 0) { (((struct GPIO0_B_IOC_REG *) 0x201C0000U)->GPIO0B_IOMUX_SEL_0) = ((((1U << ((4))) - 1U) << (((pin % (4)) * ((4))) + 16)) | (((val) & ((1U << ((4))) - 1U)) << ((pin % (4)) * ((4))))); } else if (pin % 8 / (4) == 1) { (((struct GPIO0_B_IOC_REG *) 0x201C0000U)->GPIO0B_IOMUX_SEL_1) = ((((1U << ((4))) - 1U) << (((pin % (4)) * ((4))) + 16)) | (((val) & ((1U << ((4))) - 1U)) << ((pin % (4)) * ((4))))); } else do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown IOMUX_SEL_%d \n", pin % 8 / (4)); } while (0); } while (0);
        } else {
            do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown gpio %d pin %d\n", bank, pin); } while (0);
        }
        break;
    case 1:
        if (pin < 4) {
            do { { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1A_IOMUX_SEL_0) = ((((1U << ((4))) - 1U) << (((pin % (4)) * ((4))) + 16)) | (((val) & ((1U << ((4))) - 1U)) << ((pin % (4)) * ((4))))); } } while (0);
        } else if (pin < 6) {
            do { { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1A_IOMUX_SEL_1_0) = ((((1U << ((4))) - 1U) << (((pin % (4)) * ((4))) + 16)) | (((val) & ((1U << ((4))) - 1U)) << ((pin % (4)) * ((4))))); } } while (0);
        } else if (pin < 8) {
            do { { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1A_IOMUX_SEL_1_1) = ((((1U << ((4))) - 1U) << (((pin % (4)) * ((4))) + 16)) | (((val) & ((1U << ((4))) - 1U)) << ((pin % (4)) * ((4))))); } } while (0);
        } else if (pin < 16) {
            do { if (pin % 8 / (4) == 0) { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1B_IOMUX_SEL_0) = ((((1U << ((4))) - 1U) << (((pin % (4)) * ((4))) + 16)) | (((val) & ((1U << ((4))) - 1U)) << ((pin % (4)) * ((4))))); } else if (pin % 8 / (4) == 1) { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1B_IOMUX_SEL_1) = ((((1U << ((4))) - 1U) << (((pin % (4)) * ((4))) + 16)) | (((val) & ((1U << ((4))) - 1U)) << ((pin % (4)) * ((4))))); } else do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown IOMUX_SEL_%d \n", pin % 8 / (4)); } while (0); } while (0);
        } else if (pin == 16) {
            do { { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1C_IOMUX_SEL_0) = ((((1U << ((4))) - 1U) << (((pin % (4)) * ((4))) + 16)) | (((val) & ((1U << ((4))) - 1U)) << ((pin % (4)) * ((4))))); } } while (0);
        } else {
            do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown gpio %d pin %d\n", bank, pin); } while (0);
        }
        break;
    case 2:
        if (pin < 8) {
            do { if (pin % 8 / (4) == 0) { (((struct GPIO2_IOC_REG *) 0x201A0000U)->GPIO2A_IOMUX_SEL_0) = ((((1U << ((4))) - 1U) << (((pin % (4)) * ((4))) + 16)) | (((val) & ((1U << ((4))) - 1U)) << ((pin % (4)) * ((4))))); } else if (pin % 8 / (4) == 1) { (((struct GPIO2_IOC_REG *) 0x201A0000U)->GPIO2A_IOMUX_SEL_1) = ((((1U << ((4))) - 1U) << (((pin % (4)) * ((4))) + 16)) | (((val) & ((1U << ((4))) - 1U)) << ((pin % (4)) * ((4))))); } else do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown IOMUX_SEL_%d \n", pin % 8 / (4)); } while (0); } while (0);
        } else if (pin < 12) {
            do { { (((struct GPIO2_IOC_REG *) 0x201A0000U)->GPIO2B_IOMUX_SEL_0) = ((((1U << ((4))) - 1U) << (((pin % (4)) * ((4))) + 16)) | (((val) & ((1U << ((4))) - 1U)) << ((pin % (4)) * ((4))))); } } while (0);
        } else {
            do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown gpio %d pin %d\n", bank, pin); } while (0);
        }
        break;
    default:
        do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown gpio%d\n", bank); } while (0);
        break;
    }

    return HAL_OK;
}
# 281 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/pinctrl/hal_pinctrl_rv1103b.c"
static HAL_Status PINCTRL_SetPULL(eGPIO_bankId bank, uint8_t pin, uint32_t val)
{
    switch (bank) {
    case 0:
        if (pin < 7) {
            do { { (((struct GPIO0_A_IOC_REG *) 0x201B0000U)->GPIO0A_PULL) = ((((1U << ((2))) - 1U) << (((pin % (8)) * ((2))) + 16)) | (((val) & ((1U << ((2))) - 1U)) << ((pin % (8)) * ((2))))); } } while (0);
        } else if (pin >= 8 && pin < 14) {
            do { { (((struct GPIO0_B_IOC_REG *) 0x201C0000U)->GPIO0B_PULL) = ((((1U << ((2))) - 1U) << (((pin % (8)) * ((2))) + 16)) | (((val) & ((1U << ((2))) - 1U)) << ((pin % (8)) * ((2))))); } } while (0);
        } else {
            do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown gpio %d pin %d\n", bank, pin); } while (0);
        }
        break;
    case 1:
        if (pin < 6) {
            do { { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1A_PULL_0) = ((((1U << ((2))) - 1U) << (((pin % (8)) * ((2))) + 16)) | (((val) & ((1U << ((2))) - 1U)) << ((pin % (8)) * ((2))))); } } while (0);
        } else if (pin < 8) {
            do { { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1A_PULL_1) = ((((1U << ((2))) - 1U) << (((pin % (8)) * ((2))) + 16)) | (((val) & ((1U << ((2))) - 1U)) << ((pin % (8)) * ((2))))); } } while (0);
        } else if (pin < 16) {
            do { { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1B_PULL) = ((((1U << ((2))) - 1U) << (((pin % (8)) * ((2))) + 16)) | (((val) & ((1U << ((2))) - 1U)) << ((pin % (8)) * ((2))))); } } while (0);
        } else if (pin == 16) {
            do { { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1C_PULL) = ((((1U << ((2))) - 1U) << (((pin % (8)) * ((2))) + 16)) | (((val) & ((1U << ((2))) - 1U)) << ((pin % (8)) * ((2))))); } } while (0);
        } else {
            do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown gpio %d pin %d\n", bank, pin); } while (0);
        }
        break;
    case 2:
        if (pin < 8) {
            do { { (((struct GPIO2_IOC_REG *) 0x201A0000U)->GPIO2A_PULL) = ((((1U << ((2))) - 1U) << (((pin % (8)) * ((2))) + 16)) | (((val) & ((1U << ((2))) - 1U)) << ((pin % (8)) * ((2))))); } } while (0);
        } else if (pin < 12) {
            do { { (((struct GPIO2_IOC_REG *) 0x201A0000U)->GPIO2B_PULL) = ((((1U << ((2))) - 1U) << (((pin % (8)) * ((2))) + 16)) | (((val) & ((1U << ((2))) - 1U)) << ((pin % (8)) * ((2))))); } } while (0);
        } else {
            do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown gpio %d pin %d\n", bank, pin); } while (0);
        }
        break;
...
# 330 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/pinctrl/hal_pinctrl_rv1103b.c"
static HAL_Status PINCTRL_SetDRV(eGPIO_bankId bank, uint8_t pin, uint32_t val)
{
    switch (bank) {
    case 0:
        if (pin < 7) {
            do { if (pin % 8 / (2) == 0) { (((struct GPIO0_A_IOC_REG *) 0x201B0000U)->GPIO0A_DS_0) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else if (pin % 8 / (2) == 1) { (((struct GPIO0_A_IOC_REG *) 0x201B0000U)->GPIO0A_DS_1) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else if (pin % 8 / (2) == 2) { (((struct GPIO0_A_IOC_REG *) 0x201B0000U)->GPIO0A_DS_2) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else if (pin % 8 / (2) == 3) { (((struct GPIO0_A_IOC_REG *) 0x201B0000U)->GPIO0A_DS_3) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown DS_%d \n", pin % 8 / (2)); } while (0); } while (0);
        } else if (pin >= 8 && pin < 14) {
            do { if (pin % 8 / (2) == 0) { (((struct GPIO0_B_IOC_REG *) 0x201C0000U)->GPIO0B_DS_0) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else if (pin % 8 / (2) == 1) { (((struct GPIO0_B_IOC_REG *) 0x201C0000U)->GPIO0B_DS_1) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else if (pin % 8 / (2) == 2) { (((struct GPIO0_B_IOC_REG *) 0x201C0000U)->GPIO0B_DS_2) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown DS_%d \n", pin % 8 / (2)); } while (0); } while (0);
        } else {
            do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown gpio %d pin %d\n", bank, pin); } while (0);
        }
        break;
    case 1:
        if (pin < 8) {
            do { if (pin % 8 / (2) == 0) { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1A_DS_0) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else if (pin % 8 / (2) == 1) { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1A_DS_1) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else if (pin % 8 / (2) == 2) { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1A_DS_2) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else if (pin % 8 / (2) == 3) { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1A_DS_3) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown DS_%d \n", pin % 8 / (2)); } while (0); } while (0);
        } else if (pin < 16) {
            do { if (pin % 8 / (2) == 0) { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1B_DS_0) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else if (pin % 8 / (2) == 1) { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1B_DS_1) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else if (pin % 8 / (2) == 2) { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1B_DS_2) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else if (pin % 8 / (2) == 3) { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1B_DS_3) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown DS_%d \n", pin % 8 / (2)); } while (0); } while (0);
        } else if (pin == 16) {
            do { if (pin % 8 / (2) == 0) { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1C_DS_0) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown DS_%d \n", pin % 8 / (2)); } while (0); } while (0);
        } else {
            do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown gpio %d pin %d\n", bank, pin); } while (0);
        }
        break;
    case 2:
        if (pin < 8) {
            do { if (pin % 8 / (2) == 0) { (((struct GPIO2_IOC_REG *) 0x201A0000U)->GPIO2A_DS_0) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else if (pin % 8 / (2) == 1) { (((struct GPIO2_IOC_REG *) 0x201A0000U)->GPIO2A_DS_1) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else if (pin % 8 / (2) == 2) { (((struct GPIO2_IOC_REG *) 0x201A0000U)->GPIO2A_DS_2) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else if (pin % 8 / (2) == 3) { (((struct GPIO2_IOC_REG *) 0x201A0000U)->GPIO2A_DS_3) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown DS_%d \n", pin % 8 / (2)); } while (0); } while (0);
        } else if (pin < 12) {
            do { if (pin % 8 / (2) == 0) { (((struct GPIO2_IOC_REG *) 0x201A0000U)->GPIO2B_DS_0) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else if (pin % 8 / (2) == 1) { (((struct GPIO2_IOC_REG *) 0x201A0000U)->GPIO2B_DS_1) = ((((1U << ((8))) - 1U) << (((pin % (2)) * ((8))) + 16)) | (((val) & ((1U << ((8))) - 1U)) << ((pin % (2)) * ((8))))); } else do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown DS_%d \n", pin % 8 / (2)); } while (0); } while (0);
        } else {
            do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown gpio %d pin %d\n", bank, pin); } while (0);
        }
        break;
...
# 377 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/pinctrl/hal_pinctrl_rv1103b.c"
static HAL_Status PINCTRL_SetSMT(eGPIO_bankId bank, uint8_t pin, uint32_t val)
{
    switch (bank) {
    case 0:
        if (pin < 7) {
            do { { (((struct GPIO0_A_IOC_REG *) 0x201B0000U)->GPIO0A_SMT) = ((((1U << ((1))) - 1U) << (((pin % (8)) * ((1))) + 16)) | (((val) & ((1U << ((1))) - 1U)) << ((pin % (8)) * ((1))))); } } while (0);
        } else if (pin >= 8 && pin < 14) {
            do { { (((struct GPIO0_B_IOC_REG *) 0x201C0000U)->GPIO0B_SMT) = ((((1U << ((1))) - 1U) << (((pin % (8)) * ((1))) + 16)) | (((val) & ((1U << ((1))) - 1U)) << ((pin % (8)) * ((1))))); } } while (0);
        } else {
            do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown gpio %d pin %d\n", bank, pin); } while (0);
        }
        break;
    case 1:
        if (pin < 6) {
            do { if (0 == 0) { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1A_SMT_0) = ((((1U << ((1))) - 1U) << (((pin % (8)) * ((1))) + 16)) | (((val) & ((1U << ((1))) - 1U)) << ((pin % (8)) * ((1))))); } else if (0 == 1) { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1A_SMT_1) = ((((1U << ((1))) - 1U) << (((pin % (8)) * ((1))) + 16)) | (((val) & ((1U << ((1))) - 1U)) << ((pin % (8)) * ((1))))); } else do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown SMT_%d \n", 0); } while (0); } while (0);
        } else if (pin < 8) {
            do { if (1 == 0) { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1A_SMT_0) = ((((1U << ((1))) - 1U) << (((pin % (8)) * ((1))) + 16)) | (((val) & ((1U << ((1))) - 1U)) << ((pin % (8)) * ((1))))); } else if (1 == 1) { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1A_SMT_1) = ((((1U << ((1))) - 1U) << (((pin % (8)) * ((1))) + 16)) | (((val) & ((1U << ((1))) - 1U)) << ((pin % (8)) * ((1))))); } else do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown SMT_%d \n", 1); } while (0); } while (0);
        } else if (pin < 16) {
            do { { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1B_SMT) = ((((1U << ((1))) - 1U) << (((pin % (8)) * ((1))) + 16)) | (((val) & ((1U << ((1))) - 1U)) << ((pin % (8)) * ((1))))); } } while (0);
        } else if (pin == 16) {
            do { { (((struct GPIO1_IOC_REG *) 0x20170000U)->GPIO1C_SMT) = ((((1U << ((1))) - 1U) << (((pin % (8)) * ((1))) + 16)) | (((val) & ((1U << ((1))) - 1U)) << ((pin % (8)) * ((1))))); } } while (0);
        } else {
            do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown gpio %d pin %d\n", bank, pin); } while (0);
        }
        break;
    case 2:
        if (pin < 8) {
            do { { (((struct GPIO2_IOC_REG *) 0x201A0000U)->GPIO2A_SMT) = ((((1U << ((1))) - 1U) << (((pin % (8)) * ((1))) + 16)) | (((val) & ((1U << ((1))) - 1U)) << ((pin % (8)) * ((1))))); } } while (0);
        } else if (pin < 12) {
            do { { (((struct GPIO2_IOC_REG *) 0x201A0000U)->GPIO2B_SMT) = ((((1U << ((1))) - 1U) << (((pin % (8)) * ((1))) + 16)) | (((val) & ((1U << ((1))) - 1U)) << ((pin % (8)) * ((1))))); } } while (0);
        } else {
            do { if (0) HAL_DBG_Printf("[HAL INFO] " "unknown gpio %d pin %d\n", bank, pin); } while (0);
        }
        break;
...
# 426 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/pinctrl/hal_pinctrl_rv1103b.c"
static HAL_Status PINCTRL_SetPinParam(eGPIO_bankId bank, uint8_t pin, uint32_t param)
{
    HAL_Status rc = HAL_OK;

    if (param & (1UL << (31))) {
        rc |= PINCTRL_SetIOMUX(bank, pin, (uint8_t)((param & (0xFU << (0))) >> (0)));
    }

    if (param & (1UL << (30))) {
        rc |= PINCTRL_SetPULL(bank, pin, (uint8_t)((param & (0xFU << (4))) >> (4)));
    }

    if (param & (1UL << (29))) {
        rc |= PINCTRL_SetDRV(bank, pin, (uint8_t)((param & (0xFFU << (8))) >> (8)));
    }

    if (param & (1UL << (27))) {
        rc |= PINCTRL_SetSMT(bank, pin, (uint8_t)((param & (0x3U << (18))) >> (18)));
    }

    return rc;
}
# 467 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/pinctrl/hal_pinctrl_rv1103b.c"
HAL_Status HAL_PINCTRL_Init(void)
{
    return HAL_OK;
}
...
# 490 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/pinctrl/hal_pinctrl_rv1103b.c"
HAL_Status HAL_PINCTRL_SetParam(eGPIO_bankId bank, uint32_t mPins, ePINCTRL_configParam param)
{
    uint8_t pin;
    ...
    if (!(param & ((1UL << (31)) | (1UL << (30)) | (1UL << (29)) | (1UL << (27))))) {
        do { if (0) HAL_DBG_Printf("[HAL INFO] " "pinctrl: no parameter!\n"); } while (0);
...
# 523 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/hal/lib/hal/src/pinctrl/hal_pinctrl_rv1103b.c"
HAL_Status HAL_PINCTRL_SetIOMUX(eGPIO_bankId bank, uint32_t mPins, ePINCTRL_configParam param)
{
