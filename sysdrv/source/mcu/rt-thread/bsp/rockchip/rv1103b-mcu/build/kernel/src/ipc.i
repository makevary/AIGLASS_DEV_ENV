# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
# 37 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
...
# 38 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c" 2
...
# 39 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c" 2


extern void (*rt_object_trytake_hook)(struct rt_object *object);
extern void (*rt_object_take_hook)(struct rt_object *object);
extern void (*rt_object_put_hook)(struct rt_object *object);
# 59 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
...
# 78 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
...
# 132 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
...
# 155 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
...
# 197 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_sem_init(rt_sem_t sem,
                     const char *name,
                     rt_uint32_t value,
                     rt_uint8_t flag)
...
;
# 229 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_sem_detach(rt_sem_t sem)
{
...
;
# 258 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_sem_t rt_sem_create(const char *name, rt_uint32_t value, rt_uint8_t flag)
{
    rt_sem_t sem;
...
;
# 291 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_sem_delete(rt_sem_t sem)
{
    ;
...
;
# 320 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_sem_take(rt_sem_t sem, rt_int32_t time)
{
    ...
    do { if ((rt_object_trytake_hook) != (0)) rt_object_trytake_hook (&(sem->parent.parent)); } while (0);
    ...
    do { if ((rt_object_take_hook) != (0)) rt_object_take_hook (&(sem->parent.parent)); } while (0);

    return 0;
}
;
# 415 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_sem_trytake(rt_sem_t sem)
{
    return rt_sem_take(sem, 0);
}
;
# 429 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_sem_release(rt_sem_t sem)
{
    register rt_base_t temp;
    ...
    do { if ((rt_object_put_hook) != (0)) rt_object_put_hook (&(sem->parent.parent)); } while (0);
...
;
# 479 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_sem_control(rt_sem_t sem, int cmd, void *arg)
{
    rt_ubase_t level;
...
;
# 526 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mutex_init(rt_mutex_t mutex, const char *name, rt_uint8_t flag)
{
...
;
# 558 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mutex_detach(rt_mutex_t mutex)
{
...
;
# 586 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_mutex_t rt_mutex_create(const char *name, rt_uint8_t flag)
{
...
;
# 621 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mutex_delete(rt_mutex_t mutex)
{
    ;
...
;
# 650 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mutex_take(rt_mutex_t mutex, rt_int32_t time)
{
    register rt_base_t temp;
    struct rt_thread *thread;
    ...
    do { if ((rt_object_trytake_hook) != (0)) rt_object_trytake_hook (&(mutex->parent.parent)); } while (0);
...
__again:
        ...
        else
        {
            ...
            else
            {
                ...
                if (thread->error != 0)
                {
                 ...
                 if (thread->error == -9) goto __again;
    ...
    do { if ((rt_object_take_hook) != (0)) rt_object_take_hook (&(mutex->parent.parent)); } while (0);

    return 0;
}
;
# 786 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mutex_release(rt_mutex_t mutex)
{
    register rt_base_t temp;
    struct rt_thread *thread;
    ...
    do { if ((rt_object_put_hook) != (0)) rt_object_put_hook (&(mutex->parent.parent)); } while (0);
...
;
# 889 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mutex_control(rt_mutex_t mutex, int cmd, void *arg)
{
...
;
# 911 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_event_init(rt_event_t event, const char *name, rt_uint8_t flag)
{
...
;
# 939 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_event_detach(rt_event_t event)
{
...
;
# 965 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_event_t rt_event_create(const char *name, rt_uint8_t flag)
{
    rt_event_t event;
...
;
# 996 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_event_delete(rt_event_t event)
{
...
;
# 1025 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_event_send(rt_event_t event, rt_uint32_t set)
{
    struct rt_list_node *n;
    struct rt_thread *thread;
    ...
    do { if ((rt_object_put_hook) != (0)) rt_object_put_hook (&(event->parent.parent)); } while (0);
...
;
# 1123 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_event_recv(rt_event_t event,
                       rt_uint32_t set,
                       rt_uint8_t option,
                       rt_int32_t timeout,
                       rt_uint32_t *recved)
{
    ...
    do { if ((rt_object_trytake_hook) != (0)) rt_object_trytake_hook (&(event->parent.parent)); } while (0);
    ...
    do { if ((rt_object_take_hook) != (0)) rt_object_take_hook (&(event->parent.parent)); } while (0);

    return thread->error;
}
;
# 1245 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_event_control(rt_event_t event, int cmd, void *arg)
{
    rt_ubase_t level;
...
;
# 1290 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mb_init(rt_mailbox_t mb,
                    const char *name,
                    void *msgpool,
                    rt_size_t size,
...
;
# 1328 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mb_detach(rt_mailbox_t mb)
{
...
;
# 1357 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_mailbox_t rt_mb_create(const char *name, rt_size_t size, rt_uint8_t flag)
{
    rt_mailbox_t mb;
...
;
# 1402 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mb_delete(rt_mailbox_t mb)
{
    ;
...
;
# 1438 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mb_send_wait(rt_mailbox_t mb,
                         rt_uint32_t value,
                         rt_int32_t timeout)
{
    ...
    do { if ((rt_object_put_hook) != (0)) rt_object_put_hook (&(mb->parent.parent)); } while (0);
...
;
# 1570 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mb_send(rt_mailbox_t mb, rt_uint32_t value)
{
    return rt_mb_send_wait(mb, value, 0);
}
;
# 1586 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mb_recv(rt_mailbox_t mb, rt_uint32_t *value, rt_int32_t timeout)
{
    struct rt_thread *thread;
    register rt_ubase_t temp;
    ...
    do { if ((rt_object_trytake_hook) != (0)) rt_object_trytake_hook (&(mb->parent.parent)); } while (0);
    ...
    *value = mb->msg_pool[mb->out_offset];
    ...
    if (!rt_list_isempty(&(mb->suspend_sender_thread)))
    {
        ...
        do { if ((rt_object_take_hook) != (0)) rt_object_take_hook (&(mb->parent.parent)); } while (0);
...
;
# 1722 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mb_control(rt_mailbox_t mb, int cmd, void *arg)
{
    rt_ubase_t level;
...
# 1777 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mq_init(rt_mq_t mq,
                    const char *name,
                    void *msgpool,
                    rt_size_t msg_size,
...
;
# 1834 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mq_detach(rt_mq_t mq)
{
...
;
# 1862 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_mq_t rt_mq_create(const char *name,
                     rt_size_t msg_size,
                     rt_size_t max_msgs,
                     rt_uint8_t flag)
...
;
# 1927 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mq_delete(rt_mq_t mq)
{
    ;
...
;
# 1960 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mq_send(rt_mq_t mq, void *buffer, rt_size_t size)
{
    register rt_ubase_t temp;
    ...
    do { if ((rt_object_put_hook) != (0)) rt_object_put_hook (&(mq->parent.parent)); } while (0);
...
;
# 2050 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mq_urgent(rt_mq_t mq, void *buffer, rt_size_t size)
{
    register rt_ubase_t temp;
    struct rt_mq_message *msg;
...
;
# 2135 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mq_recv(rt_mq_t mq,
                    void *buffer,
                    rt_size_t size,
                    rt_int32_t timeout)
{
    ...
    thread = rt_thread_self();
    do { if ((rt_object_trytake_hook) != (0)) rt_object_trytake_hook (&(mq->parent.parent)); } while (0);
    ...
    do { if ((rt_object_take_hook) != (0)) rt_object_take_hook (&(mq->parent.parent)); } while (0);

    return 0;
}
;
# 2276 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/ipc.c"
rt_err_t rt_mq_control(rt_mq_t mq, int cmd, void *arg)
{
    rt_ubase_t level;
    struct rt_mq_message *msg;
