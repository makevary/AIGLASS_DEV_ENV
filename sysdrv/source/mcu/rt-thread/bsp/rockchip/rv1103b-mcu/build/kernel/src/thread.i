# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
# 29 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
...
# 30 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c" 2
...
# 31 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c" 2
...
# 50 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
void rt_thread_suspend_sethook(void (*hook)(rt_thread_t thread))
{
    rt_thread_suspend_hook = hook;
}
# 63 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
void rt_thread_resume_sethook(void (*hook)(rt_thread_t thread))
{
                                ...
                                rt_uint32_t tick)
{
    ...
    rt_timer_init(&(thread->thread_timer),
                  ...
                  0,
                  0x0);
# 194 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
    do { if ((rt_thread_inited_hook) != (0)) rt_thread_inited_hook (thread); } while (0);

    return 0;
}
# 220 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
rt_err_t rt_thread_init(struct rt_thread *thread,
                        const char *name,
                        void (*entry)(void *parameter),
                        void *parameter,
...
;
# 265 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
rt_err_t rt_thread_startup(rt_thread_t thread)
{
...
;
# 308 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
rt_err_t rt_thread_detach(rt_thread_t thread)
{
    rt_base_t lock;
    ...
    if ((thread->stat & 0x0f) == 0x04)
        return 0;

    if ((thread->stat & 0x0f) != 0x00)
    {
...
;
# 365 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
rt_thread_t rt_thread_create(const char *name,
                             void (*entry)(void *parameter),
                             void *parameter,
                             rt_uint32_t stack_size,
...
;
# 410 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
rt_err_t rt_thread_delete(rt_thread_t thread)
{
    rt_base_t lock;
...
;
# 458 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
rt_err_t rt_thread_yield(void)
{
    register rt_base_t level;
    struct rt_thread *thread;
...
;
# 502 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
...
# 540 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
rt_err_t rt_thread_delay(rt_tick_t tick)
{
    return rt_thread_sleep(tick);
}
;
# 553 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
rt_err_t rt_thread_mdelay(rt_int32_t ms)
{
    rt_tick_t tick;
...
;
# 575 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
rt_err_t rt_thread_control(rt_thread_t thread, int cmd, void *arg)
{
    register rt_base_t temp;
...
;
# 654 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
rt_err_t rt_thread_suspend(rt_thread_t thread)
{
    register rt_base_t temp;
    ...
    thread->stat = 0x02 | (thread->stat & ~0x0f);
    rt_schedule_remove_thread(thread);
    ...
    do { if ((rt_thread_suspend_hook) != (0)) rt_thread_suspend_hook (thread); } while (0);
    return 0;
}
;
# 697 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
rt_err_t rt_thread_resume(rt_thread_t thread)
{
    register rt_base_t temp;
    ...
    do { if ((rt_thread_resume_hook) != (0)) rt_thread_resume_hook (thread); } while (0);
    return 0;
}
;
...
;
# 774 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/src/thread.c"
rt_thread_t rt_thread_find(char *name)
{
