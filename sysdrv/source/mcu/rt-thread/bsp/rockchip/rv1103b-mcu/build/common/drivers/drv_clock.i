# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_clock.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_clock.c"
# 45 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_clock.c"
...
# 46 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_clock.c" 2
...
# 51 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_clock.c" 2
...
# 52 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_clock.c" 2

static const struct clk_init *g_clk_init = (0);

static rt_slist_t clk_gate_list;

static struct rt_mutex clk_lock;
static struct rt_mutex gate_lock;
# 76 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_clock.c"
rt_err_t clk_enable(struct clk_gate *gate)
{
    rt_err_t error = 0;
    HAL_Status ret;
...
struct clk_gate *get_clk_gate_from_id(int gate_id)
{
    ...
    for (pos = (&clk_gate_list)->next; pos != (0); pos = pos->next)
    {
        clk_gate = ((struct clk_gate *)((char *)(pos) - (unsigned long)(&((struct clk_gate *)0)->node)));
...
# 237 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_clock.c"
rt_err_t clk_set_rate(eCLOCK_Name clk_id, uint32_t rate)
{
    rt_err_t error = 0;
...
# 381 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_clock.c"
int clock_dev_init(void)
{
    if (rt_mutex_init(&(clk_lock), "clkLock", 0x00) != 0)
    {
        ;
    }
    if (rt_mutex_init(&(gate_lock), "gateLock", 0x00) != 0)
    {
        ;
    }
    rt_slist_init(&clk_gate_list);
# 400 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_clock.c"
    return 0;
}
...
void clk_init(const struct clk_init *clk_inits, 
# 409 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_clock.c" 3 4
                                               _Bool 
# 409 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_clock.c"
                                                    clk_dump)
{
