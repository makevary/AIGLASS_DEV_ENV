# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_gpio.c"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/rv1103b-mcu//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_gpio.c"
# 45 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_gpio.c"
...
# 46 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_gpio.c" 2
...
# 47 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_gpio.c" 2
...
# 52 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_gpio.c" 2
# 1 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_gpio.h" 1
# 53 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_gpio.c" 2
# 94 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_gpio.c"
static struct GPIO_REG *GPIO_GROUP[] =
{

    ((struct GPIO_REG *) 0x20520000U),


    ((struct GPIO_REG *) 0x20D80000U),


    ((struct GPIO_REG *) 0x20840000U),
...
static struct rt_pin_irq_hdr pin_irq_hdr_tab[(sizeof((GPIO_GROUP)) / sizeof((GPIO_GROUP)[0])) * (32)];
                               ...
                               rt_uint32_t mode, void (*hdr)(void *args), void *args)
{
    ...
    if (pin < 0 || pin >= (sizeof((pin_irq_hdr_tab)) / sizeof((pin_irq_hdr_tab)[0])))
    {
        return 6;
    }
    ...
    if (pin_irq_hdr_tab[pin].pin != (-1) && pin_irq_hdr_tab[pin].hdr != (0))
    {
        rt_hw_interrupt_enable(level);
        return 7;
    }
...
static rt_err_t pin_detach_irq(struct rt_device *device, rt_int32_t pin)
{
    ...
    pin_irq_hdr_tab[pin].hdr = (0);
    pin_irq_hdr_tab[pin].mode = 0;
    pin_irq_hdr_tab[pin].args = (0);
...
static rt_err_t pin_irq_enable(struct rt_device *dev, rt_base_t pin, rt_uint32_t enabled)
{
    ...
    if (enabled == 0x01)
    {
        ...
        HAL_GPIO_SetIntType((GPIO_GROUP[((pin & (0x7 << (5))) >> (5))]), ((1UL << (((pin & (0x1f << (0))) >> (0))))), mode);
        HAL_GPIO_EnableIRQ((GPIO_GROUP[((pin & (0x7 << (5))) >> (5))]), ((1UL << (((pin & (0x1f << (0))) >> (0))))));
        rt_hw_interrupt_enable(level);
    }
    else if (enabled == 0x00)
    {
        HAL_GPIO_DisableIRQ((GPIO_GROUP[((pin & (0x7 << (5))) >> (5))]), ((1UL << (((pin & (0x1f << (0))) >> (0))))));
    }
    else
    {
        return 6;
...
static void pin_mode(struct rt_device *dev, rt_base_t pin, rt_base_t mode)
{
    ...
    case 0x04:
        ...
        HAL_PINCTRL_SetIOMUX(((pin & (0x7 << (5))) >> (5)), (1UL << (pin & 0x1f)), PIN_CONFIG_MUX_FUNC0);

        HAL_GPIO_SetPinDirection((GPIO_GROUP[((pin & (0x7 << (5))) >> (5))]), ((1UL << (((pin & (0x1f << (0))) >> (0))))), GPIO_OUT);
        break;
    ...
    case 0x01:
        ...
        HAL_GPIO_SetPinDirection((GPIO_GROUP[((pin & (0x7 << (5))) >> (5))]), ((1UL << (((pin & (0x1f << (0))) >> (0))))), GPIO_IN);
        break;

    case 0x02:

        HAL_PINCTRL_SetIOMUX(((pin & (0x7 << (5))) >> (5)), (1UL << (pin & 0x1f)), PIN_CONFIG_MUX_FUNC0);
        HAL_PINCTRL_SetParam(((pin & (0x7 << (5))) >> (5)), (1UL << (pin & 0x1f)), PIN_CONFIG_PUL_UP);
    ...
    case 0x03:
        ...
        HAL_PINCTRL_SetIOMUX(((pin & (0x7 << (5))) >> (5)), (1UL << (pin & 0x1f)), PIN_CONFIG_MUX_FUNC0);
        HAL_PINCTRL_SetParam(((pin & (0x7 << (5))) >> (5)), (1UL << (pin & 0x1f)), PIN_CONFIG_PUL_DOWN);
...
{
    ;
    HAL_GPIO_SetPinLevel((GPIO_GROUP[((pin & (0x7 << (5))) >> (5))]), ((1UL << (((pin & (0x1f << (0))) >> (0))))), value);
}

static int pin_read(struct rt_device *dev, rt_base_t pin)
{
    ;
    return HAL_GPIO_GetPinLevel((GPIO_GROUP[((pin & (0x7 << (5))) >> (5))]), ((1UL << (((pin & (0x1f << (0))) >> (0))))));;
}
...
{
    rt_interrupt_enter();
    HAL_GPIO_IRQHandler(((struct GPIO_REG *) 0x20520000U), GPIO_BANK0);
    rt_interrupt_leave();
}
...
{
    rt_interrupt_enter();
    HAL_GPIO_IRQHandler(((struct GPIO_REG *) 0x20D80000U), GPIO_BANK1);
    rt_interrupt_leave();
}
...
{
    rt_interrupt_enter();
    HAL_GPIO_IRQHandler(((struct GPIO_REG *) 0x20840000U), GPIO_BANK2);
    rt_interrupt_leave();
}
# 341 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_gpio.c"
...
int rt_hw_gpio_init(void)
{
    ...
    rt_hw_interrupt_install(GPIO0_IRQn, (void *)pin_gpio0_handler, (0), (0));
    rt_hw_interrupt_umask(GPIO0_IRQn);


    rt_hw_interrupt_install(GPIO1_IRQn, (void *)pin_gpio1_handler, (0), (0));
    rt_hw_interrupt_umask(GPIO1_IRQn);


    rt_hw_interrupt_install(GPIO2_IRQn, (void *)pin_gpio2_handler, (0), (0));
    rt_hw_interrupt_umask(GPIO2_IRQn);
# 377 "/opt/aiglass_dev_env/sysdrv/source/mcu/rt-thread/bsp/rockchip/common/drivers/drv_gpio.c"
    rt_device_pin_register("pin", &pin_ops, (0));

    return 0;
}
__attribute__((used)) const init_fn_t __rt_init_rt_hw_gpio_init __attribute__((section(".rti_fn.""1"))) = rt_hw_gpio_init;
...
void HAL_GPIO_IRQDispatch(eGPIO_bankId bank, uint32_t pin)
{
    ...
    pin_irq_hdr(((((bank) << (5)) & (0x7 << (5))) + (((pin) << (0)) & (0x1f << (0)))));
}
