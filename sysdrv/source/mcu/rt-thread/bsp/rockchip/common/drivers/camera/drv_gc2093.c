...
static const uint8_t gc2093_1080p_hdr_settings[] =
{
    ...
    0x3, 0x01, 0x23, 0x08,
    0x3, 0x01, 0x23, 0x00,
    0x5, 0x01, 0x20, 0x01, 0x00, 0x10,
    0x5, 0x01, 0x24, 0x03, 0xff, 0x3c,
    0x3, 0x00, 0x1a, 0x8c,
    0x3, 0x00, 0xc6, 0xe0,
    0x3, 0x00, 0x26, 0x30,
    0x3, 0x01, 0x42, 0x00,
...
static ret_err_t rk_gc2093_set_expval(struct gc2093_dev *dev, struct rk_camera_exp_val *exp)
{
    ...
    gc2093_read_reg(dev->i2c_bus, GC2093_REG_EXP_LONG_H, &exp_time[0]);
    gc2093_read_reg(dev->i2c_bus, GC2093_REG_EXP_LONG_L, &exp_time[1]);
    gc2093_dbg("GC2093_REG_EXP_LONG_H: 0x%x, GC2093_REG_EXP_LONG_L: 0x%x\n",
...
static ret_err_t rk_gc2093_set_intput_fmt(struct gc2093_dev *dev, struct rk_camera_mbus_framefmt *mbus_fmt)
{
    ...
    gc2093_info("dst resulotion, width %d, height %d\n",
