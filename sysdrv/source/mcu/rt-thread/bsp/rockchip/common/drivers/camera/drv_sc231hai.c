/**
  ...
  * 2024-07-19    Longchang.Ma          modify reset/pwnd gpio active
  * 2024-07-19    Longchang.Ma          fix gain setting error
  *
  ******************************************************************************
  */
...
#define SC231HAI_GAIN_MAX                (1850 * 32)       // 116.55*15.875*32
...
static int sc231hai_set_gain_reg(struct sc231hai_dev *dev, uint32_t gain, int mode)
{
    ...
    else if (gain < 3788)        /* 2.0x ~ 3.7x  1024 * 3.7 = 3788 */
    {
        Dcg_gainx100 = 100;
        Coarse_gain = 2;
        DIG_gain = 1;
    ...
    else if (gain < 7577)        /* 3.7x ~ 7.4x  1024 * 7.284 = 7577 */
    {
        Dcg_gainx100 = 370;
        Coarse_gain = 1;
        DIG_gain = 1;
    ...
    else if (gain < 15115)       /* 7.4x ~ 14.8x  1024 * 14.596 = 15115 */
    {
        Dcg_gainx100 = 370;
        Coarse_gain = 2;
        DIG_gain = 1;
    ...
    else if (gain < 30310)       /* 14.8x ~ 29.6x  1024 * 29.138 = 30310 */
    {
        Dcg_gainx100 = 370;
        Coarse_gain = 4;
        DIG_gain = 1;
    ...
    else if (gain < 60620)       /* 29.6x ~ 59.2x  1024 * 58.275 = 60620 */
    {
        Dcg_gainx100 = 370;
        Coarse_gain = 8;
        DIG_gain = 1;
