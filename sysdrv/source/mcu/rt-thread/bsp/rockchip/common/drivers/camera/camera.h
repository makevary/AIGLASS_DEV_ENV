...
#define RK_DEVICE_CTRL_CAMERA_QUICK_STREAM          (27)
#define RK_DEVICE_CTRL_CAMERA_GET_EXP_INIT          (28)
...
enum sc850sl_support_mode_id
{
    SC850SL_1920X1080_120FPS = 0,
    SC850SL_1920X1080_60FPS,
    SC850SL_3840X2160,
    SC850SL_MODE_ID_MAX = SC850SL_3840X2160,
};
extern const struct camera_board_desc camera_sc850sl;
#endif
...
enum os04e10_support_mode_id
{
    OS04E10_1024X1024 = 0,
    OS04E10_2048X2048,
    OS04E10_MODE_ID_MAX = OS04E10_2048X2048,
};
extern const struct camera_board_desc camera_os04e10[];
#endif

#ifdef RT_USING_PS5458
enum ps5458_support_mode_id
{
    PS5458_1344X760,
    PS5458_2688X1520,
    PS5458_MODE_ID_MAX = PS5458_2688X1520,
};
extern const struct camera_board_desc camera_ps5458[];
#endif
