...
int rk_camera_sc4336_init(void)
{
    ...
    if (sc4336->rst_gpio.gpio_group)
    {
        HAL_GPIO_SetPinDirection((struct GPIO_REG *)sc4336->rst_gpio.gpio_group,
                                 sc4336->rst_gpio.gpio_pin,
                                 GPIO_OUT);
        HAL_GPIO_SetPinLevel((struct GPIO_REG *)sc4336->rst_gpio.gpio_group,
                             sc4336->rst_gpio.gpio_pin,
                             sc4336->rst_active);
    }

    if (sc4336->pwdn_gpio.gpio_group)
    {
        HAL_GPIO_SetPinDirection((struct GPIO_REG *)sc4336->pwdn_gpio.gpio_group,
                                 sc4336->pwdn_gpio.gpio_pin,
                                 GPIO_OUT);
        HAL_GPIO_SetPinLevel((struct GPIO_REG *)sc4336->pwdn_gpio.gpio_group,
                             sc4336->pwdn_gpio.gpio_pin,
                             sc4336->pwdn_active);
    }
