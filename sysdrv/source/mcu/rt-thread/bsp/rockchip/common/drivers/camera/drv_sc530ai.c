...
int rk_camera_sc530ai_init(void)
{
    ...
    if (sc530ai->rst_gpio.gpio_group)
    {
        HAL_GPIO_SetPinDirection((struct GPIO_REG *)sc530ai->rst_gpio.gpio_group,
                                 sc530ai->rst_gpio.gpio_pin,
                                 GPIO_OUT);
        HAL_GPIO_SetPinLevel((struct GPIO_REG *)sc530ai->rst_gpio.gpio_group,
                             sc530ai->rst_gpio.gpio_pin,
                             sc530ai->rst_active);
    }

    if (sc530ai->pwdn_gpio.gpio_group)
    {
        HAL_GPIO_SetPinDirection((struct GPIO_REG *)sc530ai->pwdn_gpio.gpio_group,
                                 sc530ai->pwdn_gpio.gpio_pin,
                                 GPIO_OUT);
        HAL_GPIO_SetPinLevel((struct GPIO_REG *)sc530ai->pwdn_gpio.gpio_group,
                             sc530ai->pwdn_gpio.gpio_pin,
                             sc530ai->pwdn_active);
    }
