...
#define RK_FASTAE_TOLERANCE_COEF "rk_fastae_tolerance_coef"
#define RK_RTT_STREAM_ON_THRESHOLD "rk_rtt_stream_on_threshold"
#define RK_RTT_STREAM_BUF_CNT "rk_rtt_stream_buf_cnt"
#define RK_CAM_SENSOR_NUM "rk_cam_num"

#define RK_CAM2_MIRROR_FLIP    "rk_cam2_mirror_flip"

#define RK_CAM1_MAX_FPS            "rk_cam1_max_fps"
#define RK_CAM2_MAX_FPS            "rk_cam2_max_fps"
#define RK_CAM_SKIP_FRAME_INTERVAL "rk_cam_skip"

#define RK_EXP_TIME            "rk_exp_time"
#define RK_EXP_GAIN            "rk_exp_gain"
