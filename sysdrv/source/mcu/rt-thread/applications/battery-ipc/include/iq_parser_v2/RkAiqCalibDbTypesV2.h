...
/*typedef struct CamCalibDbV2Context_s {
    union {
        ...
        struct {
            CalibDb_Sensor_ParaV2_t  sensorinfo;
            ae_param_t               ae_calib;
            awb_api_attrib_t         awb_calib;
            blc_api_attrib_t         blc_calib;
            btnr_api_attrib_t        btnr_calib;
        };
#endif
        struct {
...
typedef enum rk_aiq_iq_bin_mode_s {
    FULL_IQ_BIN_MODE = 0, // normal iq
    AOV_IQ_BIN_MODE = 1, // aov simplified iq
    RTT_IQ_BIN_MODE = 2, // rtt simplified iq
