...
#ifdef VALLOC_VERSION_2
#define IO_STRING_MAX_LEN 32
#else
...
#ifdef VALLOC_VERSION_2
    int mpi_buf_refcnt;
    int cache_direct; // 0: write, 1 read;
#endif
} __attribute__((packed));
...
#ifdef VALLOC_VERSION_2
#define VALLOC_IOCTL_MB_GET_REFCNT    VALLOC_IOWR(0x06, struct valloc_mb)
#define VALLOC_IOCTL_MB_SYNC_CACHE    VALLOC_IOWR(0x07, struct valloc_mb)
#define VALLOC_IOCTL_MB_ADD_REFCNT    VALLOC_IOWR(0x08, struct valloc_mb)
#define VALLOC_IOCTL_MB_DEC_REFCNT    VALLOC_IOWR(0x09, struct valloc_mb)
#endif
