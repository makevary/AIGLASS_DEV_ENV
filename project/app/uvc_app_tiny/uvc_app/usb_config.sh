...
uvc_device_config()
{
  ...
  configure_uvc_resolution_mjpeg 2688 1520
  ...
  configure_uvc_resolution_h264 2688 1520
  ...
  configure_uvc_resolution_h265 2688 1520
...
insmod /oem/usr/ko/usb_f_uac1_legacy.ko
...
insmod /oem/usr/ko/phy-rockchip-inno-usb2.ko      #for rv1106
insmod /oem/usr/ko/phy-rockchip-naneng-usb2.ko    #for rv1126
