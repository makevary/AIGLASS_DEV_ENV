...
static RK_S32 SAMPLE_COMM_ISP_SetMaxExpTime(int cam_id, RK_U32 max_exp_time_ms) {
	return 0;
}
static RK_S32 SAMPLE_COMM_SmartIr_Start(int cam_id) { return 0; }
static RK_S32 SAMPLE_COMM_SmartIr_Stop() { return 0; }
static RK_S32 SAMPLE_COMM_SmartIr_SetThreshold(int cnt) { return 0; }
static RK_S32 SAMPLE_COMM_SmartIr_SwitchScene(void) { return 0; }
static RK_S32 SAMPLE_COMM_ISP_Get2AInfoStr(char *buf, size_t len, int cam_id) {
	return 0;
}
static RK_S32 SAMPLE_COMM_ISP_SetSyncMode(int cam_id, enum rkmodule_sync_mode sync_mode) {
	return 0;
}
#ifdef __cplusplus
#if __cplusplus
