...
export RK_CAMERA_SENSOR_IQFILES="ainr/sc450ai_default_default.json"
...
export RK_PARTITION_CMD_IN_ENV="256K(env),1M@256K(idblock),1M(uboot),8M(boot),24M(rootfs),48M(oem),40M(userdata)"
...
# app config
export RK_APP_TYPE=RKIPC_RV1103B_AIISP
...
export RK_POST_OVERLAY=overlay-test
...
# config AI-ISP model
export RK_AIISP_MODEL="rkmodel_1080_1920.aiisp rkmodel_1080_1920.meh rkmodel_1520_2688.aiisp rkmodel_1520_2688.meh"
export RK_ENABLE_SYSSTAT=y
