...
export RK_CAMERA_SENSOR_IQFILES="common/sc200ai_default_default.json common/sc4336p_default_default.json common/sc450ai_default_default.json"
...
export RK_PARTITION_CMD_IN_ENV="256K(env),1M@256K(idblock),1M(uboot),8M(boot),16M(rootfs),56M(oem),40M(userdata)"
