...
export RK_UBOOT_RKBIN_MCU_CFG=rv1103b_evb1-SC200AI-ADC
...
# Kernel dts
export RK_KERNEL_DTS=rv1103b-evb1-v10-thunderboot-spi-nor.dts
...
export RK_PARTITION_CMD_IN_ENV="64K(env),256K@64K(idblock),256K(uboot),384K(meta),3M(boot),5M(rootfs),640K(userdata)"
