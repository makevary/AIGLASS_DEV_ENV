...
# Kernel dts
export RK_KERNEL_DTS=rv1103b-evb1-v10-thunderboot-spi-nand.dts
...
export RK_POST_BUILD_SCRIPT=tb-spi_nand-post.sh
...
# config NPU model
export RK_NPU_MODEL="iva_object_detection_v3_pvn_lite_896x512.data"
