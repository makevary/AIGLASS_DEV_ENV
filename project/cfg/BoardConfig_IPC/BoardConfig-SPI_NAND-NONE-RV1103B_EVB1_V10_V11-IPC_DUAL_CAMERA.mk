...
# Kernel dts
export RK_KERNEL_DTS=rv1103b-evb1-v10-dual-cam.dts
...
export RK_CAMERA_SENSOR_IQFILES="common/sc200ai_default_default.json"
...
export RK_PARTITION_CMD_IN_ENV="256K(env),1M@256K(idblock),1M(uboot),8M(boot),16M(rootfs),64M(oem),24M(userdata)"
...
# app config
export RK_APP_TYPE=RKIPC_RV1103B_DUAL_IPC
