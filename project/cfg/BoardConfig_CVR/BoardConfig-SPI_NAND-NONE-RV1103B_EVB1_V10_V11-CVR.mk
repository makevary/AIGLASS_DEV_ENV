...
export RK_BOOTARGS_CMA_SIZE="65M"
...
export RK_PARTITION_CMD_IN_ENV="256K(env),1M@256K(idblock),1M(uboot),8M(boot),24M(rootfs),64M(oem),28M(userdata)"
...
# app config
export RK_APP_TYPE=RKCVR_RV1103B
...
export RK_PRE_BUILD_OEM_SCRIPT=rv1103b-pre-oem-post.sh

# enable lvgl
export RK_ENABLE_LVGL=n
