...
export RK_UBOOT_RKBIN_MCU_CFG=rv1103b_evb3-PS5458-ADC

# Uboot Loader miniall ini file: locate in <SDK>/sysdrv/source/uboot/rkbin/RKBOOT
export RK_UBOOT_RKBIN_MINIALL_INI_FILE=RV1103BMINIALL_UART0M2_SPI_NOR_TB.ini

# Kernel defconfig
export RK_KERNEL_DEFCONFIG=rv1103b_defconfig

# Kernel defconfig fragment
export RK_KERNEL_DEFCONFIG_FRAGMENT="rv1106b-tb.config rv1106b-battery-ipc.config rv1103b-sdiowifi.config rv1106b-pm.config"

# Recovery defconfig fragment
export RK_RECOVERY_KERNEL_DEFCONFIG_FRAGMENT="rv1103b-recovery.config rv1106b-tb.config"

# Kernel dts
export RK_KERNEL_DTS=rv1106b-evb3-v10.dts
...
export RK_CAMERA_SENSOR_IQFILES="thunderboot/ps5458_default_default.bin"

# Config CMA size in environment
export RK_BOOTARGS_CMA_SIZE="50M"
...
export RK_PARTITION_CMD_IN_ENV="64K(env),256K@64K(idblock),256K(uboot),384K(meta),3M(boot),5M(rootfs),3M(userdata)"
...
export RK_POST_BUILD_SCRIPT=pr-spi_nor-post.sh
...
export RK_POST_OVERLAY=overlay-pre-record

export RK_APP_TYPE="RK_AO_RECORD_SERVICE RK_AO_RECORD_DEMO"
