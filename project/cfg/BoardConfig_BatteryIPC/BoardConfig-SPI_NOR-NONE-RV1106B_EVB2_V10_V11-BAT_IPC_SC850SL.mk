...
export RK_UBOOT_RKBIN_MCU_CFG=rv1103b_evb2-SC850SL-ADC
...
export RK_KERNEL_DEFCONFIG_FRAGMENT="rv1106b-tb.config rv1106b-battery-ipc.config rv1106b-tb-sdiowifi.config"

# Recovery defconfig fragment
export RK_RECOVERY_KERNEL_DEFCONFIG_FRAGMENT="rv1103b-recovery.config rv1106b-tb.config"

# Kernel dts
export RK_KERNEL_DTS=rv1106b-evb2-v10-4k.dts
...
export RK_CAMERA_SENSOR_IQFILES="thunderboot/sc850sl_default_default.bin"
...
export RK_PARTITION_CMD_IN_ENV="64K(env),256K@64K(idblock),256K(uboot),384K(meta),3M(boot),5M(rootfs)"
...
export RK_PARTITION_FS_TYPE_CFG=rootfs@IGNORE@erofs
...
# app config
export RK_APP_TYPE="RK_FASTBOOT_DEMO"
