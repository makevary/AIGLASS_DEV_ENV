...
# Kernel dts
export RK_KERNEL_DTS=rv1106b-evb2-v10.dts
...
export RK_PARTITION_CMD_IN_ENV="64K(env),256K@64K(idblock),256K(uboot),384K(meta),3M(boot),5M(rootfs),7232K(userdata)"
...
#export RK_APP_TYPE="RK_FASTBOOT_DUAL_PROCESS"
