...
export RK_KERNEL_DEFCONFIG_FRAGMENT="rv1106b-tb.config rv1106b-battery-ipc.config"

# Recovery defconfig fragment
export RK_RECOVERY_KERNEL_DEFCONFIG_FRAGMENT="rv1103b-recovery.config rv1106b-tb.config"

# Kernel dts
export RK_KERNEL_DTS=rv1106b-evb2-v10-dual-cam.dts
...
export RK_PARTITION_CMD_IN_ENV="64K(env),256K@64K(idblock),256K(uboot),704K(meta),3M(boot),5M(rootfs),6912K(userdata)"
...
# app config
#export RK_APP_TYPE="RK_FASTBOOT_CLIENT_DUAL_CAMERA"
export RK_APP_TYPE="RK_FASTBOOT_DUAL_DEMO"
...
# config NPU model
export RK_NPU_MODEL="iva_object_detection_pfp.data"

# enable rockchip test
export RK_ENABLE_ROCKCHIP_TEST=n

# specify post.sh for delete/overlay files
export RK_POST_BUILD_SCRIPT=tb-dual-cam-spi_nor-post.sh
