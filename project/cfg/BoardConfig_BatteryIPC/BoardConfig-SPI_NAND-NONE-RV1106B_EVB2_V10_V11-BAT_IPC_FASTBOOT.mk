...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=rv1106b-fastboot-spi-nand_defconfig
...
export RK_KERNEL_DEFCONFIG_FRAGMENT="rv1103b-fastboot.config rv1103b-nand.config rv1106b-tb-sdiowifi.config"

# Recovery defconfig fragment
export RK_RECOVERY_KERNEL_DEFCONFIG_FRAGMENT="rv1103b-recovery.config rv1106b-tb.config"

# Kernel dts
export RK_KERNEL_DTS=rv1106b-evb2-v10-fastboot-spi-nand.dts
...
export RK_PARTITION_CMD_IN_ENV="256K(env),1M@256K(idblock),512K(uboot),8M(boot),32M(rootfs),60M(userdata)"
