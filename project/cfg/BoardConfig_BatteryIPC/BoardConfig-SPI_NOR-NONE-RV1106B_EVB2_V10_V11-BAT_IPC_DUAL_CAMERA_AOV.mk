...
# build.sh mcu info --> rv1103b_evb2-dual_cam_SC200AI_SC200AI-ADC
export RK_UBOOT_RKBIN_MCU_CFG=rv1103b_evb2-dual_cam_SC200AI_SC200AI-ADC
...
export RK_KERNEL_DEFCONFIG_FRAGMENT="rv1106b-tb.config rv1106b-battery-ipc.config rv1106b-pm.config rv1106b-wakeup.config"

# Recovery defconfig fragment
export RK_RECOVERY_KERNEL_DEFCONFIG_FRAGMENT="rv1103b-recovery.config rv1106b-tb.config"

# Kernel dts
export RK_KERNEL_DTS=rv1106b-evb2-v10-aov-dual-cam.dts
...
export RK_CAMERA_SENSOR_IQFILES="thunderboot/sc200ai_default_default.bin thunderboot/sc200ai_default_default.bin"
...
export RK_PARTITION_CMD_IN_ENV="64K(env),256K@64K(idblock),256K(uboot),704K(meta),3M(boot),5M(rootfs),3M(userdata)"
...
export RK_AOV_APP_BUILD_STATIC=y
export RK_AOV_DEFAULT_APP=sample_aov_multi_vi_nonblend_stitch_venc
...
export RK_POST_BUILD_SCRIPT=tb-dual-cam-spi_nor-aov-post.sh
...
export RK_ENABLE_WIFI_CHIP=NONE
