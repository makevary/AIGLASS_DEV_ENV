...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=rv1106b-tb-emmc_defconfig
...
export RK_UBOOT_RKBIN_MINIALL_INI_FILE=RV1103BMINIALL_TB_EMMC.ini
...
# Kernel dts
export RK_KERNEL_DTS=rv1106b-evb2-v10-emmc.dts
...
export RK_PARTITION_CMD_IN_ENV="32K(env),256K@32K(idblock),256K(uboot),384K(meta),3M(boot),30M(rootfs),7G(userdata)"
...
export RK_POST_BUILD_SCRIPT=tb-emmc-post.sh
...
export RK_META_PARAM=" \
 ...
 --rk_led_value=20 \
 --rk_night_mode=2 \
 --rk_rtt_stream_on_threshold=15 \
 --rk_rtt_stream_buf_cnt=2 \
"
