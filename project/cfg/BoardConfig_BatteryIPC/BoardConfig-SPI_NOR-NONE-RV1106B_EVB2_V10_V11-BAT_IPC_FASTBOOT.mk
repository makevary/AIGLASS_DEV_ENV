...
# Uboot defconfig
export RK_UBOOT_DEFCONFIG=rv1106b-fastboot-spi-nor_defconfig
...
# Kernel dts
export RK_KERNEL_DTS=rv1106b-evb2-v10-fastboot.dts
#misc image
...
export RK_BOOTARGS_CMA_SIZE="22M"
...
export RK_PARTITION_CMD_IN_ENV="64K(env),128K@64K(idblock),256K(uboot),4M(boot),8M(rootfs),3M(userdata)"
