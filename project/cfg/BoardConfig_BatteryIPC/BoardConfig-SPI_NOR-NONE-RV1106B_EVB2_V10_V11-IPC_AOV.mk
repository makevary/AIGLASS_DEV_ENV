...
export RK_KERNEL_DEFCONFIG_FRAGMENT="rv1103b-evb.config rv1106b-pm.config rv1106b-wakeup.config rv1103b-sdiowifi.config"

# Kernel dts
export RK_KERNEL_DTS=rv1106b-evb2-v10-normal-spi-nor.dts

# Config sensor IQ files
# RK_CAMERA_SENSOR_IQFILES format:
#     "iqfile1 iqfile2 iqfile3 ..."
# ./build.sh media and copy <SDK root dir>/output/out/media_out/isp_iqfiles/$RK_CAMERA_SENSOR_IQFILES
export RK_CAMERA_SENSOR_IQFILES="common/sc200ai_default_default.bin common/sc4336p_default_default.bin common/sc450ai_default_default.bin"

# Config sensor lens CAC calibrattion bin files
export RK_CAMERA_SENSOR_CAC_BIN=""

# Config CMA size in environment
export RK_BOOTARGS_CMA_SIZE="34M"
